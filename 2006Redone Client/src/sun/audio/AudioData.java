...
/**
 * A clip of audio data. This data can be used to construct an AudioDataStream,
 * which can be played.
 * <p>
 *
...
/*
 * the idea here is that the AudioData object encapsulates the data you need to
 * play an audio clip based on a defined set of data. to do this, you require
 * the audio data (a byte array rather than an arbitrary input stream) and a
 * format object.
 */

public final class AudioData {

  private static final AudioFormat DEFAULT_FORMAT = new AudioFormat(AudioFormat.Encoding.ULAW, 8000, // sample
                                                                                                     // rate
