...
import client.model.Animable_Sub3;
import client.model.Animable_Sub4;
...
public class Game extends RSApplet {
  ...
  final synchronized void method58(int i_30_, int volume, boolean bool, int music) {
    if (musicIsntNull()) {
      nextSong = music;
  ...
  public void drawChatArea() {
    ...
    if (messagePromptRaised) {
      ...
      drawInterface(0, 0, RSInterface.interfaceCache[backDialogID], 0);// CHANGED
                                                                       // THIS -
                                                                       // andrew
                                                                       // was 0,
                                                                       // 0
    } else if (dialogID != -1) {
      drawInterface(0, 0, RSInterface.interfaceCache[dialogID], 0);// CHANGED
                                                                   // THIS -
                                                                   // andrew was
                                                                   // 0, 0
    } else {
  ...
  public void buildInterfaceMenu(int i, RSInterface class9, int k, int l, int i1, int j1) {
    ...
    for (int l1 = 0; l1 < k1; l1++) {
      ...
      if ((class9_1.anInt230 >= 0 || class9_1.anInt216 != 0) && k >= i2 && i1 >= j2 && k < i2 + class9_1.width
                ...
                if (class9_1.inv[k2] > 0) {
                  ...
                  if (itemSelected == 1 && class9_1.isInventoryInterface) {
                    ...
                    menuActionName[menuActionRow] = "Examine @lre@" + itemDef.name
                        + (showInfo ? " @gre@(@whi@" + (class9_1.inv[k2] - 1) + "@gre@)" : "");
        ...
        for (int j1 = 0; j1 < 4; j1++) {
          if (((Entity) obj).hitsLoopCycle[j1] > loopCycle) {
            ...
            if (spriteDrawX > -1) {
              ...
              aTextDrawingArea_1270.drawText(0, String.valueOf(((Entity) obj).hitArray[j1]), spriteDrawY + 4,
                  spriteDrawX);
              aTextDrawingArea_1270.drawText(0xffffff, String.valueOf(((Entity) obj).hitArray[j1]), spriteDrawY + 3,
                  spriteDrawX - 1);
            }
          }
        }
      ...
      if (k1 == 2 && worldController.method304(plane, i1, j1, l) >= 0) {
        ...
        if (itemSelected == 1) {
          ...
          menuActionName[menuActionRow] = "Examine @cya@" + class46.name
              + (showInfo ? " @gre@(@whi@" + l1 + "@gre@) (@whi@" + (i1 + baseX) + "," + (j1 + baseY) + "@gre@)" : "");
  ...
  public void buildChatAreaMenu(int j) {
    ...
    for (int i1 = 0; i1 < 100; i1++) {
      ...
      if ((j1 == 3 || j1 == 7) && splitpublicChat == 0
  ...
  public void drawFriendsListOrWelcomeScreen(RSInterface class9) {
    ...
    if (j == 660) {
      ...
      if (k1 <= 0)
        ...
        s1 = k1 + " days ago";
      class9.disabledText = "You last logged in @red@" + s1 + "@bla@ from: @red@" + Signlink.dns;
    }
    if (j == 661)
      if (anInt1034 == 0)
        class9.disabledText = "\\nYou have not yet set any recovery questions.\\nIt is @lre@strongly@yel@ recommended that you do so.\\n\\nIf you don't you will be @lre@unable to recover your\\n@lre@password@yel@ if you forget it, or it is stolen.";
      else if (anInt1034 <= anInt1170) {
        class9.disabledText = "\\n\\nRecovery Questions Last Set:\\n@gre@" + method104(anInt1034);
      } else {
    ...
    if (j == 665)
      if (anInt992 > 2 && !isMembers)
        ...
        class9.disabledText = "You have @gre@" + anInt992
  ...
  public void processRightClick() {
    ...
    if ((backDialogID != -1 || dialogID != -1) && anInt886 != anInt1039) {// TODO
                                                                          // remove
                                                                          // if
                                                                          // any
                                                                          // issues
  ...
  public void buildAtNPCMenu(EntityDef entityDef, int i, int j, int k) {
    ...
    if (spellSelected == 1) {
      ...
      menuActionName[menuActionRow] = "Examine @yel@" + s
          + (showInfo ? " @gre@(@whi@" + entityDef.type + "@gre@)" : "");
  ...
  void startUp() {
    ...
    try {
      ...
      TextDrawingArea aclass30_sub2_sub1_sub4s[] = { aTextDrawingArea_1270, aTextDrawingArea_1271, chatTextDrawingArea,
      ...
      if (component.type == 0) {
        ...
        if (component.type == 2) {
          ...
          for (int l6 = l2 + textDrawingArea.anInt1497; s.length() > 0; l6 += textDrawingArea.anInt1497) {
            if (s.indexOf("%") != -1) {
              do {
                ...
                s = s.substring(0, k7) + interfaceIntToString(extractInterfaceValues(component, 0))
                    + s.substring(k7 + 2);
              } while (true);
              do {
                int l7 = s.indexOf("%2");
                ...
                s = s.substring(0, l7) + interfaceIntToString(extractInterfaceValues(component, 1))
                    + s.substring(l7 + 2);
              } while (true);
              do {
                int i8 = s.indexOf("%3");
                ...
                s = s.substring(0, i8) + interfaceIntToString(extractInterfaceValues(component, 2))
                    + s.substring(i8 + 2);
              } while (true);
              do {
                int j8 = s.indexOf("%4");
                ...
                s = s.substring(0, j8) + interfaceIntToString(extractInterfaceValues(component, 3))
                    + s.substring(j8 + 2);
              } while (true);
              do {
                int k8 = s.indexOf("%5");
                ...
                s = s.substring(0, k8) + interfaceIntToString(extractInterfaceValues(component, 4))
                    + s.substring(k8 + 2);
              } while (true);
            }
            int l8 = s.indexOf("\\n");
          ...
          if (i7 == -1) {
            ...
            model = component.method209(animation.anIntArray354[component.anInt246],
                animation.anIntArray353[component.anInt246], flag2);
          }
          if (model != null) {
          ...
          for (int j5 = 0; j5 < component.height; j5++) {
            for (int i6 = 0; i6 < component.width; i6++) {
              if (component.inv[k4] > 0) {
                ...
                if (component.aBoolean223) {
                  textDrawingArea_1.method382(component.textColor, i9 + component.width / 2, s2, k9,
                      component.aBoolean268);
                } else {
  ...
  public void drawMinimap() {
    ...
    aClass30_Sub2_Sub1_Sub1_1263.method352(151, i, anIntArray1229, 256 + minimapInt3, anIntArray1052, l2, 5, 25, 146,
        j);
    compass.method352(33, minimapInt1, anIntArray1057, 256, anIntArray968, 25, 0, 0, 33, 25);
  ...
  public void method137(Stream stream, int j) {
    ...
    if (j == 105) {
      ...
      if (myPlayer.smallX[0] >= k3 - i14 && myPlayer.smallX[0] <= k3 + i14 && myPlayer.smallY[0] >= j6 - i14
          && myPlayer.smallY[0] <= j6 + i14 && aBoolean848 && !lowMem && currentSound < 50) {
  ...
  public boolean parsePacket() {
    ...
    try {
      ...
      if (pktType == 97) {
        ...
        /*
         * if (openInterfaceID != l7) { openInterfaceID = l7; }
         */
        if (inputDialogState != 0) {
          inputDialogState = 0;
          inputTaken = true;
        ...
        /*
         * 15244 = main Interface ID 17511 = Question Type 15819 = Christmas
         * Type 15812 = Security Type 15801 = Item Scam Type 15791 = Password
         * Safety 15774 = Good/Bad Password 15767 = Drama Type
         */
        ...
        if (l7 == 15244) {
          ...
          /*
           * } else if (l7 == 17511) { openInterfaceID = 17511;
           * fullScreenBackDialogID = 15244; } else if (l7 == 15819) {
           * openInterfaceID = 15819; fullScreenBackDialogID = 15244; } else if
           * (l7 == 15812) { openInterfaceID = 15812; fullScreenBackDialogID =
           * 15244; } else if (l7 == 15801) { openInterfaceID = 15801;
           * fullScreenBackDialogID = 15244; } else if (l7 == 15791) {
           * openInterfaceID = 15791; fullScreenBackDialogID = 15244; } else if
           * (l7 == 15774) { openInterfaceID = 15774; fullScreenBackDialogID =
           * 15244; } else if (l7 == 15767) { openInterfaceID = 15767;
           * fullScreenBackDialogID = 15244;
           */
        } else {
          openInterfaceID = l7;
    ...
    for (int i2 = 0; i2 < 5; i2++) {
      if (aBooleanArray876[i2]) {
        int j2 = (int) (Math.random() * (double) (anIntArray873[i2] * 2 + 1) - (double) anIntArray873[i2]
            + Math.sin((double) anIntArray1030[i2] * (double) anIntArray928[i2] / 100D) * (double) anIntArray1203[i2]);
        if (i2 == 0) {
          xCameraPos += j2;
        }
        if (i2 == 1) {
  ...
  public static int[] anIntArray385 = new int[] { 12800, 12800, 12800, 12800, 12800, 12800, 12800, 12800, 12800, 12800,
