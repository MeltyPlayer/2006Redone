...
import server.game.objects.impl.SpecialObjects;
import server.game.players.Client;
import server.game.players.PlayerAssistant;
import server.game.shops.Shops.Shop;
...
public class DialogueHandler {
    ...
    switch (dialogue) {
      ...
      case 2:
        if (player.canLeaveArea) {
          sendNpcChat2("Just step through the glowing portal when you're ready",
              "to leave, and I'll ensure you get a nice reward.", player.talkingNpc, "Freaky Forester");
          player.getItemAssistant().deleteItem(6178, player.getItemAssistant().getItemSlot(6178),
              player.getItemAssistant().getItemAmount(6178));
        } else if (FreakyForester.hasKilledPheasant(player) && player.getItemAssistant().playerHasItem(6178, 1)) {
          sendNpcChat1("Thank you. I take that pheasant, you can leave now.", player.talkingNpc, "Freaky Forester");
          player.canLeaveArea = true;
          player.getItemAssistant().deleteItem(6178, player.getItemAssistant().getItemSlot(6178),
              player.getItemAssistant().getItemAmount(6178));
        } else {
          sendNpcChat2("Hello there mate. Can you please kill a " + FreakyForester.getPheasant(player) + " and",
              "bring it back to me and I shall let you leave.", player.talkingNpc, "Freaky Forester");
        }
        player.nextChat = 0;
        break;// go to where they appear or whatever

      case 3:
        sendNpcChat1("Come back mate! You can't leave yet!", player.talkingNpc, "Freaky Forester");
        player.nextChat = 0;
        break;
      ...
      case 4:
        if (player.luthas == true && player.bananas >= 2) {
          ...
          sendNpcChat1("Thank you for your services you have been rewarded 30 coins.", player.talkingNpc, "Luthas");
          player.luthas = false;
          player.bananas = 0;
          player.nextChat = 0;
        } else {
      ...
      case 10:
        sendNpcChat1("Please put 10 bannanas in a crate then I will reward you.", player.talkingNpc, "Luthas");
        player.nextChat = 4;
        break;
      ...
      case 18:
        sendNpcChat1("Hi welcome to the partyroom.", player.talkingNpc, "Party Pete");
        player.nextChat = 605;
        break;

      case 19:
        sendNpcChat1("Hello would you like to buy a beer for 2 gp?", player.talkingNpc, "Bartender");
        player.nextChat = 20;
        break;
      ...
      case 21:
        sendNpcChat1("Hello, would you like me to bring you into to shilo village?", player.talkingNpc, "Mosol Rei");
        player.nextChat = 22;
        break;
      ...
      case 24:
        if (player.getItemAssistant().playerHasItem(995, 200)) {
          sendNpcChat3("Hello Fair Traveler.", "Can i interest you in a ride back to shantay", "for 200 coins?",
              player.talkingNpc, "Rug Merchant");
          player.nextChat = 25;
        } else {
          sendNpcChat1("You need 200 coins to travel my rug.", player.talkingNpc, "Rug Merchant");
          player.nextChat = 0;
        }
        break;
      ...
      case 26:
        if (player.getItemAssistant().playerHasItem(995, 200)) {
          sendNpcChat2("Hello Fair Traveler.", "Can i interest you in a ride for 200 coins?", player.talkingNpc,
              "Rug Merchant");
          player.nextChat = 27;
        } else {
          sendNpcChat1("You need 200 coins to travel my rug.", player.talkingNpc, "Rug Merchant");
      ...
      case 37:
        sendNpcChat2("Welcome to my food store!", "Would you like to buy anything?", player.talkingNpc, "Wydin");
        player.nextChat = 38;
        break;
      case 38:
      ...
      case 41:
        ...
        break;
      case 42:
        sendNpcChat3("Well you're keen, I'll give you that.", "Okay, I'll give you a go.",
            "Have you got your own white apron?", player.talkingNpc, "Wydin");
        player.nextChat = 43;
        break;
      case 43:
        ...
        break;
      case 44:
        sendNpcChat2("Well, you can't work here unless you have a white apron.",
            "Health and safety regulations, you understand.", player.talkingNpc, "Wydin");
        player.nextChat = 45;
        break;
      case 45:
        ...
        break;
      case 46:
        sendNpcChat2("Well I get all mine at the clothing shop in Varrock.", "They sell them cheap there.",
            player.talkingNpc, "Wydin");
        player.nextChat = 47;
        player.ptjob = 1;
        break;
      case 47:
        sendNpcChat1("Have you got your white apron now?", player.talkingNpc, "Wydin");
        player.nextChat = 47;
        break;
      case 48:
        ...
        break;
      case 49:
        sendNpcChat2("Wow, your well prepared! Your hired.", "Go through the back and tidy up for me please.",
            player.talkingNpc, "Wydin");
        player.nextChat = 0;
        player.ptjob = 2;
        break;
      ...
      case 54:
        ...
        break;
      case 55:
        sendNpcChat4("I've forgotten to buy the ingredients. I'll never get",
            "them in time now. He'll sack me! What will I do? I have",
            "four children and a goat to look after. Would you help", "me? Please?", player.talkingNpc, "Cook");
        player.nextChat = 56;
        break;
      case 56:
      ...
      case 60:
        sendNpcChat2("Oh thank you, thank you. I need milk, an egg, and",
            "flour. I'd be very grateful if you can get them for me.", player.talkingNpc, "Cook");
        player.cookAss = 1;
      ...
      case 61:
        ...
        break;
      case 62:
        sendNpcChat3("You can find flour in any of the shops here.", "You can find eggs by killing chickens.",
            "You can find milk by using a bucket on a cow", player.talkingNpc, "Cook");
        player.nextChat = 0;
        break;
      case 63:
        sendNpcChat1("I don't have time for your jibber-jabber!", player.talkingNpc, "Cook");
        player.nextChat = 0;
        break;
      case 64:
        sendNpcChat1("Does it look like I have the time?", player.talkingNpc, "Cook");
        player.nextChat = 0;
        break;
      case 65:
        ...
        break;
      case 66:
        sendNpcChat1("How are you getting on with finding the ingredients?", player.talkingNpc, "Cook");
        player.nextChat = 67;
        break;
      case 67:
        if (player.getItemAssistant().playerHasItem(1944, 1) && player.getItemAssistant().playerHasItem(1927, 1)
      ...
      case 68:
        ...
        player.cookAss = 2;
        sendNpcChat2("You brought me everything I need! I'm saved!", "Thank you!", player.talkingNpc, "Cook");
        player.nextChat = 69;
        break;
      case 69:
        ...
        break;
      case 70:
        sendNpcChat2("I'm afraid not, only the big cheeses get to dine with the", "Duke.", player.talkingNpc, "Cook");
        player.nextChat = 72;
        break;
      case 72:
        ...
        break;
      case 74:
        sendNpcChat1("Maybe, but I won't be holding my breath.", player.talkingNpc, "Cook");
        player.nextChat = 75;
        break;
      case 75:
        ...
        break;
      case 76:
        sendNpcChat1("Thanks for helping me out friend!", player.talkingNpc, "Cook");
        player.nextChat = 0;
        break;
      case 84:
        sendNpcChat1("How are you getting on finding all my supplies", player.talkingNpc, "Doric");
        player.nextChat = 85;
        break;
      case 85:
        if (player.getItemAssistant().playerHasItem(434, 6) && player.getItemAssistant().playerHasItem(436, 4)
      ...
      case 86:
        ...
        player.doricQuest = 2;
        sendNpcChat2("You brought me everything i need.", "Thank You!", player.talkingNpc, "Doric");
        player.nextChat = 87;
        break;
      case 87:
      ...
      case 88:
        ...
        break;
      case 89:
        sendNpcChat1("Hello traveler, what brings you to my humble smithy?", player.talkingNpc, "Doric");
        player.nextChat = 90;
        break;
      case 90:
        ...
        break;
      case 91:
        sendNpcChat1("Mind your own buisness, Shortstuff!", player.talkingNpc, "Doric");
        player.nextChat = 0;
        break;
      case 92:
        sendNpcChat1("So you want to use my anivils?", player.talkingNpc, "Doric");
        player.nextChat = 98;
        break;
      case 98:
        ...
        break;
      case 93:
        sendNpcChat4("My anvils get enough work with my own use.", "I make pickaxes, and it takes a lot of hard work.",
            "If you could get me some more materials,", "then i could let use them.", player.talkingNpc, "Doric");
        player.nextChat = 94;
        break;
      case 94:
      ...
      case 97:
        sendNpcChat4("Clay is what i use more than anything, to make casts.",
            "Could you get me 6 clay, 4 copper, and 2 iron, please?", "I could give a nice little reward",
            "Take my pickaxe with you just incase you need it.", player.talkingNpc, "Doric");
      ...
      case 102:
        ...
        break;
      case 103:
        sendNpcChat2("You even defeated TzTok-Jad, I am most impressed!", "Please accept this gift as a reward.", 2617,
            "TzHaar-Mej-Jal");
        player.nextChat = 0;
        break;
      case 104:
      ...
      case 147:
        ...
        break;
      case 148:
        sendNpcChat2("Well seeing as you asked nicely... I could do with some", "help.", player.talkingNpc,
            "Wizard Mizgog");
        player.nextChat = 149;
        break;
      case 149:
        sendNpcChat2("The wizard Grayzag next door decided he didn't like",
            "me so he enlisted an army of hundreds of imps.", player.talkingNpc, "Wizard Mizgog");
        player.nextChat = 150;
        break;
      case 150:
        sendNpcChat3("These imps stole all sorts of my things. Most of these",
            "things I don't really care about, just eggs and balls of", "string and things.", player.talkingNpc,
            "Wizard Mizgog");
        player.nextChat = 151;
        break;
      case 151:
        sendNpcChat2("But they stole my four magical beads. There was a red",
            "one, a yellow one, a black one, and a white one.", player.talkingNpc, "Wizard Mizgog");
        player.nextChat = 152;
        break;
      case 152:
        sendNpcChat2("These imps have now spread out all over the kingdom.", "Could you get my beads back for me?",
      ...
      case 154:
        ...
        break;
      case 155:
        sendNpcChat1("That's great, thank you.", player.talkingNpc, "Wizard Mizgog");
        player.nextChat = 0;
        break;

      case 156:
        sendNpcChat1("So how are you doing finding my beads?", player.talkingNpc, "Wizard Mizgog");
        player.nextChat = 157;
        break;
      case 157:
      ...
      case 160:
        sendNpcChat3("Give them here and I'll check that really are MY",
            "beads, before I give you your reward. You'll take it, it's", "an amulet of accuracy.", player.talkingNpc,
            "Wizard Mizgog");
        player.nextChat = 161;
        break;
      case 161:
        sendStatement("You give four coloured beads to Wizard Mizgog.");
        if (player.getItemAssistant().playerHasItem(1470, 1) && player.getItemAssistant().playerHasItem(1472, 1)
            && player.getItemAssistant().playerHasItem(1474, 1) && player.getItemAssistant().playerHasItem(1476, 1)) {
      ...
      case 164:
        sendNpcChat3("What are you doing on my land? ", "You're not the one who keeps leaving all my gates open",
            "and letting out all my sheep are you?", player.talkingNpc, "Fred");
        player.nextChat = 165;
        break;
      case 165:
      ...
      case 166:
        ...
        break;
      case 167:
        sendNpcChat1("Goblins are great for killing near the bridge in lumbridge.", player.talkingNpc, "Fred");
        player.nextChat = 0;
        break;
      case 168:
        ...
        break;
      case 169:
        sendNpcChat2("You're after a quest, you say", "Actually I could do with a bit of help.", player.talkingNpc,
            "Fred");
        player.nextChat = 170;
        break;
      case 170:
        sendNpcChat3("My sheep are getting mighty wolly.", "I'd be much obliged if you could shear them.",
            "And while you're at it spin the wool for me too.", player.talkingNpc, "Fred");
        player.nextChat = 171;
        break;
      case 171:
        sendNpcChat4("Yes, that's it.", " Bring me 20 balls of wool.",
            "And I'm sure I could sort out some sort of payment.", " Of course, there's the small matter of The Thing.",
            player.talkingNpc, "Fred");
        player.nextChat = 172;
        break;
      case 172:
        sendOption3("Yes okay. I can do that.", "That doesn't sound a very exciting quest.",
      ...
      case 176:
        ...
        break;
      case 177:
        sendNpcChat2("Good! Now one more thing,", "do you actually know how to shear a sheep?.", player.talkingNpc,
            "Fred");
        player.nextChat = 178;
        break;
      case 178:
      ...
      case 179:
        ...
        break;
      case 180:
        sendNpcChat1("And you know how to spin wool into balls?", player.talkingNpc, "Fred");
        player.nextChat = 181;
        break;
      case 181:
      ...
      case 182:
        ...
        break;
      case 183:
        sendNpcChat1("Well you can stop grinning and get to work then?", player.talkingNpc, "Fred");
        player.nextChat = 184;
        break;
      case 184:
        sendNpcChat1("I'm not paying you by the hour!", player.talkingNpc, "Fred");
        player.nextChat = 0;
        break;
      case 185:
        sendNpcChat1("How are you doing getting my balls of wool?", player.talkingNpc, "Fred");
        player.nextChat = 186;
        break;
      case 186:
      ...
      case 188:
        ...
        break;
      case 189:
        sendNpcChat1("I guess I'd better pay you then.", player.talkingNpc, "Fred");
        player.nextChat = 263;
        break;
      case 263:
        ...
        break;
      case 190:
        sendNpcChat1("Greetings, welcome to my castle.", player.talkingNpc, "Duke Horacio");
        player.nextChat = 191;
        break;
      case 191:
        sendOption3("Have you any quests for me?", "Where can I find money?",
      ...
      case 192:// 9158
        ...
        break;
      case 193:
        sendNpcChat1("I'm sorry, I'm not sure.", player.talkingNpc, "Duke Horacio");
        player.nextChat = 0;
        break;
      case 194:// 9157
        if (player.runeMist == 0) {
          sendNpcChat2("Well, it's not really a quest", "but I recently discovered this strange talisman.",
              player.talkingNpc, "Duke Horacio");
          player.nextChat = 195;
        } else {
          sendNpcChat1("You have already started this quest.", player.talkingNpc, "Duke Horacio");
          player.nextChat = 0;
        }
        break;
      case 195:
        sendNpcChat2("It seems to be mystical and I have never seen anything like it before.",
            "Would you take it to the head wizard at", player.talkingNpc, "Duke Horacio");
        player.nextChat = 196;
        break;
      case 196:
      ...
      case 199:
        sendNpcChat2("Thank you very much, stranger.",
            "I'm sure the head wizard will reward you for such an interesting find.", player.talkingNpc,
            "Duke Horacio");
        player.nextChat = 200;
        break;
      case 200:
        itemMessage1("The duke hands you an @blu@air talisman@blu@.", 1438, 1);
        ...
        break;
      case 201:
        sendNpcChat2("Welcome adventurer, to the world renowed Wizards Tower", "How may I help you?", player.talkingNpc,
            "Sedridor");
        player.nextChat = 202;
        break;
      case 202:
        sendOption3("Nothing thanks, I'm just looking around.", "What are you doing down here?",
            "I'm looking for the head wizard.");
        player.dialogueAction = 126;
        break;
      case 203: // 9168
        sendNpcChat1("That's none of your buisness.", player.talkingNpc, "Sedridor");
        player.nextChat = 0;
        break;
      case 204: // 9169
        ...
        break;
      case 205:
        sendNpcChat2("Oh, you are, are you?", "And just why would you be doing that?", player.talkingNpc, "Sedridor");
        player.nextChat = 207;
        break;
      case 207:
        sendPlayerChat3("The Duke of Lumbridge sent me to find him. Most of these",
            "I have this weird talisman he found.", "He said the head wizard would be very interested in it.");
        player.nextChat = 208;
        break;
      case 208:
        sendNpcChat4("Did he now? HmmmMMMMMmmmm.", "Well that IS interested. Hand it over then adverturer",
            "let me see what all the hubbub about it is.", "Just some amulet I'll wager.", player.talkingNpc,
            "Sedridor");
        player.nextChat = 209;
        break;
      case 209:
      ...
      case 212:
        ...
        break;
      case 213:
        sendNpcChat1("Wow! This is... incredible!", player.talkingNpc, "Sedridor");
        player.nextChat = 214;
        break;
      case 214:
        sendNpcChat4("Th-this talisman you brought me...! ", "It is the last piece of the puzzle, I think! Finally!",
            "The legacy of our ancestors.", "It will return to us once more!", player.talkingNpc, "Sedridor");
        player.nextChat = 215;
        break;
      case 215:
        sendNpcChat3("I need time to study this, " + player.playerName + ".",
            "Can you please do me this task while I study this talisman you have brought me?",
            "In the mighty town of Varrock, which", player.talkingNpc, "Sedridor");
        player.nextChat = 216;
        break;
      case 216:
        sendNpcChat2("is located North East of here, there is a certain shop that sells magical runes.",
            "I have in this package all of the research I have done relating to the Rune Stones, and",
            player.talkingNpc, "Sedridor");
        player.nextChat = 217;
        break;
      case 217:
        sendNpcChat3("require sombody to take them to the shopkeeper so that he may share my research",
            "and offer me his insights.", "Do this thing for me, and bring back what he gives you,", player.talkingNpc,
            "Sedridor");
        player.nextChat = 218;
        break;
      case 218:
        sendNpcChat3("and if my suspicions are correct,",
            ...
            "A secret so powerful that it destroyed the", player.talkingNpc, "Sedridor");
        player.nextChat = 219;
        break;
      case 219:
        sendNpcChat3("original Wizards tower all of those centuries ago!",
            "My research, combined with this mysterious talisman...",
            "I cannot believe the answer to the mysteries is so close now!", player.talkingNpc, "Sedridor");
        player.nextChat = 220;
        break;
      case 220:
        sendNpcChat2("Do this thing for me " + player.playerName + ".", " Be rewarded in a way you can never imagine.",
            player.talkingNpc, "Sedridor");
        player.nextChat = 222;
        break;
      case 222:
      ...
      case 223:// 9157
        ...
        break;
      case 224:
        sendNpcChat3("Take this package, and head directly North from here.",
            "through Draynor village, until you reach the Barbarian Village.",
            "Then head East from there until you reach Varrock.", player.talkingNpc, "Sedridor");
        player.nextChat = 225;
        break;
      case 225:
        sendNpcChat3("Once in Varrock, take this package to the owner of the rune shop.", "His name is Aubury.",
            "You may find it helpful to ask one of Varrock's citizens for directions,", player.talkingNpc, "Sedridor");
        player.nextChat = 226;
        break;
      case 226:
        sendNpcChat3("as Varrock can be a confusing place for the first time visitor.",
            "He will give you a special item - bring it back to me,",
            "and I shall show you the mystery of the runes...", player.talkingNpc, "Sedridor");
        player.nextChat = 227;
        break;
      case 227:
        ...
        break;
      case 228:
        sendNpcChat1("Best of luck with your quest, " + player.playerName + ".", player.talkingNpc, "Sedridor");
        player.nextChat = 0;
        break;
      case 229:
        sendNpcChat1("Do you want to buy some runes?", player.talkingNpc, "Aubury");
        player.nextChat = 230;
        break;
      case 230:
        sendOption3("Yes please!", "Oh, it's a rune shop. No thank you, then.",
      ...
      case 232: // 9169
        ...
        break;
      case 233:
        sendNpcChat3("Really? But... surely he can't have..?", "Please, let me have it,",
            "it must be extremely important for him to have sent a stranger.", player.talkingNpc, "Aubury");
        player.nextChat = 234;
        break;
      case 234:
      ...
      case 235:
        sendNpcChat2("This... this is incredible. Please,",
            "give me a few moments to quickly look over this, and then talk to me again.", player.talkingNpc, "Aubury");
        player.nextChat = 236;
        break;
      case 236:
        ...
        break;
      case 237:
        sendNpcChat1("Thank you, now you should head back to Sedridor and tell him your discoveries.",
            player.talkingNpc, "Aubury");
        player.nextChat = 0;
        break;
      case 238:
        sendNpcChat2("Welcome, adventure to the world-renowed Wizards Tower.", "How may i help you?", player.talkingNpc,
            "Sedridor");
        player.nextChat = 239;
        break;
      case 239:
        sendNpcChat2("Ah, " + player.playerName + ". How goes your quest?",
            "Have you delivered the research notes to my friend yet?", player.talkingNpc, "Sedridor");
        player.nextChat = 240;
        break;
      case 240:
      ...
      case 243:
        sendNpcChat2("You have been nothing but helpful, adventured.",
            "In return, I can let you in on the secret of our research.", player.talkingNpc, "Sedridor");
        player.nextChat = 245;
        break;
      case 245:
        sendNpcChat2("Many centuries ago, the wizards of the Wizards Tower learnt the secret of creating runes,",
            "which allowed them to cast magic very easily.", player.talkingNpc, "Sedridor");
        player.nextChat = 247;
        break;
      case 247:
        sendNpcChat3("But, when this tower was burnt down, the sercret of creating runes was lost with it...",
            "or so I thought.", "Some months ago, while searching these ruins for information, ", player.talkingNpc,
            "Sedridor");
        player.nextChat = 248;
        break;
      case 248:
        sendNpcChat2("I came upon a scroll that made refrence to a magical rock",
            "deep in the ice fields of the north.", player.talkingNpc, "Sedridor");
        player.nextChat = 249;
        break;
      case 249:
        sendNpcChat3("This rock was called the rune essence by those magicians who studied it's powers.",
            "Apparently, by simply breaking a chunk for it,", "a rune could be fashioned and taken to certain",
            player.talkingNpc, "Sedridor");
        player.nextChat = 250;
        break;
      case 250:
        sendNpcChat3("magical altars that were scattered across the land.",
            ...
            "not much use to us since we do not have access to this rune essence", player.talkingNpc, "Sedridor");
        player.nextChat = 251;
        break;
      case 251:
        sendNpcChat2("teleportations spell that he had never come across before, When cast,",
            "it took him to a strange rock, yet it felt strangly familiar.", player.talkingNpc, "Sedridor");
        player.nextChat = 252;
        break;
      case 252:
        sendNpcChat3("As I'm sure you have guessed, he had discovered a spell to the mythical rune essence.",
            "As soon as he told me of this,", "I saw the importance of the find.", player.talkingNpc, "Sedridor");
        player.nextChat = 253;
        break;
      case 253:
        sendNpcChat2("For, if we could find the altars spoken of in the ancient texts",
            "we would once more be able to create runes as our ancestors had done!", player.talkingNpc, "Sedridor");
        player.nextChat = 254;
        break;
      case 254:
        ...
        break;
      case 255:
        sendNpcChat3("You haven't guessed?", "This talisman you brough me is the key to the elemental altar of air!",
            "When you hold it, it directs you to", player.talkingNpc, "Sedridor");
        player.nextChat = 256;
        break;
      case 256:
        sendNpcChat3("the entrance of the long-forgotten Air Altar.",
            "By bringing peices of the rune essence the Air Altar,", "you will be able to fashion your own air runes",
            player.talkingNpc, "Sedridor");
        player.nextChat = 257;
        break;
      case 257:
        sendNpcChat3("That's not all!", "By finding other talismans similar to his one,",
            "you will eventually be able to craft every rune that is available in this world, jus", player.talkingNpc,
            "Sedridor");
        player.nextChat = 258;
        break;
      case 258:
        sendNpcChat3("as our ancestors did.", "I cannot stress enough what find this is!",
            "Now, due to the risks invovled in letting this mighty power fall into the wrong hands.", player.talkingNpc,
            "Sedridor");
        player.nextChat = 259;
        break;
      case 259:
        sendNpcChat3("I will keep the teleport spell to the rune essence a closely guarded secret.",
            "This means that, if any evil power should discover the talismans required to enter the emental temples,",
            "we will be able to prevent their", player.talkingNpc, "Sedridor");
        player.nextChat = 260;
        break;
      case 260:
        sendNpcChat3("access to the rune essence.",
            ...
            "but now return your air talisman.", player.talkingNpc, "Sedridor");
        player.nextChat = 261;
        break;
      case 261:
        sendNpcChat1("Find the Air Altar and you will be able to craft you blank runes into air runes at will.",
            player.talkingNpc, "Sedridor");
        player.nextChat = 262;
        break;
      case 262:
        sendNpcChat2("Any time you wish to visit the rune essence,",
            "speak to me or Aubury and we will open a portal to that mystical place.", player.talkingNpc, "Sedridor");
        player.nextChat = 264;
        break;
      case 264:
      ...
      case 266:
        sendNpcChat2("No, there are others. When you speak to them,",
            "they will know you and grant you access to that place when asked.", player.talkingNpc, "Sedridor");
        player.nextChat = 267;
        break;
      case 267:
        sendNpcChat2(
            "Use the air talisman to locate the Air Altar and use any further talismans you find to locate the other altars.",
            "Now, my research notes please?", player.talkingNpc, "Sedridor");
        player.nextChat = 268;
        break;
      case 268:
        itemMessage1("You give the research notes to Sedrdior. He gives you an air talisman.", 290, 1);
        player.getItemAssistant().deleteItem(290, 1);
        player.runeMist = 4;
      ...
      case 269:
        ...
        break;
      case 270:
        sendNpcChat2("Do I look ok?", "Those kid's drive me crazy.", player.talkingNpc, "Gertrude");
        player.nextChat = 271;
        break;
      case 271:
        sendNpcChat1("I'm sorry. It's just that I've lost her.", player.talkingNpc, "Gertrude");
        player.nextChat = 272;
        break;
      case 272:
        ...
        break;
      case 273:
        sendNpcChat1("Fluffs, poor Fluffs, She never hurt anyone.", player.talkingNpc, "Gertrude");
        player.nextChat = 274;
        break;
      case 274:
        ...
        break;
      case 275:
        sendNpcChat4("My beloved feline friend, Fluffs.", "She's been purring by my side for almost a decade.",
            "Could you go and search for her while", "I take care of the children?", player.talkingNpc, "Gertrude");
        player.nextChat = 276;
        break;
      case 276:
        sendOption3("Well, I suppose I could though I'd need more details.", "What's in it for me?",
      ...
      case 278: // 9169
        ...
        break;
      case 279: // 9168
        sendNpcChat1("Come back with a better attitude a maybe you will find out.", player.talkingNpc, "Gertrude");
        player.nextChat = 0;
        break;
      case 280:
        sendNpcChat2("Really? Thank you so much!", "I really have no idea where she could be!", player.talkingNpc,
            "Gertrude");
        player.gertCat = 1;
        player.nextChat = 281;
        break;
      case 281:
        sendNpcChat2("I think my sons, Shilop and Wilough, saw the cat last.", "They'll be out in the marketplace.",
      ...
      case 282:
        ...
        break;
      case 283:
        sendNpcChat4("Really? Well, I generally let them do what they want,",
            "so I've no idea exactly what they would be doing.", "They are good lads, though. I'm sure, they are",
            "just watching the passers-by in Varrock Marketplace.", player.talkingNpc, "Gertrude");
        player.nextChat = 284;
        break;
      case 284:
        sendNpcChat1("Oh, to be young and carefree again!", player.talkingNpc, "Gertrude");
        player.nextChat = 285;
        break;
      case 285:
        sendPlayerChat2("I'll see what I can do. Two young lads in Varrock.",
      ...
      case 286:
        ...
        break;
      case 287:
        sendNpcChat1("I didn't mean to take it! I just forgot to pay.", player.talkingNpc, "Wilough");
        player.nextChat = 288;
        break;
      case 288:
      ...
      case 289:
        sendNpcChat4("Ohh...well, in that case I might be able to help.",
            "Fluffs followed me to my super secret hideout.", "I haven't seen her since.",
            "She's probably off eating small creatures somewhere.", player.talkingNpc, "Wilough");
        player.nextChat = 290;
        break;
      case 290:
      ...
      case 291:
        sendNpcChat2("If I told you that, It wouldn't be a secret.",
            "What if I need to escape for the law? I need a hideout.", player.talkingNpc, "Wilough");
        player.nextChat = 292;
        break;
      case 292:
        ...
        break;
      case 293:
        sendNpcChat3("Well it's still mine anyway, we need a place to relax,", "sometimes.",
            "Those two little brothers at the house are just such babies.", player.talkingNpc, "Wilough");
        player.nextChat = 294;
        break;
      case 294:
        sendOption3("Tell me sonny, or I will inform you are a pair of criminals.", "What will make you tell me?",
            "Well never mind, it's Fluffs loss.");
        player.dialogueAction = 61;
        break;
      case 295: // 9167
        sendNpcChat1("No. Where not criminals.", player.talkingNpc, "Wilough");
        player.nextChat = 0;
        break;
      case 296: // 9169
      ...
      case 297: // 9168
        ...
        break;
      case 298:
        sendNpcChat1("Well...now you ask, I am a bit short on cash.", player.talkingNpc, "Wilough");
        player.nextChat = 299;
        break;
      case 299:
      ...
      case 302:
        ...
        break;
      case 303:
        sendNpcChat1("100 coins should cover it.", player.talkingNpc, "Shilop");
        player.nextChat = 304;
        break;
      case 304:
        ...
        break;
      case 305:
        sendNpcChat2("Well I don't like chocolate", "and have you seen how much sweets cost to buy?", player.talkingNpc,
            "Shilop");
        player.nextChat = 306;
        break;
      case 306:
        ...
        break;
      case 307:
        sendNpcChat4("Obviously you shouldn't pay that much,", "but I won't help otherwise. I never liked,",
            "that cat anyway, fussy scratchy thing it is", "so what do you say?", player.talkingNpc, "Shilop");
        player.nextChat = 308;
        break;
      case 308:
      ...
      case 310:
        ...
        break;
      case 311:
        sendPlayerChat2("I'll want you to tell your mother what a nice person I am",
      ...
      case 314:
        ...
        break;
      case 315:
        sendNpcChat4("We hide out at the lumber mill to the northeast.", "Just beyond the Jolly Beat Inn.",
            "I saw Fluffs running around in there. Well,", "not so much running as plodding lazily, you get the point.",
      ...
      case 316:
        ...
        break;
      case 317:
        sendNpcChat4("Well, technically you are tresspassing inside there but noone seems to care.",
            "You'll have to find the broken fence to get in.", "It will be a bit of a squeeze for a grown-up but",
            "I'm sure you can manage that.", player.talkingNpc, "Wilough");
        player.nextChat = 0;
        break;
      case 318:
        sendStatement("Mew");
      ...
      case 327:
        ...
        break;
      case 328:
        sendPlayerChat2("Hello Gertrude. Fluffs has run off with her lost kittens.",
            "That I have now returned to her.");
        player.nextChat = 329;
        break;
      case 329:
        sendNpcChat4("You're Back!", "Thank you, thank you!", "Fluffs just came back. I think she was upset,",
            "because she couldn't find her kittens.", player.talkingNpc, "Gertrude");
        player.nextChat = 330;
        break;
      case 330:
        ...
        break;
      case 331:
        sendNpcChat2("If you wouldn't have found her kittens,", "then they would have died out there.",
            player.talkingNpc, "Gertrude");
        player.nextChat = 332;
        break;
      case 332:
        ...
        break;
      case 333:
        sendNpcChat3("I don't know how to thank you.", "I have no real material possesions, but I do have kittens.",
            "I can really only look after one or two.", player.talkingNpc, "Gertrude");
        player.nextChat = 334;
        break;
      case 334:
        ...
        break;
      case 335:
        sendNpcChat4("I would sell one to my couzin in West Aroudnge.", "I hear there's a " + " epidemic there,",
            "but it's too far for me to travel.", "With all my boys and all.", player.talkingNpc, "Gertrude");
        player.nextChat = 336;
        break;
      case 336:
        sendNpcChat1("Here you go look after her and thank you.", player.talkingNpc, "Gertrude");
        player.nextChat = 337;
        break;
      case 337:
        ...
        break;
      case 338:
        sendNpcChat1("Welcome to the church of holy Saradomin..", player.talkingNpc, "Father Aereck");
        player.nextChat = 339;
        break;
      case 339:
        ...
        break;
      case 340:// 9178
        sendNpcChat1("None of your buisness.", player.talkingNpc, "Father Aereck");
        player.nextChat = 0;
        break;
      case 341:// 9179
      ...
      case 342:// 9180
        ...
        break;
      case 343:
        sendNpcChat1("That's lucky, I need someone to do a quest for me.", player.talkingNpc, "Father Aereck");
        player.nextChat = 344;
        break;
      case 344:
        ...
        break;
      case 345:
        sendNpcChat3("Thank you. The problem is there's,", "a ghost in the graveyard crypt just south of this church.",
            "I would like you to get rid of it.", player.talkingNpc, "Father Aereck");
        player.nextChat = 346;
        break;
      case 346:
        sendNpcChat2("You'll need the help of my friend, Father Urhney,", "who is a bit of a ghost expert.",
            player.talkingNpc, "Father Aereck");
        player.nextChat = 347;
        break;
      case 347:
        sendNpcChat2("He's currently living in a little shack to the south of,", "the Lumbridge Swamp near the coast.",
            player.talkingNpc, "Father Aereck");
        player.nextChat = 348;
        break;
      case 348:
        sendNpcChat2("My name is Father Aereck, by the way.", "Pleased to meet you.", player.talkingNpc,
            "Father Aereck");
        player.nextChat = 349;
        break;
      case 349:
        ...
        break;
      case 350:
        sendNpcChat3("Take care traveling through the swamps.", "To get there just follow the path south,",
            "through the graveyard.", player.talkingNpc, "Father Aereck");
        player.nextChat = 351;
        player.restGhost = 1;
        QuestAssistant.sendStages(player);
        break;
      case 351:
        ...
        break;
      case 352:
        sendNpcChat1("Go away! I'm meditating.", player.talkingNpc, "Father Urhney");
        player.nextChat = 353;
        break;
      case 353:
        sendOption4("Well, that's friendly", "Father Aereck sent me to talk to you",
      ...
      case 356: // 9179
        ...
        break;
      case 357:
        sendNpcChat2("I suppose I better talk to you then.", "What has he got himself into this time?",
      ...
      case 359: // 9158
        ...
        break;
      case 360:
        sendNpcChat1("Yes, he does. A ghost is haunting his graveyard.", player.talkingNpc, "Father Urhney");
        player.nextChat = 0;
        break;
      case 361:
        ...
        break;
      case 362:
        sendNpcChat1("Oh, the silly fool.", player.talkingNpc, "Father Urhney");
        player.nextChat = 363;
        break;
      case 363:
        sendNpcChat2("I leave town for five months,", "and he's already having problems.", player.talkingNpc,
            "Father Urhney");
        player.nextChat = 364;
        break;
      case 364:
        ...
        break;
      case 365:
        sendNpcChat3("Well I can't go back and exorcise it", "I vowed not to leave this place until,",
            "I've spent a full two years praying and meditating.", player.talkingNpc, "Father Urhney");
        player.nextChat = 366;
        break;
      case 366:
        sendNpcChat1("I'll tell you what I can do though take this amulet.", player.talkingNpc, "Father Urhney");
        player.nextChat = 367;
        player.getItemAssistant().addOrDropItem(552, 1);
        player.restGhost = 2;
        break;
      case 367:
        sendNpcChat1("It's a ghost speak amulet.", player.talkingNpc, "Father Urhney");
        player.nextChat = 368;
        break;
      case 368:
        sendNpcChat3("It's called that because, when you wear it, you can,",
            "speak to ghosts. Many ghosts are doomed to remain in this,",
            "world because they have some important task left uncompleted.", player.talkingNpc, "Father Urhney");
        player.nextChat = 369;
        break;
      case 369:
        sendNpcChat3("If you know what this task is, you can get rid of the ghost.",
            "I'm not making any guarentees, mind you,", "but it's the best I can do right now.", player.talkingNpc,
            "Father Urhney");
        player.nextChat = 370;
        break;
      case 370:
      ...
      case 371:
        ...
        break;
      case 372:
        sendNpcChat1("Not very good, actually.", player.talkingNpc, "Restless Ghost");
        player.nextChat = 373;
        break;
      case 373:
        ...
        break;
      case 374:
        sendNpcChat1("Did you just understand what I said?", player.talkingNpc, "Restless Ghost");
        player.nextChat = 375;
        break;
      case 375:
        sendOption4("Yep. Now, tell me what the problem is.", "No, you sound like you're speaking nonsense to me.",
      ...
      case 378: // 9178
        ...
        break;
      case 379:
        sendNpcChat2("Wow! This is incredible!", "I didn't expect anyone to ever understand me!", player.talkingNpc,
            "Restless Ghost");
        player.nextChat = 380;
        break;
      case 380:
      ...
      case 381:
        ...
        break;
      case 382:
        sendNpcChat1("Well, to be honest, I'm not sure.", player.talkingNpc, "Restless Ghost");
        player.nextChat = 383;
        break;
      case 383:
        ...
        break;
      case 384:
        sendNpcChat1("I should think it's because I've lost my head.", player.talkingNpc, "Restless Ghost");
        player.nextChat = 385;
        break;
      case 385:
      ...
      case 386:
        sendNpcChat4("No, no, I mean from my REAL body.",
            ...
            "while I was mining. It was at the mine just south of this", player.talkingNpc, "Restless Ghost");
        player.nextChat = 387;
        break;
      case 387:
      ...
      case 389:
        ...
        break;
      case 390:
        sendNpcChat2("Why isn't she returning any of them...", "Is it my hair...", player.talkingNpc, "Romeo");
        player.nextChat = 391;
        break;
      case 391:
      ...
      case 394: // 9157
        ...
        break;
      case 396:
        sendNpcChat1("My Juliet..my poor poor Juliet", player.talkingNpc, "Romeo");
        player.nextChat = 397;
        break;
      case 397:
        sendNpcChat3("I've been trying to contact her all day", "but the problem is...she won't return any",
      ...
      case 398:
        ...
        break;
      case 399: // 9157
        sendNpcChat1("Well you see...the problem is..", player.talkingNpc, "Romeo");
        player.nextChat = 401;
        break;
      case 401:
        sendNpcChat1("Her mother doesn't know we've been dating.", player.talkingNpc, "Romeo");
        player.nextChat = 402;
        break;
      case 402:
        sendNpcChat1("Can you please speak with Juliet and see what's going on?", player.talkingNpc, "Romeo");
        player.nextChat = 403;
        break;
      case 403:
      ...
      case 407:
        player.romeojuliet++;
        QuestAssistant.sendStages(player);
        sendNpcChat2("Great, Juliet is just in the house west of here", "You will most likely find her upstairs.",
            player.talkingNpc, "Romeo");
        player.nextChat = 0;
        break;
      case 408:
        sendNpcChat1("Please speak to Juliet for me", player.talkingNpc, "Romeo");
        player.nextChat = 0;
        break;
      case 409:
      ...
      case 411:
        ...
        break;
      case 412:
        sendNpcChat1("I can't explain much. Please just go.", player.talkingNpc, "Juliet");
        player.nextChat = 413;
        break;
      case 413:
        ...
        break;
      case 414:
        sendNpcChat1("Just go...you shouldn't be here.", player.talkingNpc, "Juliet");
        player.nextChat = 0;
        break;
      case 415:
        sendNpcChat1("Hey did you talk to her yet?..How I long for Juliet.", player.talkingNpc, "Romeo");
        player.nextChat = 416;
        break;
      case 416:
      ...
      case 418:
        sendNpcChat3("Dear Romeo...sadly we can not see each other anymore",
            "mother has been complaining on how you aren't the right", "person.", player.talkingNpc, "Romeo");
        player.nextChat = 419;
        break;
      case 419:
        sendNpcChat3("We come from two different classes..", "I'm just some lonely Varrock girl, and",
            "your a fine prince that travels around the world..", player.talkingNpc, "Romeo");
        player.nextChat = 420;
        break;
      case 420:
        sendNpcChat1("This is my goodbyes...Juliet...", player.talkingNpc, "Romeo");
        player.nextChat = 0;
        player.romeojuliet++;
        player.romeojuliet++;
        break;
      case 421:
        sendNpcChat1("Well have you spoken to her?", player.talkingNpc, "Romeo");
        player.nextChat = 422;
        break;
      case 422:
        ...
        break;
      case 423:
        sendNpcChat2("Please bring it as soon as possible...", "How I miss my Juliet", player.talkingNpc, "Romeo");
        player.nextChat = 0;
        break;
      case 424:
        ...
        break;
      case 425:
        sendNpcChat1("What have I done wrong...", player.talkingNpc, "Romeo");
        player.nextChat = 426;
        break;
      case 426:
      ...
      case 428:
        ...
        break;
      case 429:
        sendNpcChat2("No, your right. Please", "speak to the witch just south west of here.", player.talkingNpc,
            "Romeo");
        player.nextChat = 430;
        break;
      case 430:
        ...
        break;
      case 431:
        sendNpcChat1("Speak to Winelda. She's south west.", player.talkingNpc, "Romeo");
        player.nextChat = 0;
        break;
      case 432:
        sendNpcChat1("So I see that prince sent you here.", player.talkingNpc, "Winelda");
        player.nextChat = 433;
        break;
      case 433:
        ...
        break;
      case 434:
        sendNpcChat2("I'm a witch..I've studied the arts", "of magic for years.", player.talkingNpc, "Winelda");
        player.nextChat = 435;
        break;
      case 435:
        sendNpcChat2("I will help you. This one time.", "But next time I won't be so kind.", player.talkingNpc,
            "Winelda");
        player.nextChat = 436;
        break;
      case 436:
      ...
      case 438:// 9157
        ...
        break;
      case 439:
        sendNpcChat1("You need, 1 rat's tail, 1 bone, and a vial of water", player.talkingNpc, "Winelda");
        player.nextChat = 440;
        break;
      case 440:
        sendNpcChat2("Bring those items here and I'll make you a potion", "that makes anyone tell the truth.",
            player.talkingNpc, "Winelda");
        player.nextChat = 0;
        player.romeojuliet++;
        break;
      case 441:
        sendNpcChat1("You need, 1 rats tail, 1 bone, and a vial of water", player.talkingNpc, "Winelda");
        player.nextChat = 442;
        break;
      case 442:
        sendNpcChat1("Speak to me when you have all 3 items.", player.talkingNpc, "Winelda");
        player.nextChat = 0;
        break;
      case 443:
      ...
      case 444:
        ...
        break;
      case 445:
        sendNpcChat1("Which items if you don't mind me asking?", player.talkingNpc, "Romeo");
        player.nextChat = 446;
        break;
      case 446:
      ...
      case 450:
        ...
        break;
      case 451:
        sendNpcChat1("Tell Juliet to drink this", player.talkingNpc, "Winelda");
        player.nextChat = 453;
        break;
      case 453:
        ...
        break;
      case 454:
        sendNpcChat3("I don't know?!", "What do I look like some kind of", "fortune teller?", player.talkingNpc,
            "Winelda");
        player.nextChat = 455;
        break;
      case 455:
        sendNpcChat1("Tell her it's soup or something.", player.talkingNpc, "Winelda");
        player.nextChat = 456;
        break;
      case 456:
      ...
      case 461:
        ...
        break;
      case 462:
        sendNpcChat1("Well...tomorrow's Romeos birthday.", player.talkingNpc, "Juliet");
        player.nextChat = 463;
        break;
      case 463:
        sendNpcChat3("Mama and I wanted to show Romeo that", "Even though he's richer then us we still",
      ...
      case 464:
        ...
        break;
      case 465:
        sendNpcChat2("Yeah, I've been telling Mother to act", "grouchy with him.", player.talkingNpc, "Juliet");
        player.nextChat = 466;
        break;
      case 466:
        sendNpcChat2("That way we can throw him off easily.", "that's what a surprise is.", player.talkingNpc,
            "Juliet");
        player.nextChat = 467;
        break;
      case 467:
        ...
        break;
      case 468:
        sendNpcChat1("Wait your not going to tell Romeo are you?", player.talkingNpc, "Juliet");
        player.nextChat = 0;
        break;
      case 469:
        sendNpcChat1("So? What's going on with Juliet?", player.talkingNpc, "Romeo");
        player.nextChat = 470;
        break;
      case 470:
      ...
      case 471:
        ...
        break;
      case 472:
        sendNpcChat1("Wait but my birthday isn't till next week", player.talkingNpc, "Romeo");
        player.nextChat = 473;
        break;
      case 473:
        sendNpcChat2("That was very thoughtful of her", "Thank you young traveller for all your help",
            player.talkingNpc, "Romeo");
        player.nextChat = 474;
        break;
      case 474:
        QuestRewards.julietFinish(player);
        sendNpcChat2("Juliet and I have been great ever", "since you've helped. Thank you adventurer",
            player.talkingNpc, "Romeo");
      ...
      case 211:
        ...
        break;
      case 476:
        sendNpcChat2("Praise Saradomin! He has Brought you here to save us", "all!", player.talkingNpc, "Morgan");
        player.nextChat = 477;
        break;
      case 477:
        sendPlayerChat1("Wha-");
      ...
      case 478:
        sendNpcChat3("He has guided your steps to my door, So that",
            "I may beseech you to save my village from a terrible", "threat.", player.talkingNpc, "Morgan");
        player.nextChat = 479;
        break;
      case 479:
      ...
      case 482:
        sendNpcChat3("Our village is plagued by a vampire. He visits us",
            "frequently and demands blood payments or he will,", "terroise us all!", player.talkingNpc, "Morgan");
        player.nextChat = 483;
        break;
      case 483:
        ...
        break;
      case 484:
        sendNpcChat3("I don't know, I just moved here with my wife.", "We'd move on again,",
            "but we're down on our luck and can't afford to.", player.talkingNpc, "Morgan");
        player.nextChat = 485;
        break;
      case 485:
        sendNpcChat3("Besides, I don't want to abandon other innocents to this,",
            "fate. This could be a good community.", "If only that vampire would leave us.", player.talkingNpc,
            "Morgan");
        player.nextChat = 486;
        break;
      case 486:
        sendNpcChat1("Will you help me, brave adventurer?", player.talkingNpc, "Morgan");
        player.nextChat = 487;
        break;
      case 487:
        sendOption2("Yes", "No");
      ...
      case 488:// 9157
        ...
        break;
      case 489:
        sendNpcChat4("Wonderful! You will succeed.,", "I'm sure of it you are very brave to take this on.",
            "But you should speak to my friend Harlow before you,", "do anything else.", player.talkingNpc, "Morgan");
        player.nextChat = 490;
        break;
      case 490:
        ...
        break;
      case 491:
        sendNpcChat4("He is a retired vampire slayer!,", "I met him when i was a missionaire, long ago.",
            "He will be able to advise you on the best methods to,", "vanquish the vampire.", player.talkingNpc,
            "Morgan");
        player.nextChat = 492;
        break;
      case 492:
        ...
        break;
      case 493:
        sendNpcChat3("Harlow is... past his prime.. He's seen too many evil things in",
            "his life, and, to forget that, he drinks himself into,",
            "oblivion. I fear he will slayer vampires no more.", player.talkingNpc, "Morgan");
        player.nextChat = 494;
        break;
      case 494:
      ...
      case 495:
        sendNpcChat4("He spends his time at the Blue Moon Inn, located in,",
            "Varrock. If you enter Varrock from the south it is,", "the second building on your right. I'm sure,",
            "it's filled with lively people, so you shouldn't miss it.", player.talkingNpc, "Morgan");
        player.nextChat = 496;
        break;
      case 496:
        ...
        break;
      case 497:
        sendNpcChat1("May Saradomin protect you, my friend!", player.talkingNpc, "Morgan");
        player.nextChat = 0;
        break;
      case 498:
        sendNpcChat1("Buy me a drink please.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 499;
        break;
      case 499:
        sendOption4("No you've had enough.", "Are you Dr Harlow, the famous vampire slayer?",
            "You couldn't possibly be Dr Harlow, your just a drunk.", "Never mind.");
      ...
      case 502:// 9179
        ...
        break;
      case 503:
        sendNpcChat1("Dependish whose is ashking.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 504;
        break;
      case 504:
        ...
        break;
      case 505:
        sendNpcChat2("Shure I can teach you.", "I wash the best vampire shhlayer ever.", player.talkingNpc,
            "Doctor Harlow");
        player.nextChat = 506;
        break;
      case 506:
        sendNpcChat1("Buy me a beer and I'll teach you.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 507;
        break;
      case 507:
        ...
        break;
      case 508:
        sendNpcChat1("Buy ush a drink anyway.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 509;
        break;
      case 509:
      ...
      case 511:
        ...
        break;
      case 512:
        sendNpcChat1("Yes, yes, vampires, I was very good at killing em once.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 513;
        break;
      case 513:
        sendNpcChat2("Vampire slaying is not to be undertaken lighty.", "You must go in prepared, or you will die.",
      ...
      case 514:
        ...
        break;
      case 515:
        sendNpcChat3("A stake is an essential tool for any vampire slayer. The,",
            "stake must be used in the final blow againt the vampire.",
            "Or his dark magic will regenerate him to full health.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 516;
        break;
      case 516:
        sendNpcChat1("I always carry a spare, so you can have one.", player.talkingNpc, "Doctor Harlow");
        player.getItemAssistant().addOrDropItem(1549, 1);
        player.nextChat = 517;
        break;
      case 517:
        sendNpcChat2("You'll need a special hammer as well, to drive it in in", "properly.", player.talkingNpc,
            "Doctor Harlow");
        player.nextChat = 518;
        break;
      case 518:
        sendNpcChat1("Hmm, I think i have a spare hammer you can have.", player.talkingNpc, "Doctor Harlow");
      ...
      case 519:
        sendNpcChat2("One last thing. It's wise to carry garlic with you,",
            "vampires are slightly weakened if they can smell garlic.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 520;
        break;
      case 520:
        sendNpcChat4("Garlic is pretty common,", "I know I always advised Morgan to keep a supply,",
            "so you might be able to get some from him.", "If not, I know they it is in Port Sarim.", player.talkingNpc,
            "Doctor Harlow");
        player.nextChat = 521;
        break;
      case 521:
        ...
        break;
      case 522:
        sendNpcChat1("You are a eager one.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 523;
        break;
      case 523:
        sendNpcChat4("Killing a vampire is D A N G E R O U S!", "Never forget that. Go in prepared",
            "Understand you may die.", "It's a risk we all take in the buisness.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 524;
        break;
      case 524:
        sendNpcChat2("I've seen many fine men and women,", "die at the hands of vampires.", player.talkingNpc,
            "Doctor Harlow");
        player.nextChat = 525;
        break;
      case 525:
        sendNpcChat4("Enter the vampire's lair and attempt to open the coffin.",
            "He should be asleep in there, so try to use the stake on,", "him. As you're new at this you'll,",
            "probably just wake him up and the real fight begins.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 526;
        break;
      case 526:
        sendNpcChat3("Fight him until he's nearly dead, and,", "when the moment is right. Stake him through the heart",
            "and hammer it in.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 527;
        break;
      case 527:
        sendNpcChat3("It's gruesome, but it's the only way.", "Once he's dead speak to morgan so",
            "he can notify the village.", player.talkingNpc, "Doctor Harlow");
        player.nextChat = 528;
        break;
      case 528:
      ...
      case 529:
        ...
        break;
      case 530:
        sendNpcChat1("Congratulations! You have saved the village.", player.talkingNpc, "Morgan");
      ...
      case 531:
        ...
        break;
      case 532:
        sendNpcChat1("What could you want with an old woman like me?", player.talkingNpc, "Hetty");
        player.nextChat = 533;
        break;
      case 533:
      ...
      case 535: // 9158
        ...
        break;
      case 536:
        sendNpcChat2("Would you like to become more proficient in the", "dark arts?", player.talkingNpc, "Hetty");
        player.nextChat = 537;
        break;
      case 537:
        sendOption3("Yes help me become one with my darker side.", "No I have my principles and hour.",
      ...
      case 540:// 9167
        ...
        break;
      case 541:
        sendNpcChat2("Ok, I'm going to make a potion to help bring out your", "darker self.", player.talkingNpc,
            "Hetty");
        player.nextChat = 542;
        break;
      case 542:
        sendNpcChat1("You will need certain ingredients.", player.talkingNpc, "Hetty");
        player.nextChat = 543;
        break;
      case 543:
        ...
        break;
      case 544:
        sendNpcChat2("You need an eye of newt, a rat's tail, an onion...", "Oh and a peice of burnt mean.",
      ...
      case 545:
        ...
        break;
      case 546:
        sendNpcChat1("So have you found the things for my potion?", player.talkingNpc, "Hetty");
        player.nextChat = 547;
        break;
      case 547:
        if (player.getItemAssistant().playerHasItem(221, 1) && player.getItemAssistant().playerHasItem(300, 1)
      ...
      case 549:
        ...
        break;
      case 550:
        sendNpcChat1("Excellent can I have them?", player.talkingNpc, "Hetty");
        player.nextChat = 551;
        break;
      case 551:
        if (player.getItemAssistant().playerHasItem(221, 1) && player.getItemAssistant().playerHasItem(300, 1)
            && player.getItemAssistant().playerHasItem(2146, 1)) {
          sendStatement4("You pass the ingredients to Hetty and she puts them all into her,", "Cauldron.",
              "Hetty closes her eyes and begins to chant.", "The caludron bubbles mysteriously.");
      ...
      case 552:
        ...
        break;
      case 553:
        sendNpcChat1("Ok, now drink from the cauldron.", player.talkingNpc, "Hetty");
        player.nextChat = 0;
        break;
      case 554:
      ...
      case 557:
        sendNpcChat2("Arr, trasure you be after eh?",
            "Well I might be able to tell you where to find some... For a price...", player.talkingNpc,
            "Redbeard Frank");
        player.nextChat = 558;
        break;
      case 558:
        ...
        break;
      case 559:
        sendNpcChat2("Well for example if you can get me a bottle of rum..", "Not just any rum mind...",
            player.talkingNpc, "Redbeard Frank");
        player.nextChat = 560;
        break;
      case 560:
        sendNpcChat2("I'd like some rum made on Karamja Island.", "There's no rum like Karamja Rum!", player.talkingNpc,
            "Redbeard Frank");
        player.nextChat = 561;
        break;
      case 561:
      ...
      case 563:// 9157
        ...
        break;
      case 564:
        sendNpcChat1("Yer a saint, although it'll take a miracle to get it off Karamja.", player.talkingNpc,
            "Redbeard Frank");
        player.nextChat = 565;
        break;
      case 565:
        ...
        break;
      case 566:
        sendNpcChat3("The customs office has been clampin' down on the export of spirits. ",
            "You seem like a resourceful young lad,",
            " I'm sure ye'll be able to find a way to slip the stuff past them.", player.talkingNpc, "Redbeard Frank");
        player.nextChat = 567;
        break;
      case 567:
        ...
        break;
      case 568:
        sendNpcChat1("Arr, that's the spirit!", player.talkingNpc, "Redbeard Frank");
        player.nextChat = 0;
        player.pirateTreasure = 1;
        QuestAssistant.sendStages(player);
        break;
      case 569:
        if (player.pirateTreasure == 2 && player.getItemAssistant().playerHasItem(431, 1)) {
          sendNpcChat1("Arr, Matey!", player.talkingNpc, "Redbeard Frank");
          player.nextChat = 570;
        } else {
        ...
        break;
      case 570:
        sendNpcChat1("Have ye brought some rum for yer ol' mate Frank?", player.talkingNpc, "Redbeard Frank");
        player.nextChat = 571;
        break;
      case 571:
        ...
        break;
      case 572:
        sendNpcChat2("Now a deal's a deal, I'll tell ye about the treasure.",
            "I used to server under a pirate captain called One-Eyed Hector.", player.talkingNpc, "Redbeard Frank");
        player.nextChat = 573;
        break;
      case 573:
        sendNpcChat2("Hector were very successful and became very rich.",
            "But about a year ago we were boarded by the Customs and Excise Agents.", player.talkingNpc,
            "Redbeard Frank");
        player.nextChat = 574;
        break;
      case 574:
        sendNpcChat2("Hector were killed along with many of the crew,",
            "I were one of the few to escape and I escaped with this.", player.talkingNpc, "Redbeard Frank");
        player.nextChat = 575;
        break;
      case 575:
        if (player.getItemAssistant().playerHasItem(431, 1)) {
      ...
      case 576:
        sendNpcChat2("This be Hector's key. ",
            "I belive it opens his chest in his old room in the Blue Moon Inn in Varrock.", player.talkingNpc,
            "Redbeard Frank");
        player.nextChat = 577;
        break;
      case 577:
        sendNpcChat1("With any luck his treasure will be in there.", player.talkingNpc, "Redbeard Frank");
        player.nextChat = 578;
        break;
      case 578:
      ...
      case 580:// 9158
        ...
        break;
      case 581:
        sendNpcChat1("That's none of your buisness.", player.talkingNpc, "Redbeard Frank");
        player.nextChat = 0;
        break;
      case 582:// 9158
        sendPlayerChat1("Arr!");
      ...
      case 584:
        sendNpcChat1("The trip back to port sarim will cost you 30 coins.", player.talkingNpc, "Sailor");
        player.nextChat = 585;
        break;
      ...
      case 590:
        sendNpcChat1("Hello " + player.playerName + ".", player.talkingNpc, "Gnome Pilot");
        player.nextChat = 591;
        break;

      case 591:
        sendNpcChat1("Would you like to fly my glider?", player.talkingNpc, "Gnome Pilot");
        player.nextChat = 592;
        break;
      ...
      case 596:
        sendNpcChat2("You didn't participate enough to take down", "You've gain less points", player.talkingNpc,
            "Void Knight");
        player.nextChat = 0;
        break;
      case 597:
        sendNpcChat3("You couldn't take down all the portals in time.", "Please try harder next time, or ask more",
            "people to join your game.", player.talkingNpc, "Void Knight");
        player.nextChat = 0;
        break;
      case 598:
        sendNpcChat3("Congratulations " + player.playerName + "! you have taken",
            "down all the portals while keeping the Knight alive", "please accept this reward from us.",
            player.talkingNpc, "Void Knight");
        player.getActionSender().sendMessage("You have won the Pest Control game!");
        player.nextChat = 0;
        break;
      case 599:
        sendNpcChat2("Do not let the Void Knights health reach 0!",
            "You can regain health by destroying more monsters,", player.talkingNpc, "Void Knight");
        player.nextChat = 600;
        break;
      case 600:
        sendNpcChat1("NOW GO AND DESTROY THOSE PORTALS!!!", player.talkingNpc, "Void Knight");
        player.nextChat = 0;
        break;
      case 601:
        sendNpcChat1("You call yourself a Knight?", player.talkingNpc, "Void Knight");
        player.nextChat = 0;
        break;
      case 602:
        sendNpcChat1("Hi welcome to Pest Control.", player.talkingNpc, "Void Knight");
        player.nextChat = 84;
        break;
      case 603:
        sendNpcChat1("Would you like to open the Armor Shop or Exp Shop?", player.talkingNpc, "Void Knight");
        player.nextChat = 85;
        break;
      case 604:
        ...
        break;
      case 605:
        sendNpcChat2("The party room is a fun place where you can put your items",
            "in the chest and drop them and have a party with your friends.", player.talkingNpc, "Party Pete");
        player.nextChat = 0;
        break;
      ...
      case 613:
        sendNpcChat3("Well, Sir Vyvin is a good guy to work for, however,",
            "I'm in a spot of trouble today. I've gone and lost Sir", "Vyvin's sword!", player.talkingNpc, "Squire");
        player.nextChat = 614;
        break;
      case 614:
      ...
      case 616:
        ...
        break;
      case 617:
        sendNpcChat4("The thing is, this sword is a family heirloom. It has been",
            "passed down through Vyvin's family for five", "generations! It was originally made by the Imacando",
            "dwarves, who were", player.talkingNpc, "Squire");
        player.nextChat = 618;
        break;
      case 618:
        sendNpcChat2("a particularly skilled tribe of dwarven smiths.",
            "I doubt anyone could make it in the style they do.", player.talkingNpc, "Squire");
        player.nextChat = 619;
        break;
      case 619:
      ...
      case 621:
        sendNpcChat4("I'm not a hundred percent sure the Imacando tribe",
            "exists anymore. I should think Reldo, the palace", "librarian will know; he has done a lot of",
            "research on the races of Runescape.", player.talkingNpc, "Squire");
        player.nextChat = 622;
        break;
      case 622:
        sendNpcChat3("I don't suppose you could try and track down the",
            "Imcando dwarves for me? I've got so much work to", "do...", player.talkingNpc, "Squire");
        player.nextChat = 623;
        break;
      case 623:
      ...
      case 624:
        ...
        break;
      case 625:
        sendNpcChat2("Thank you very much! As I say, the best place to start", "should be with Reldo...",
      ...
      case 632:
        sendNpcChat3("Ah yes... for many hundreds of years they were the",
            ...
            "knowledge passed down from generation to generation.", player.talkingNpc, "Reldo");
        player.nextChat = 633;
        break;
      case 633:
        sendNpcChat3("Unfortunately, about century ago, the once thriving",
            "race was wiped out during the barbarian invasions of", "that time.", player.talkingNpc, "Reldo");
        player.nextChat = 634;
        break;
      case 634:
        ...
        break;
      case 635:
        sendNpcChat3("I believe a few of them survived, but with the bulk of",
            "their population destroyed their numbers have dwindled", "even further.", player.talkingNpc, "Reldo");
        player.nextChat = 636;
        break;
      case 636:
        sendNpcChat3("I believe I remember a couple living in Asgarnia near",
            "the cliffs on the Asgarnian southern peninsula, but they", "DO tend to keep to themselves.",
      ...
      case 637:
        sendNpcChat4("They tend not to tell people they're the",
            ...
            "have more luck talking to them if you bring them some", player.talkingNpc, "Reldo");
        player.nextChat = 639;
        break;
      case 639:
      ...
      case 646:
        ...
        break;
      case 647:
        sendNpcChat2("By Guthix! THAT was a good pie! Anyone who makes", "pie like THAT has got to be alright!",
      ...
      case 649:
        sendNpcChat2("Well, after bringing me my favorite food I guess I",
            "should give it a go. What sort of sword is it?", player.talkingNpc, "Thurgo");
        player.nextChat = 650;
        break;
      case 650:
        sendPlayerChat4("I need you to make a sword for one of Falador's",
            "knights. He had one which was passed down through five",
            "generations, but his squire lost it. So we need an", "identical one to replace it.");
        player.nextChat = 651;
        break;
      case 651:
        sendNpcChat2("A knight's sword eh? Well I'd need to know exactly",
            "how it looked before I could make a new one.", player.talkingNpc, "Thurgo");
        player.nextChat = 652;
        break;
      case 652:
        sendNpcChat3("All the Faladorian knights used to have sword with",
            "unique designs according to their position. Could you bring me", "a picture or something?",
            player.talkingNpc, "Thurgo");
        player.nextChat = 653;
        break;
      case 653:
      ...
      case 655:
        ...
        break;
      case 656:
        sendNpcChat3("A picture eh? Hmmm.... The only one I can think of is",
            "in a small portrait of Sir Vyvin's father... Sir Vyvin", "keeps it in a cupboard in his room I think.",
            player.talkingNpc, "Squire");
        player.nextChat = 657;
        break;
      case 657:
      ...
      case 661:
        ...
        break;
      case 662:
        sendNpcChat2("Ok. You'll need to get me some stuff in order for me", "to make this.", player.talkingNpc,
            "Thurgo");
        player.nextChat = 663;
        break;
      case 663:
        sendNpcChat4("I'll need two iron bars to make the sword to start with.",
            "I'll also need an ore called blurite. It's useless for", "making actual weapons for fighting with except",
            "crossbows, but I'll need some as decoration for the hilt.", player.talkingNpc, "Thurgo");
        player.nextChat = 664;
        break;
      case 664:
        sendNpcChat2("It is a fairly rare sort of ore... The only place I know",
            "where to get it is under the cliff here...", player.talkingNpc, "Thurgo");
        player.nextChat = 665;
        break;
      case 665:
        ...
        break;
      case 666:
        sendNpcChat3("Most of the rocks in that cliff are pretty useless, and",
            "don't contain much of anything, but there's", "DEFINITELY some blurite in there.", player.talkingNpc,
            "Thurgo");
        player.nextChat = 667;
        break;
      case 667:
        sendNpcChat2("You'll need a little bit of mining experience to be able to", "find it.", player.talkingNpc,
            "Thurgo");
        player.knightS = 7;
        player.nextChat = 668;
        break;
      ...
      case 671:
        if (player.knightS == 7) {
          sendStatement2("You give the blurite ore and two bars to Thurgo. Thurgo starts",
      ...
      case 682:
        ...
        break;
      case 683:
        sendNpcChat2("Thank you, thank you, thank you! I was seriously", "worried I would have to own up to Sir Vyvin!",
            player.talkingNpc, "Squire");
        player.nextChat = 684;
        break;
      case 684:
      ...
      case 908:
        ...
        break;
      case 909:
        sendNpcChat1("Meeeooow.", npcId, NpcHandler.getNpcListName(player.talkingNpc));
        player.nextChat = 0;
        break;
      case 910:
      ...
      case 911:
        ...
        break;
      case 912:
        player.getDialogueHandler().sendStatement("Catching rats is currently disabled.");
        player.nextChat = 0;
        break;
      case 913:
      ...
      case 1000:
        sendNpcChat1("Is it nice and tidy round the back now?", player.talkingNpc, "Wydin");
        player.pirateTreasure = 2;
        player.nextChat = 1001;
        break;
      case 1001:
        sendOption4("Yes, can I work out front now?", "Yes, are you going to pay me yet?", "No it's a complete mess",
      ...
      case 1005:// 9178
        ...
        break;
      case 1006:
        sendNpcChat1("No I'm the person who works here.", player.talkingNpc, "Wydin");
        player.nextChat = 0;
        break;
      case 1007:
      ...
      case 1009:
        ...
        break;
      case 1011:
        sendNpcChat2("How dare you try to take dangerous equipment?", "Come back when you have left it all behind.",
            player.talkingNpc, "Monk of Entrana");
        player.nextChat = 0;
        break;
      case 1012:
        sendNpcChat2("You even defeated TzTok-Jad, I am most impressed!", "Please accept this gift as a reward.",
            player.talkingNpc, "Tzhaar-Mej-Tal");
        player.nextChat = 0;
        break;
      ...
      case 1014:// bank open done, this place done, settings done, to do
                // delete pin
        sendOption3("I'd like to access my bank account, please.", "I'd like to check my my P I N settings.",
            "What is this place?");
      ...
      case 1017:
        sendStartInfo("Since you don't know your P I N, it will be deleted in @red@3 days@bla@. If you",
      ...
      case 1019:
        if (player.absX == 3267 || player.absX == 3268) {
          sendNpcChat1("You must pay a toll of 10 gold coins to pass.", player.talkingNpc, "Border Guard");
      ...
      case 1022:
        ...
        break;
      case 1023:
        sendNpcChat2("The money goes to the city of Al-Kharid.", "Will you pay the toll?", player.talkingNpc,
            "Border Guard");
      ...
      case 1034:
        sendNpcChat1("You have been warned, you can't go back now.", player.talkingNpc, "Runescape Guide");
        player.getPlayerAssistant().movePlayer(3098, 3107, 0);
        player.nextChat = 0;
        break;

      case 1035:
        sendNpcChat1("You have successfully skipped tutorial island.", player.talkingNpc, "Runescape Guide");
        player.getPlayerAssistant().startTeleport(3222, 3218, 0, "modern");
        player.nextChat = 0;
        break;

      case 1036:
        sendNpcChat1("Good day to you Bwana.", player.talkingNpc, "Saniboch");
        player.nextChat = 1037;
        break;
      case 1037:
        sendOption4("Can I go through that door please?", "Where does this strange entrance lead?",
            "Good day to you too.", "I'm impressed, that tree is growing on that shed.");
      ...
      case 1038:
        ...
        break;
      case 1040:
        sendNpcChat2("My employer tells me it is an uncommon sort of tree", "called the Fyburglars tree.",
      ...
      case 1043:
        sendNpcChat3("To a huge fearsome dungeon, populated by giants and",
            "strange dogs. Adventurers come from all around to", "explore its depths", player.talkingNpc, "Saniboch");
        player.nextChat = 1044;
        break;
      case 1044:
        sendNpcChat2("I know not what lies deeper in myself, for my skills in",
            "agility and woodcutting are inadequate.", player.talkingNpc, "Saniboch");
        player.nextChat = 0;
        break;
      case 1045:
        ...
        break;
      case 1046:
        sendNpcChat2("Most certainly, but I must charge you the sum of 875", "coins first.", player.talkingNpc,
            "Saniboch");
      ...
      case 1047:
        ...
        break;
      case 1048:
        sendNpcChat1("You can't go in there without paying me!", player.talkingNpc, "Saniboch");
        player.nextChat = 0;
        break;
      case 1049:
      ...
      case 1051:
        sendNpcChat3("It leads to a huge fearsome dungeon, populated by",
            "giants and strange dogs. Adventurers come from all", "around to explore its depths.", player.talkingNpc,
            "Saniboch");
        player.nextChat = 1052;
        break;
      case 1052:
        sendNpcChat3("I know not what lies deeper in myself, for my skills in",
      ...
      case 1054:
        ...
        break;
      case 1055:
        sendNpcChat2("Many thanks. You may now pass the door. May your", "death be a glorious one!", player.talkingNpc,
            "Saniboch");
        player.nextChat = 0;
        break;
      case 1056:
        ...
        break;
      case 1057:
        sendNpcChat2("Well this is a dungeon for the more wealthy discerning",
            "adventurer, be gone with you riff raff.", player.talkingNpc, "Saniboch");
      ...
      case 1059:
        ...
        break;
      case 1226:
        sendNpcChat2("You already have a slayer task", "please finish it talk to me again.", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
        player.nextChat = 0;
        break;
      case 1227:
        sendNpcChat1("You already have an easier slayer task. Please finish it then talk to me again.",
            player.talkingNpc, NpcHandler.getNpcListName(player.talkingNpc));
        player.nextChat = 0;
        break;
      case 1228:
        sendNpcChat1("'Ello and what are you after then?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
        player.nextChat = 1229;
        break;
      case 1229:
        sendOption4("I need another assignement.", "Where is the location of my task?",
            "I would like to view your shop.", "I would like to cancel or remove my task.");
      ...
      case 1235:
        if (player.getSlayer().hasTask()) {
          sendNpcChat1("Your Slayer Task is located at " + player.getSlayer().getLocation(player.slayerTask) + ".",
              player.talkingNpc, NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        } else {
          sendNpcChat2("You don't have a slayer task", "if you wish to get one talk to a slayer mask.",
              player.talkingNpc, NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      ...
      case 1237:
        sendNpcChat2(
            "You have been assigned " + player.taskAmount + " " + player.getSlayer().getTaskName(player.slayerTask)
                + ",",
            "Good luck " + player.playerName + ".", player.talkingNpc, NpcHandler.getNpcListName(player.talkingNpc));
        player.nextChat = 0;
        break;

      case 1300:
        sendNpcChat2("Good afternoon, sir. In need of a haircut or shave, are", "we?", player.talkingNpc,
            "Hairdresser");
      ...
      case 1303:
        sendNpcChat1("Certainly, sir. The fee will be 2,000 coins.", player.talkingNpc, "Hairdresser");
        player.nextChat = 1304;
        break;

      case 1304:
        if (player.getItemAssistant().playerHasItem(995, 2000)) {
          sendNpcChat2("Please select a hairstyle you would", "like from this brochure.", 598, "Hairdresser");
          player.nextChat = 1305;
        } else {
          sendNpcChat2("It looks like you don't have 2,000 coins,", "please revisit when you do.", 598, "Hairdresser");
          player.nextChat = 0;
        }
        break;
      ...
      case 1307:
        sendNpcChat1("Very well. Come back if you change your mind.", player.talkingNpc, "Hairdresser");
        player.nextChat = 0;
        break;
      // END
      ...
      case 1310:
        if (player.getItemAssistant().playerHasItem(995, 2000)) {
          sendNpcChat2("Please select a beard and color you would", "like from this brochure.", player.talkingNpc,
              "Hairdresser");
          player.nextChat = 1311;
        } else {
          sendNpcChat2("It looks like you don't have 2,000 coins,", "please revisit when you do.", player.talkingNpc,
              "Hairdresser");
          player.nextChat = 0;
        }
        break;
      case 1311:
        ...
        break;
      case 1312:
        sendNpcChat1("What sort of dye would you like? Red, yellow, or blue?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 1314:// red 1763, yellow 1765, blue 1767
        if (player.getItemAssistant().playerHasItem(1951, 3) && player.getItemAssistant().playerHasItem(995, 5)) {
          player.getItemAssistant().deleteItem2(1951, 3);
          player.getItemAssistant().addOrDropItem(1763, 1);
          sendPlayerChat1("Red Dye Please.");
          player.nextChat = 0;
        } else {
          sendNpcChat1("You need 5 coins and 3 redberries to make red dye.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      case 1315:// red 1763, yellow 1765, blue 1767
        if (player.getItemAssistant().playerHasItem(1957, 2) && player.getItemAssistant().playerHasItem(995, 5)) {
          player.getItemAssistant().deleteItem2(1957, 2);
          player.getItemAssistant().addOrDropItem(1765, 1);
          sendPlayerChat1("Yellow Dye Please.");
          player.nextChat = 0;
        } else {
          sendNpcChat1("You need 5 coins and 2 onions to make yellow dye.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      case 1316:// red 1763, yellow 1765, blue 1767
        if (player.getItemAssistant().playerHasItem(1793, 2) && player.getItemAssistant().playerHasItem(995, 5)) {
          player.getItemAssistant().deleteItem2(1793, 2);
          player.getItemAssistant().addOrDropItem(1767, 1);
          sendPlayerChat1("Blue Dye Please.");
          player.nextChat = 0;
        } else {
          sendNpcChat1("You need 5 coins and 2 woad leaves to make blue dye.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      case 1317:
        sendNpcChat1("Welcome to the Guild of Master Craftsman.", player.talkingNpc, "Master Crafter");
        player.nextChat = 0;
        break;
      ...
      case 1318:
        if (player.getSlayer().hasTask()) {
          sendNpcChat3("Hello " + player.playerName + ".",
              "You currently need to kill " + player.taskAmount + " more "
                  + player.getSlayer().getTaskName(player.slayerTask) + ".",
              "in the " + player.getSlayer().getLocation(player.slayerTask) + ".", player.talkingNpc,
      ...
      case 1319:
        if (player.getSlayer().hasTask()) {
          sendNpcChat1("I am " + player.getSlayer().getSlayerMaster(player.SlayerMaster) + ".", player.talkingNpc,
              NpcHandler.getNpcListName(player.SlayerMaster));
          player.nextChat = 0;
        } else {
          sendNpcChat1("You don't have a slayer task.", player.talkingNpc,
      ...
      case 1320:
        if (player.getSlayer().hasTask()) {
          sendNpcChat2("Hello " + player.playerName + ".",
              "I am located in " + player.getSlayer().getMasterLocation(player.SlayerMaster) + ".", player.talkingNpc,
              NpcHandler.getNpcListName(player.SlayerMaster));
          player.nextChat = 0;
        } else {
          sendNpcChat1("You don't have a slayer task.", player.talkingNpc,
        ...
        break;
      case 1321:
        sendNpcChat1("You have " + player.slayerPoints + " slayer points nice job!", player.talkingNpc,
            NpcHandler.getNpcListName(player.SlayerMaster));
        player.nextChat = 0;
        break;

      case 1322:
        sendNpcChat2("Hello " + player.playerName + ".", "Are you interested in buying anything?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 1335:
        if (player.getItemAssistant().playerHasItem(6183, 1)) {
          ...
          sendNpcChat1("You don't have any frog tokens.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      ...
      case 1336:
        if (player.getItemAssistant().playerHasItem(6183, 1) && player.playerAppearance[0] == 0) {
          ...
          player.nextChat = 0;
        } else if (player.getItemAssistant().playerHasItem(6183, 1) && player.playerAppearance[0] == 1) {
      ...
      case 1341:
        sendOption3("I will give you 15 coins for 1 rope.", "I will give you 4 balls of wool for 1 rope.",
            "Never mind.");
      ...
      case 1344:
        if (player.getItemAssistant().playerHasItem(1759, 4)) {
          ...
          sendNpcChat1("You don't even have 4 balls of wool.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      ...
      case 1345:
        sendNpcChat1("Hello, would you like to buy climbing boots for 12 gp?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 1348:
        if (player.getItemAssistant().playerHasItem(995, 12)) {
          ...
          sendNpcChat1("You need 12 gp to buy these.", player.talkingNpc, NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;

      case 1349:
        if (player.absY > 3485 && player.absY < 3489 && player.hasPaid != true) {
          sendNpcChat2("Hello, are you interested in traveling up the river", "for 50 coins?", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 1350;
        } else if (player.hasPaid != true) {
          sendNpcChat2("Hello, are you interested in traveling back down the river", "for 50 coins?", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 1350;
        } else if (player.hasPaid == true && player.absY > 3485 && player.absY < 3489) {
          sendNpcChat1("Hello, are you interested in a free ride up the river?", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 1350;
        } else if (player.hasPaid == true) {
          sendNpcChat1("Hello, are you interested in a free back down the river?", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 1350;
        }
        break;
      ...
      case 1352:
        if (player.getItemAssistant().playerHasItem(995, 50) && player.absY > 3485 && player.absY < 3489) {
          player.getItemAssistant().deleteItem2(995, 50);
          sendPlayerChat1("Yes please.");
          player.getPlayerAssistant().startTeleport(2358, 3640, 0, "modern");
          player.hasPaid = true;
          player.nextChat = 0;
        } else if (player.getItemAssistant().playerHasItem(995, 50)) {
          player.getItemAssistant().deleteItem2(995, 50);
          sendPlayerChat1("Yes please.");
          player.getPlayerAssistant().startTeleport(2367, 3488, 0, "modern");
          player.hasPaid = true;
          player.nextChat = 0;
        } else if (player.hasPaid == true && player.absY > 3485 && player.absY < 3489) {
          sendPlayerChat1("Yes please.");
      ...
      case 1353:
        sendNpcChat1("Would you like to travel to Keldagrim?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 1358:
        sendNpcChat1("Hello, would you like some monk robes?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 1362:
        if (player.getItemAssistant().playerHasItem(542) || player.getItemAssistant().playerHasItem(544)
            || player.playerEquipment[player.playerLegs] == 542 || player.playerEquipment[player.playerChest] == 544) {
          sendNpcChat1("You already have some monks robes", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        } else {
      ...
      case 1363:
        sendNpcChat4("You already have the slayer task of " + player.slayerTask + " and have",
            " " + player.taskAmount + " left to kill", "are you sure you would like an easier task?",
            "it will be something much simpiler than your previous task.", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 1369:
        sendNpcChat2("Hello, " + player.playerName + " would you like to change your appearance?", "for 3k?",
            player.talkingNpc, NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 1372:
        if (player.getItemAssistant().playerHasItem(995, 3000)) {
          ...
          sendNpcChat1("You don't have enough gold to do that.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      ...
      case 1378:
        sendNpcChat2("Hello " + player.playerName + ".", "Are you interested in buying a candle for 1k?",
      ...
      case 1380:
        if (player.getItemAssistant().playerHasItem(995, 1000)) {
          ...
          sendNpcChat1("You don't have enough coins to buy a candle.", player.talkingNpc, "Candle Seller");
          player.nextChat = 0;
        }
        break;
      ...
      case 2995:
        ...
        sendStatement2("Before you start if you would like to skip Tutorial Island,",
            "now is your chance. If you skip you will be brought to mainland.");
        player.nextChat = 2996;
        break;

      case 2996:
        sendStatement2("If you don't want to skip Tutorial Island you can stay here.",
            "Would you like to skip Tutorial Island, or stay here?");
        player.nextChat = 2997;
        break;

      case 2997:
        sendOption2("I would like to skip Tutorial Island and go to Mainland.",
       ...
       */
      case 3001: // RS GUIDE
        sendNpcChat2("Greetings! I see you are a new arrival to the land. My",
            "job is to welcome all new visitors. So welcome!", player.talkingNpc, "Runescape Guide");
        player.nextChat = 3002;
        break;
      case 3002: // 2
        sendNpcChat2("You have already learned the first thing needed to",
            "succeed in this world: talking to other people!", player.talkingNpc, "Runescape Guide");
        player.nextChat = 3003;
        break;

      case 3003: // 3
        sendNpcChat3("You will find many inhabitants of this world have useful",
            "things to say to you. By clicking on them with your", "mouse you can talk to them.", player.talkingNpc,
            "Runescape Guide");
        player.nextChat = 3004;
        break;
      case 3004:
        sendNpcChat4("I would also suggest reading through some of the",
            "supporting information on the website. There you can", "find the Knowledge Base, which contains all the",
            "additional information you're ever likely to need. It also", player.talkingNpc, "Runescape Guide");
        player.nextChat = 3005;
        break;
      case 3005:
        sendNpcChat2("contains maps and helpful tips to help you on your", "journey.", player.talkingNpc,
            "Runescape Guide");
      ...
      case 3006:// show tab wrentch
        clearChatBoxText(player); // call this every time there is new
                                  ...
                                  // coming up
        sendNpcChat2("You will notice a flashing icon of a wrench, please click", "on this to continue the tutorial.",
      ...
      case 3007: // Player controls
        player.getPlayerAssistant().removeAllWindows();
        chatboxText(player, "Please click on the flashing wrench icon found at the bottom",
            "right of your screen. This will display your player controls.", "", "", "Player controls");
        player.nextChat = 0;
        break;

      case 3008: // Glad your making progress
        sendNpcChat1("I'm glad you're making progress!", player.talkingNpc, "Runescape Guide");
        player.nextChat = 3009;
        break;

      case 3009:
        sendNpcChat2("To continue the tutorial go through that door over", "there and speak to your first instructor!",
            player.talkingNpc, "Runescape Guide");
      ...
      case 3010:
        ...
        player.getPlayerAssistant().removeAllWindows();
        chatboxText(player, "You can interact with many items of scenery by simply clicking",
            ...
            "indicated with the yellow arrow to go through to the next instructor.", "Interacting with scenery");
      ...
      case 3011: // door handling
        player.getPlayerAssistant().removeAllWindows();
        chatboxText(player, "Follow the path to find the next instructor. Clicking on the",
            "ground will walk you to that point. Talk to the Survival Expert by",
            "the pond to the continue the tutorial. Remember you can rotate", "the view by pressing the arrow keys.",
            "Moving around");
      ...
      case 3012: // Survival Expert
        sendNpcChat4("Hello there, newcomer. My name is Brynna. My job is",
            ...
            "we're going to start with the most basic survival skill of", "all: making a fire.", player.talkingNpc,
            "Survival Expert");
        player.nextChat = 3013;
        break;

      case 3013: // giving bronze and tinder
        sendItemChat2(player, "", "The Survival Guide gives you a @blu@tinderbox @bla@and a", "@blu@bronze axe!", 590,
            150);
        player.getItemAssistant().addOrDropItem(590, 1);
        player.getItemAssistant().addOrDropItem(1351, 1);
        player.nextChat = 0;
        chatboxText(player, "Click on the flashing backpack icons to the right hand side of",
            "the main window to view your inventory. Your inventory is a list",
            "of everything you have on your backpack.", "", "Viewing the items that you were given");
      ...
      case 3015: // firemaking time
        player.getPlayerAssistant().removeAllWindows();
        chatboxText(player, "Well done! You managed to cut some logs from the tree! Next,",
            "use the tinderbox in your inventory to light the logs.", "First click on the tinderbox to use it.",
            "Then click on the logs in your inventory to light them.", "Making a fire");
      ...
      case 3016: // firemaking done skill tab flashing now.
        ...
        chatboxText(player, "Click on the flashing bar graph icon near the inventory button",
            "to see your skill stats.", "", "", "You gained some experience.");
      ...
      case 3017: // survival expert part 2
        sendNpcChat3("Well done! Next we need to get some food in our",
            ...
            "in the pond there so let's catch and cook some.", player.talkingNpc, "Survival Expert");
        player.nextChat = 3018;

        break;

      case 3018:
        sendItemChat1(player, "", "The Survival Guide gives you a @blu@net!", 303, 150);
        player.getItemAssistant().addOrDropItem(303, 1);
        player.nextChat = 0;
        chatboxText(player, "Click on the sparkling fishing spot indicated by the flashing",
            "arrow. Remember, you can check your inventory by clicking the", "backpack icon.", "", "Catch some Shrimp");
      ...
      case 3019: // Cooking the shrimp
        player.getActionSender().chatbox(6180);
        chatboxText(player, "Now you have caught some shrimp let's cook it. First light a",
            "fire, chop down a tree and then use the tinderbox on the logs.",
            "If you've lost your axe or tinderbox, Brynna will give you", "another.", "Cooking your shrimp.");
        player.getActionSender().chatbox(6179);
        break;
      // END
      ...
      case 3020: // tutorial PROGRESS = 7
        ...
        // // 15 percent
        player.getActionSender().chatbox(6180);
        chatboxText(player, "Talk to the chef indicated. He will teach you the more advanced",
            "aspects of Cooking such as combining ingredients. He will also",
            "teach you about your music player menu as well.", "", "Find your next instructor");
        player.getActionSender().chatbox(6179);
      ...
      case 3021: // start of dialogue.
        sendNpcChat3("Ah! Welcome newcomer. I am the Master Chef Leo. It",
            "is here I will teach you how to cook food truly fit for a", "king.", player.talkingNpc, "Master Chef");
      ...
      case 3023:
        sendNpcChat3("Hahahahahaha! You call THAT cooking? Some shrimp",
            "on an open log fire? Oh no, no, no. I am going to", "teach you the fine art of cooking bread.",
            player.talkingNpc, "Master Chef");
        player.nextChat = 3024;
        break;
      case 3024:
        sendNpcChat2("And no fine meal is complete without good music, so", "we'll cover that while you're here too.",
            player.talkingNpc, "Master Chef");
        player.nextChat = 3025;
        break;

      case 3025: // he gives u bucket of water etc TTUOTRIAL PROG 8
        sendItemChat2(player, "", "The Cooking Guide gives you a @blu@bucket of water@bla@ and a", "@blu@pot of flour!",
            1933, 150);
        player.getItemAssistant().addOrDropItem(1933, 1);
        player.getItemAssistant().addOrDropItem(1929, 1);
        player.nextChat = 0;
        chatboxText(player, "This is the base for many of the meals. To make dough we must",
            "mix flour and water. First right click the bucket of water and",
            "select use, then left click on the pot of flour.", "", "Making dough");
        PlayerAssistant.removeHintIcon(player);
      ...
      case 3026: // cooking dough
        player.getActionSender().chatbox(6180);
        chatboxText(player, "Now you have made dough, you can cook it. To cook the dough",
            "use it with the range shown by the arrow. If you lose your",
            "dough, talk to Leo - he will give you more ingredients.", "", "Cooking dough");
        player.getActionSender().chatbox(6179);
      ...
      case 3037: // new tutorial prog
        player.getActionSender().chatbox(6180);
        chatboxText(player, "Well done! Your first loaf of bread. As you gain experience in",
            "Cooking you will be able to make other things like pies, cakes",
            "and even kebabs. Now you've got the hang of cooking, let's",
            "move on. Click on the flashing icon in the bottom right.", "Cooking dough");
        player.getActionSender().chatbox(6179);
        PlayerAssistant.removeHintIcon(player);
      ...
      case 3038: // Emotes
        player.getActionSender().chatbox(6180);
        chatboxText(player, "", "Now, how about showing some feelings? You will see a flashing",
            "icon in the shape of a person. Click on that to access your", "emotes.", "Emotes");
        player.getActionSender().chatbox(6179);
        PlayerAssistant.removeHintIcon(player);
      ...
      case 3039: // running
        ...
        chatboxText(player, "It's only a short distance to the next guide.",
            "Why not try running there? Start by opening the player", "settings, that's the flashing icon of a wrench.",
            "", "Running");
        player.getActionSender().chatbox(6179);
        player.getActionSender().flashSideBarIcon(-12);
      ...
      case 3040:
        player.getActionSender().chatbox(6180);
        chatboxText(player, "In this menu you will see many options. At the bottom in the",
            "middle is a button with the symbol of a running shoe. You can",
            "turn this button on or off to select run or walk. Give it a go,", "click on the run button now.",
            "Running");
        player.getActionSender().chatbox(6179);
        player.nextChat = 0;
        break;
      case 3041: // clicked on run
        player.getActionSender().chatbox(6180);
        chatboxText(player, "Now that you have the run button turned on, follow the path",
            "until you come to the end. You may notice that the numbers on",
            "the button goes down. This is your run energy. If your run", "energy reaches zero, you'll stop running.",
      ...
      case 3042: // entering the quest GUIDE
        ...
        // or 35 percent
        player.getActionSender().chatbox(6180);
        chatboxText(player, "Talk with the Quest Guide.", "", "He will tell you all about quests.", "", "");
        player.getActionSender().chatbox(6179);
      ...
      case 3043: // quest guide dialogue START
        sendNpcChat2("Ah. Welcome, adventurer. I'm here to tell you all about",
            "quests. Let's start by opening the quest side panel.", player.talkingNpc, "Quest Guide");
      ...
      case 3044: // Send quest tab
        player.getPlayerAssistant().removeAllWindows();
        player.getActionSender().chatbox(6180);
        chatboxText(player, "Open the Quest Journal.", "", "Click on the flashing icon next to your inventory.", "",
            "");
        player.getActionSender().chatbox(6179);
      ...
      case 3045: // quest guide 2 prog 13
        sendNpcChat3("Now you have the journal open. I'll tell you a bit about",
            "it. At the moment all the quests shown in red which", "means you have not started them yet.",
      ...
      case 3046:
        sendNpcChat4("When you start a quest it will change colour to yellow",
            "and to green when you've finished. This is so you can",
            "easily see what's complete, what's started, and what's left", "to begin.", player.talkingNpc,
            "Quest Guide");
        player.nextChat = 3047;
        break;

      case 3047:
        sendNpcChat3("The start of quests are easy to find. Look out for the",
            "star icons on the minimap, just like the one you should", "see marking my house.", player.talkingNpc,
            "Quest Guide");
        player.nextChat = 3048;
        break;

      case 3048:
        sendNpcChat4("The quests themselves can vary greatly from collecting",
            "beads to hunting down dragons. Generally quests are",
            "started by talking to a non-player character like me,", "and will involve a series of tasks.",
            player.talkingNpc, "Quest Guide");
        player.nextChat = 3049;
        break;

      case 3049: // last
        sendNpcChat4("There's not a lot more I can tell you about questing.",
            "You have to experience the thrill of it yourself to fully",
            "understand. You may find some adventure in the caves", "under my house.", player.talkingNpc,
            "Quest Guide");
      ...
      case 3050: // moving on. Cave time biaches
        player.getPlayerAssistant().removeAllWindows();
        player.getActionSender().chatbox(6180);
        chatboxText(player, "", "It's time to enter some caves. Click on the ladder to go down to", "the next area.",
            "", "Moving on");
        player.getActionSender().chatbox(6179);
      ...
      case 3051:
        player.getPlayerAssistant().removeAllWindows();
        player.getActionSender().chatbox(6180);
        chatboxText(player, "Next let's get you a weapon or more to the point, you can",
            "make your first weapon yourself. Don't panic, the Mining",
            "Instructor will help you. Talk to him and he'll tell you all about it.", "", "Mining and Smithing");
        player.getActionSender().chatbox(6179);
      ...
      case 3052:// mining tutor start
        sendNpcChat4("Hi there. You must be new around here. So what do I",
            ...
            "going to be working together, I'd rather call you by", "name.", player.talkingNpc, "Mining Instructor");
        player.nextChat = 3053;
        break;

      case 3053:// mining tutor start
        sendPlayerChat1("You can call me " + Misc.capitalize(player.playerName) + ".");
        player.nextChat = 3054;
        break;

      case 3054:// mining tutor start
        sendNpcChat2("Ok then, " + Misc.capitalize(player.playerName) + "." + " My name is Dezzick and I'm a",
            "miner by trade. Let's prospect some of those rocks.", player.talkingNpc, "Mining Instructor");
      ...
      case 3055: // prospecting
        player.getPlayerAssistant().removeAllWindows();
        player.getActionSender().chatbox(6180);
        chatboxText(player, "To prospect a mineable rock, just right click it and select the",
            "'prospect rock' option. This will tell you the type of ore you can",
            "mine from it. Try it now on one of the rocks indicated.", "", "Prospecting");
        player.getActionSender().chatbox(6179);
        // client.getPacketDispatcher().tutorialIslandInterface(40,9);
      ...
      case 3056: // done prospecting
        sendPlayerChat2("I prospected both types of rocks! One set contains tin",
            "and the other has copper ore inside.");
        player.nextChat = 3057;
        break;

      case 3057:
        sendNpcChat2("Absolutely right, " + Misc.capitalize(player.playerName) + "." + " These two ore types",
            "can be smelted together to make bronze.", player.talkingNpc, "Mining Instructor");
        player.nextChat = 3058;
        break;

      case 3058:
        sendNpcChat3("So now you know what ore is in the rocks over there,",
            "why don't you have a go at mining some tin and", "copper? here, you'll need this to start with.",
            player.talkingNpc, "Mining Instructor");
        player.nextChat = 3060;
        break;
      case 3060:
        sendItemChat1(player, "", "Dezzick gives you a @blu@bronze pickaxe!", 1265, 300);
        player.getItemAssistant().addOrDropItem(1265, 1);
        player.nextChat = 0;
        chatboxText(player, "It's quite simple really. All you need to do is right click on the",
            "rock and select 'mine'. You can only mine when you have a",
            "pickaxe. So give a try: first mine one tin ore.", "", "Mining");
      ...
      case 3061: // furnace time
        ...
        player.nextChat = 0;
        chatboxText(player, "You should now have both some copper and tin ore. So let's",
            "smelt them to make a bronze bar. To do this, right click on",
            "either tin or copper ore and select use, then left click on the", "furnace. Try it now.", "Smelting");
        break;
      case 3062: // smelting
        player.tutorialProgress = 20;
        player.nextChat = 0;
        player.getActionSender().chatbox(6180);
        chatboxText(player, "", "Speak to the Mining Instructor and he'll show you how to make", "it into a weapon.",
      ...
      case 3064:
        sendNpcChat2("Okay, I'll show you how to make a dagger out of it.", "You'll be needing this...",
            player.talkingNpc, "Mining Instructor");
      ...
      case 3065: // giving you the hammer
        ...
        player.getItemAssistant().addOrDropItem(2347, 1);
        player.nextChat = 0;
        chatboxText(player, "To smith you'll need a hammer - like the one you were given by",
            "Dezzick - access to an anvil like the one with the arrow over it",
            "and enough metal bars to make what you are trying to smith.", "", "Smithing a dagger");
      ...
      case 3066:
        chatboxText(player, "So let's move on. Go through the gates shown by the arrow.",
            "Remember you may need to move the camera to see your,",
            "surroundings. Speak to the guide for a recap at any time.", "", "You've finished in this area");
      ...
      case 3067:// Melee instructor c.tutorialProgress = 22
        sendPlayerChat1("Hi! My name is " + Misc.capitalize(player.playerName) + ".");
        player.nextChat = 3068;
        break;

      case 3068:
        sendNpcChat2("Do I look like I care? To me you're just another", "newcomer who thinks they're ready to fight.",
            player.talkingNpc, "Combat Instructor");
        player.nextChat = 3069;
        break;

      case 3069:
        sendNpcChat1("I am Vannaka, the greatest swordsman alive.", player.talkingNpc, "Combat Instructor");
        player.nextChat = 3070;
        break;

      case 3070:
        sendNpcChat1("Let's get started by teaching you to wield a weapon", player.talkingNpc, "Combat Instructor");
      ...
      case 3071: // send wear interface
        player.getPlayerAssistant().removeAllWindows();
        player.getActionSender().chatbox(6180);
        chatboxText(player, "", "You now have access to a new interface. Click on the flashing",
            "icon of a man the one to the right of your backpack icon.", "", "Wielding weapons");
        player.getActionSender().chatbox(6179);
      ...
      case 3072:
        sendNpcChat2("Very good, but that little butter knife isn't going to", "protect you much. Here, take these.",
            player.talkingNpc, "Combat Instructor");
      ...
      case 3073:
        sendItemChat2(player, "", // Gives me sword and shield
            "The Combat Guide gives you a @blu@bronze sword@bla@ and a", "@blu@wooden shield!", 1171, 300);
        player.getItemAssistant().addOrDropItem(1171, 1);
        player.getItemAssistant().addOrDropItem(1277, 1);
        player.nextChat = 0;
        chatboxText(player, "In your worn inventory panel, right click on the dagger and",
            "select the remove option from the drop down list. After you've",
            "unequipped the dagger, wield the sword and shield. As you",
            "pass the mouse over an item you will see its name.", "Unequipping items");
        PlayerAssistant.removeHintIcon(player);
        break;
      ...
      case 3075:
        sendNpcChat3("I saw, " + Misc.capitalize(player.playerName) + "." + " You seem better at this than I",
            "thought. Now that you have grasped basic swordplay", "let's move on.", player.talkingNpc,
            "Combat Instructor");
      ...
      case 3076:
        sendNpcChat4("Let's try some ranged attacking, with this you can kill",
            "foes from a distance. Also, foes unable to reach you are",
            "as good as dead. You'll be able to attack the rats", "without entering the pit.", player.talkingNpc,
            "Combat Instructor");
      ...
      case 3077: // gives me bow and arrow
        sendItemChat2(player, "", "The Combat Guide gives you some @blu@bronze arrows@bla@ and", "a @blu@shortbow!",
            841, 300);
        player.getItemAssistant().addOrDropItem(841, 1);
        player.getItemAssistant().addOrDropItem(882, 50);
        player.nextChat = 0;
        chatboxText(player, "Now you have a bow and some arrows. Before you can use",
            "them you'll need to equip them. Remember: to attack, right", "click on the monster and select attack.", "",
            "Rat ranging");
      ...
      case 3080:
        sendNpcChat2("I'm the Financial Advisor. I'm here to tell people how to", "make money.", player.talkingNpc,
            "Financial Advisor");
      ...
      case 3082:
        sendNpcChat1("How you can make money? Quite.", player.talkingNpc, "Financial Advisor");
        player.nextChat = 3083;
        break;

      case 3083:
        sendNpcChat3("Well there are three basic ways of making money here:",
            "combat, quests, and trading. I will talk you through each", "of them very quickly.", player.talkingNpc,
            "Financial Advisor");
        player.nextChat = 3084;
        break;

      case 3084:
        sendNpcChat3("Let's start with combat as it is probably still fresh in",
            "your mind. Many enemies, both human and monster,", "will drop items when they die.", player.talkingNpc,
            "Financial Advisor");
      ...
      case 3086:
        sendNpcChat3("By getting a high level in skills such as Cooking, Mining,",
            "Smithing or Fishing, you can create or catch your own", "items and sell them for pure profit.",
            player.talkingNpc, "Financial Advisor");
        player.nextChat = 3087;
        break;

      case 3087:
        sendNpcChat2("Well that about covers it. Come back if you'd like to go", "over this again.", player.talkingNpc,
            "Financial Advisor");
      ...
      case 3089: // start of dialogue
        sendPlayerChat1("Good day, brother, my name's " + Misc.capitalize(player.playerName) + ".");
        player.nextChat = 3090;
        break;

      case 3090:
        sendNpcChat2("Hello, " + Misc.capitalize(player.playerName) + "." + " I'm Brother Brace. I'm here to",
            "tell you all about Prayer.", player.talkingNpc, "Brother Brace");
      ...
      case 3091:
        player.getPlayerAssistant().removeAllWindows();
        player.getActionSender().chatbox(6180);
        chatboxText(player, "", "Click on the flashing icon to open the Prayer menu.", "", "", "Your Prayer menu");
        player.getActionSender().chatbox(6179);
      ...
      case 3092:
        sendNpcChat3("This is your Prayer list. Prayers can help a lot in",
            "combat. Click on the prayer you wish to use to activate", "it and click it again to deactivate it.",
      ...
      case 3093:
        sendNpcChat3("Active prayers will drain your Prayer Points which",
            "you can recharge by finding an altar or other holy spot", "and praying there.", player.talkingNpc,
            "Brother Brace");
      ...
      case 3094:
        sendNpcChat3("As you noticed, most enemies will drop bones when",
            "defeated. Burying bones by clicking them in your", "inventory will gain you Prayer experience.",
            player.talkingNpc, "Brother Brace");
        player.nextChat = 3095;
        break;

      case 3095:
        sendNpcChat2("I'm also the community officer 'round here, so it's my",
            "job to tell you about your friends and ignore list.", player.talkingNpc, "Brother Brace");
      ...
      case 3096:
        player.getPlayerAssistant().removeAllWindows();
        player.getActionSender().chatbox(6180);
        chatboxText(player, "You should now see another new icon. Click on the flashing",
      ...
      case 3097: // long dialogue START
        ...
        sendNpcChat4("Good. Now you have both menus open, I'll tell you a",
            ...
            "clicking the add button then typing their name into the", "box that appears.", player.talkingNpc,
            "Brother Brace");
      ...
      case 3098:
        sendNpcChat4("You remove people from the lists in the same way. If",
            ...
            "able to talk to you or send any form of message to", "you.", player.talkingNpc, "Brother Brace");
      ...
      case 3099:
        sendNpcChat4("Your friends list shows the online status of your",
            ...
            "online and on the same server and friends in yellow", "are online but on a different server.",
            player.talkingNpc, "Brother Brace");
      ...
      case 3101:
        sendNpcChat3("Yes, you should read the rules of conduct on the",
            "website to make sure you do nothing to get yourself", "banned.", player.talkingNpc, "Brother Brace");
        player.nextChat = 3102;
        break;
      case 3102:
        sendNpcChat3("But in general, always try to be courteous to other",
            "players - remember the people in the game are real", "people with real feelings.", player.talkingNpc,
            "Brother Brace");
        player.nextChat = 3103;
        break;
      case 3103:
        sendNpcChat2("If you go 'round being abusive or causing trouble your",
            "character could end up being the one in trouble.", player.talkingNpc, "Brother Brace");
        player.nextChat = 3104;
        break;
      case 3104: // last one
        sendPlayerChat1("Okay thanks. I'll bear that in mind.");
        player.getActionSender().chatbox(6180);
        chatboxText(player, "You're almost finished on tutorial island. Pass through the",
            "door to find the path leading to your final instructor.", "", "", "Your final instructor!");
        PlayerAssistant.removeHintIcon(player);
      ...
      case 3106:
        sendNpcChat3("Good day, newcomer. My name is Terrova. I'm here",
            "to tell you about Magic. Let's start by opening your", "spell list.", player.talkingNpc,
            "Magic Instructor");
      ...
      case 3107:
        ...
        player.getPlayerAssistant().removeAllWindows();
        player.getActionSender().chatbox(6180);
        chatboxText(player, "", "Open up the Magic menu by clicking on the flashing icon next",
            "to the Prayer button you just learned about.", "", "Open up your final menu");
        player.getActionSender().chatbox(6179);
        player.nextChat = 0;
      ...
      case 3108:
        sendNpcChat3("Good. This is a list of your spells. Currently you can",
            "only cast one offensive spell called Wind Strike. Let's", "try it out on one of those chickens.",
            player.talkingNpc, "Magic Instructor");
        player.nextChat = 3109;
        break;

      case 3109:
        sendItemChat1(player, "", "Terrova gives you five @blu@air runes@bla@ and @blu@five mind runes!", 556, 300);
        player.getItemAssistant().addOrDropItem(558, 5);
        player.getItemAssistant().addOrDropItem(556, 5);
        player.nextChat = 0;
        chatboxText(player, "Now you have runes you should see the Wind Strike icon at the",
            "top left corner of the Magic interface - second in from the",
            "left. Walk over to the caged chickens, click the Wind Strike icon",
            "and then select one of the chicken to cast it on.", "Cast Wind Strke at a chicken");
      ...
      case 3110:
        sendNpcChat2("Well you're all finished here now. I'll give you a", "reasonable number of runes when you leave.",
            player.talkingNpc, "Magic Instructor");
      ...
      case 3112:// Mainland
        ...
        sendNpcChat4("When you get to the mainland you will find yourself in",
            "the town of Lumbridge. If you want some ideas on", "where to go next talk to my friend the Lumbridge",
            "Guide. You can't miss him; he's holding a big staff with", player.talkingNpc, "Magic Instructor");
        player.nextChat = 3113;
        break;
      case 3113:
        sendNpcChat4("a question mark on the end. He also has a white beard",
            "and carries a rucksack full of scrolls. There are also",
            "many tutors willing to teach you about the many skills", "you could learn.", player.talkingNpc,
            "Magic Instructor");
      ...
      case 3115:
        ...
        player.getItemAssistant().sendWeapon(player.playerEquipment[player.playerWeapon],
      ...
      case 3117:
        sendNpcChat1("You can't stay here you've completed the tutorial already.", player.talkingNpc,
            "Magic Instructor");
        player.nextChat = 3112;
        break;

      case 3118:
        sendNpcChat2("Hello " + player.playerName + ".", "Are you interested in buying any beer?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 3123:
        if (player.getItemAssistant().playerHasItem(995, 3)) {
          ...
          sendNpcChat1("You don't have enough coins to buy that.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
        }
        break;
      ...
      case 3133:
        sendNpcChat2("Thank you for rescuing me! It isn't very comfy in this", "cell!", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 3136:
        sendNpcChat2("Well... not really... The Black Knights took all of my",
            "stuff before throwing me in here to rot!", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
        player.nextChat = 0;
        break;
      ...
      case 3138:
        sendNpcChat3("Well, this dungeon was quite good to explore ...until I",
            "got captured, anyway. I was given a key to an inner",
            "part of this dungeon by a mysterious cloaked stranger!", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 3139:
        sendNpcChat3("It's rather tough for me to get that far into the",
            "dungeon however... I just keep getting captured! Would", "you like to give it a go?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 3144:
        sendNpcChat1("Would you like me to teleport you to rune essence?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 3149:
        sendNpcChat1("Welcome to the Wizards Guild.", player.talkingNpc, "Wizard Distenor");
        player.nextChat = 0;
        break;

      case 3150:
        sendNpcChat1("Hello are you interested in buying anything?", player.talkingNpc, "Bartender");
      ...
      case 3156:
        if (player.getItemAssistant().playerHasItem(995, 16)) {
          ...
          sendNpcChat1("You need 16 coins to buy that.", player.talkingNpc, "Bartender");
          player.nextChat = 0;
        }
        break;
      ...
      case 3157:
        if (player.getItemAssistant().playerHasItem(995, 20)) {
          ...
          sendNpcChat1("You need 20 coins to buy that.", player.talkingNpc, "Bartender");
          player.nextChat = 0;
        }
        break;

      case 3158:
        sendNpcChat1("Hello, " + player.playerName + " what would you like to do?", player.talkingNpc,
            "Wyson the Gardener");
      ...
      case 3162:
        sendNpcChat1("How much are you willing to pay for a woad leaf?", player.talkingNpc, "Wyson the Gardener");
      ...
      case 3164:
        sendNpcChat2("Don't be ridiculous offer me more", "and I may sell you one!", player.talkingNpc,
            "Wyson the Gardener");
        player.nextChat = 0;
        break;
      ...
      case 3165:
        if (player.getItemAssistant().playerHasItem(995, 15)) {
          sendNpcChat1("That sounds like a fair offer, here's one woaf leaf.", player.talkingNpc, "Wyson the Gardener");
          player.getItemAssistant().addOrDropItem(1793, 1);
          player.getItemAssistant().deleteItem2(995, 15);
          player.nextChat = 0;
        } else {
          sendNpcChat1("You don't have enough coins to buy a woad leaf.", player.talkingNpc, "Wyson the Gardener");
        }
        break;

      case 3166:
        if (player.getItemAssistant().playerHasItem(995, 15)) {
          sendNpcChat1("That offer sounds generous, I will give you two woaf leaves!", player.talkingNpc,
              "Wyson the Gardener");
      ...
      case 3167:
        sendNpcChat1("Hello are you interested in buying anything?", player.talkingNpc, "Roavar");
      ...
      case 3171:
        if (player.getItemAssistant().playerHasItem(995, 5)) {
          ...
          sendNpcChat1("You need 5 coins to buy that.", player.talkingNpc, "Roavar");
          player.nextChat = 0;
        }
        break;
      ...
      case 3173:
        sendNpcChat2("Hello, would you like to travel to Shilo Village", "for 200 coins?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 3177:
        if (player.getItemAssistant().playerHasItem(995, 200)) {
          player.getItemAssistant().deleteItem2(995, 200);
          player.getPlayerAssistant().startTeleport(2834, 2953, 0, "modern");
          player.nextChat = 0;
        } else {
      ...
      case 3178:
        sendNpcChat2("Hello, would you like to travel to back to Brimhaven", "for 200 coins?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 3183:
        sendNpcChat2("Hello, are you interested in buying cooking gauntlets", "for 25k?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 3186:
        if (player.getItemAssistant().playerHasItem(995, 25000) && !player.getItemAssistant().playerHasItem(775)
          ...
          player.nextChat = 0;
        } else if (player.getItemAssistant().playerHasItem(775) || player.playerEquipment[player.playerHands] == 775) {
          sendNpcChat1("Why would you want another pair?", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        } else {
          sendNpcChat1("You need 25k to buy these.", player.talkingNpc, NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      ...
      case 3189:
        sendNpcChat2("Hello, are you interested in buying goldsmith gantlets", "for 25k?", player.talkingNpc,
            NpcHandler.getNpcListName(player.talkingNpc));
      ...
      case 3192:
        if (player.getItemAssistant().playerHasItem(995, 25000) && !player.getItemAssistant().playerHasItem(776)
          ...
          player.nextChat = 0;
        } else if (player.getItemAssistant().playerHasItem(776) || player.playerEquipment[player.playerHands] == 776) {
          sendNpcChat1("Why would you want another pair?", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        } else {
      ...
      case 3193:
        if (!player.getItemAssistant().playerHasItem(1540)) {
          ...
          sendNpcChat1("Enjoy!", player.talkingNpc, NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        } else {
          sendNpcChat1("You already have one of those shields.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      ...
      case 3197:
        if (MOLE_SKIN > 0) {
          ...
          sendNpcChat1("You don't have any mole skins.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      ...
      case 3199:
        if (MOLE_CLAW > 0) {
          ...
          sendNpcChat1("You don't have any mole claws.", player.talkingNpc,
              NpcHandler.getNpcListName(player.talkingNpc));
          player.nextChat = 0;
        }
        break;
      ...
      case 3201: // competition judge
        sendNpcChat4("Hello!", "I'm the competition judge of the Ranging Guild.",
            "You can buy shots from me and shoot the targets", "for points. You can exchange the points with me.",
      ...
      case 3203:
        sendOption4("I would like to buy shots.", "I would like to exchange my points.", "How am I doing right now?",
            "Never mind.");
      ...
      case 3216:// 23
        sendStartInfo("As you collect your reward, you notice an aweful smell.",
      ...
      case 3500:
        if (player.getCannon().needsCannon()) {
          sendNpcChat2("Hello, " + Misc.capitalize(player.playerName) + ".", "I see that you lost your cannon.",
              player.talkingNpc, "Nulodion");
          player.nextChat = 3501;
        } else {
          sendNpcChat1("" + Misc.capitalize(player.playerName) + " you do not have anything to collect currently.",
              player.talkingNpc, "Nulodion");
          player.nextChat = 0;
        }
        break;
      ...
      case 3501:
        if (player.getCannon().needsCannon()) {
          ...
          sendNpcChat1("" + Misc.capitalize(player.playerName) + " you do not have a cannon to collect currently.",
              player.talkingNpc, "Nulodion");
          player.nextChat = 0;
        }
        break;
  ...
  public void chatboxText(Client c, String text, String text1, String text2, String text3, String title) {
  ...
  /**
   * USAGE: displayTwoItemsOption(c, new String {"Whip", "DDS", new int { 4151,
   * 5698}, new int { 150, 150}); Displays two items with a select one option.
   */
  ...
  public void sendItemChat1(Client c, String header, String one, int item, int zoom) {
  ...
  public void sendItemChat2(Client c, String header, String one, String two, int item, int zoom) {
  ...
  public void sendItemChat4(Client c, String header, String one, String two, String three, String four, int item,
      int zoom) {
