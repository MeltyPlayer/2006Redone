    ...
    switch (objectId) {
      ...
      case 3506:
        if (player.absX != 3445 && player.absX != 3442) {
          openSpecialWalkGate(player, 3506, 3507, 3444, 3457, 3443, 3457, 3444, 3458, 3443, 3458, 0,
              player.absY == 3457 ? 1 : -1, 2, 0, 3);
        }
        break;
      case 3507:
        if (player.absX != 3445 && player.absX != 3442) {
          openSpecialWalkGate(player, 3507, 3506, 3443, 3457, 3444, 3457, 3443, 3458, 3444, 3458, 0,
              player.absY == 3457 ? 1 : -1, 0, 2, 3);
        }
        break;
    }
  }
