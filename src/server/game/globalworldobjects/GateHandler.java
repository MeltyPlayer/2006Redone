...
public class GateHandler {
  ...
  public static void openSingleGate(Client player, int objectId, int x1, int y1, int x2, int y2, int walkX, int walkY,
      int face1, int face2) {
  ...
  private static void openDoubleGate(Client player, int objectId, int objectId2, int x1, int y1, int x2, int y2, int x3,
      int y3, int x4, int y4, int face1, int face2) {
  ...
  private static void openSpecialGate(Client player, int objectId, int objectId2, int x1, int y1, int x2, int y2,
      int x3, int y3, int x4, int y4, int face1, int face2, int face3) {
    if (isGate(objectId) && isGate(objectId2) && gateAmount == 0) {
      spawnGate(-1, x3, y3, player.heightLevel, 0);
      spawnGate(-1, x4, y4, player.heightLevel, 0);
      spawnGate(objectId, x1, y1, player.heightLevel, face1);
  ...
  public static void openSpecialWalkGate(Client player, int objectId, int objectId2, int x1, int y1, int x2, int y2,
      int x3, int y3, int x4, int y4, int walkX, int walkY, int face1, int face2, int face3) {
    if (isGate(objectId) && isGate(objectId2) && gateAmount == 0) {
      spawnGate(-1, x3, y3, player.heightLevel, 0);
      spawnGate(-1, x4, y4, player.heightLevel, 0);
      spawnGate(objectId, x1, y1, player.heightLevel, face1);
  ...
  public static void handleGate(Client player, int objectId, int objectId2, int x1, int y1, int x2, int y2, int x3,
      int y3, int x4, int y4, int type) {
    switch (type) {
      /**
       * X Gate 1
       */
  ...
  public static void handleSpecialGate(Client player, int objectId, int objectId2, int x1, int y1, int x2, int y2,
      int x3, int y3, int x4, int y4, int type) {
    switch (type) {
      /**
       * X Gate 1
       */
