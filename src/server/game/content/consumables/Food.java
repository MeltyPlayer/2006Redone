...
public class Food {
	...
	public static enum FoodToEat {
		...
		CUP_OF_TEA(1978, 2 + Misc.random(1), "Cup of Tea", 1980, "Drink",
				true), CUP_OF_TEA2(712, 2 + Misc.random(1), "Cup of Tea", 1980,
						"Drink", true),
		...
		LEMON(2102, 2, "Lemon", 0, "Food", false), LIME(2120, 2, "Lime", 0,
				"Food", false), PINEAPPLE(2114, 2, "Pineapple", 0, "Food",
						false), CHOCOLATE_BAR(1973, 2, "Chocolate Bar", 0,
								"Food", false), Wine(1993, 11, "Wine", 1935,
										"Drink", false), MACKERAL(355, 6,
												"Mackeral", 0, "Food",
												false), MANTA(391, 22,
														"Manta Ray", 0, "Food",
														false), SHARK(385, 20,
		...
		TROUT(333, 7, "Trout", 0, "Food", false), SALMON(329, 9, "Salmon", 0,
				"Food", false), SWORDFISH(373, 14, "Swordfish", 0, "Food",
						false), TUNA(361, 10, "Tuna", 0, "Food", false),
		// MOONLIGHT_MEAD(2955, 4, "Moonlight mead", 1919, "Drink", false),
		MONKFISH(7946, 16, "Monkfish", 0, "Food", false), SEA_TURTLE(397, 21,
				"Sea Turtle", 0, "Food",
				false), CABBAGE(1965, 1, "Cabbage", 0, "Food", false), SPINACH(
						1969, 2, "Spinach Roll", 0, "Food", false), CAKE(1891,
								4, "Cake", 1893, "Food", false), CAKE2(1893, 4,
										"2/3 Cake", 1895, "Food",
										false), SLICE_OF_CAKE(1895, 4,
												"2/3 Cake", 0, "Food",
												false), BASS(365, 13, "Bass", 0,
														"Food", false), COD(339,
																7, "Cod", 0,
																"Food",
																false), POTATO(
																														...
																														false), SHRIMPS(
																																...
																																false), HERRING(
																																		...
																																		false), SARDINE(
																																				...
																																				0,
																																				"Food",
																																				false), CHOCOLATE_CAKE(
																																						1897,
																																						5,
																																						"Chocolate Cake",
																																						1899,
																																						"Food",
																																						false), HALF_CHOCOLATE_CAKE(
																																								1899,
																																								5,
																																								"2/3 Chocolate Cake",
																																								1901,
																																								"Food",
																																								false), CHOCOLATE_SLICE(
																																										1901,
																																										5,
																																										"Chocolate Slice",
																																										0,
																																																				...
																																																				false), MEAT(
																																																						...
																																																						false), HALF_MEAT_PIZZA(
																																																								...
																																																								false), ANCHOVY_PIZZA(
																																																										...
																																																										2299,
																																																										"Food",
																																																										false), HALF_ANCHOVY_PIZZA(
																																																												2299,
																																																												9,
																																																												"1/2 Anchovy Pizza",
																																																												0,
																																																												"Food",
																																																												false), PINEAPPLE_PIZZA(
																																																														2301,
																																																														11,
																																																														"Pineapple Pizza",
																																																														2303,
																																																														"Food",
																																																														false), HALF_PINEAPPLE_PIZZA(
																																																																2303,
																																																																11,
																																																																"1/2 Pineapple Pizza",
																																																																0,
		...
		SEAWEED(403, 4, "Edible Seaweed", 0, "Food", false), MEAT_PIE(2327, 6,
				"Meat Pie", 2331, "Food", false), HALF_MEAT_PIE(2331, 6,
						"Half Meat Pie", 2313, "Food", false), SUMMER_PIE(7218,
								11, "Summer Pie", 7220, "Food",
								false), HALF_SUMMER_PIE(7220, 11,
										"Half Summer Pie", 2313, "Food",
										false), PIKE(351, 8, "Pike", 0, "Food",
												false), POTATO_WITH_BUTTER(6703,
														14,
														"Potato with Butter", 0,
														"Food",
														false), SLICED_BANANA(
																3162, 2,
																"Sliced Banana",
																...
																false), BANANA(
																		...
																		false), PEACH(
																				...
																				false), ORANGE(
																						...
																						0,
																						"Food",
																						false), PINEAPPLE_RINGS(
																								2118,
																								2,
																								"Pineapple Rings",
																								0,
																								"Food",
																								false), PINEAPPLE_CHUNKS(
																										2116,
																										2,
																										"Pineapple Chunks",
																										0,
	...
	public void eat(int id, int slot) {
		...
		if (System.currentTimeMillis() - c.foodDelay >= 1800
			...
			if (f.getType().equalsIgnoreCase("Food")) {
				c.getActionSender()
						.sendMessage("You eat the " + f.getName() + ".");
			} else if (f.getType().equalsIgnoreCase("Drink")) {
				c.getActionSender()
						.sendMessage("You drink the " + f.getName() + ".");
			}
			if (id == 1965) {
	...
	public void foodEffect(int id) {
		...
		case 1907:
			if (c.playerLevel[6] < 50) {
				c.playerLevel[6] = c.getPlayerAssistant()
						.getLevelForXP(c.playerXP[6]) + 2;
			} else {
				c.playerLevel[6] = c.getPlayerAssistant()
						.getLevelForXP(c.playerXP[6]) + 3;
			}
			...
			if (c.playerLevel[0] < 5) {
				...
				c.playerLevel[0] = c.getPlayerAssistant()
						.getLevelForXP(c.playerXP[0]) - 4;
			}
			if (c.playerLevel[1] < 4) {
				c.playerLevel[1] = 1;
			} else {
				c.playerLevel[1] = c.getPlayerAssistant()
						.getLevelForXP(c.playerXP[1]) - 3;
			}
			if (c.playerLevel[2] < 4) {
				c.playerLevel[2] = 1;
			} else {
				c.playerLevel[2] = c.getPlayerAssistant()
						.getLevelForXP(c.playerXP[2]) - 3;
			}
