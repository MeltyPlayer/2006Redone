...
public class Beverages {
  ...
  public static enum beverageData {
    BEER(1917, BEERGLASS, 829, true, false, false, false), BEER1(7740, BEERGLASS, 829, true, false, false, false), GROG(
        1915, BEERGLASS, 829, true, false, false,
        false), BANDITS_BREW(4627, BEERGLASS, 829, true, false, false, false), DRAGON_BITTER(1911, BEERGLASS, 829, true,
            false, false, false), CIDER(7752, BEERGLASS, 829, true, false, false, false), MATURE_CIDER(5765, BEERGLASS,
                829, true, false, false, false), MOONLIGHT_MEAD(7750, BEERGLASS, 829, true, false, false,
                    false), DWARVEN_STOUT(1913, BEERGLASS, 829, true, false, false, false), GREENMANS_ALE(1909,
                        BEERGLASS, 829, true, false, false, false), CHEFS_DELIGHT(7754, BEERGLASS, 829, true, false,
                            false, false), ASGARNIAN_ALE(1905, BEERGLASS, 829, true, false, false,
                                false), WIZARDS_MIND_BOMB(1907, BEERGLASS, 829, true, false, false, false);

    private int bevId, replacement, bevAnim;
    private boolean effect1, effect2, effect3, effect4;

    private beverageData(final int bevId, final int replacement, final int bevAnim, final boolean effect1,
        final boolean effect2, final boolean effect3, final boolean effect4) {
      this.bevId = bevId;
