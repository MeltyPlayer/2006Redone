...
public class Kebabs {
  ...
  public static void effects(Client c) {
    ...
    if (Misc.random(100.0f) <= eff1) { // 8.71%
      c.getActionSender().sendMessage("That kebab didn't seem to do a lot.");
      ...
      c.getActionSender().sendMessage("That was a good kebab. You feel a lot better. ");
      if (c.playerLevel[3] < c.getLevelForXP(c.playerXP[3])) {
        ...
        if (c.playerLevel[3] > c.getLevelForXP(c.playerXP[3])) {
          c.playerLevel[3] = c.getLevelForXP(c.playerXP[3]);
                                             ...
                                             // 2-3 + heal 0-300
      c.getActionSender().sendMessage("Wow, that was an amazing kebab! You feel really invigorated.");
      ...
      c.getActionSender().sendMessage("That tasted very dodgy. You feel very ill.");
      c.getActionSender().sendMessage("Eating the kebab has done damage to some of your stats.");
      for (int j = 0; j < 2; j++) {
