        ...
        if (logId == l.getLogId()) {
          if (c.playerLevel[11] < l.getLevel()) {
            c.getActionSender().sendMessage(
                "You need a firemaking level of " + l.getLevel() + " to light " + ItemAssistant.getItemName(logId));
            return;
          }
          ...
          if (notInstant) {
            ...
            if (c.tutorialProgress == 4) {
              ...
              c.getDialogueHandler().chatboxText(c, "", "Your character is now attempting to light the fire.",
