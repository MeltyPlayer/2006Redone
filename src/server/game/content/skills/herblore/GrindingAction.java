...
public class GrindingAction {
	...
	public enum Data {
		UNICORN(237, 235), CHOCO(1973, 1975), NEST(5075, 6693), SCALE(243,
				241), SHARDS(6466, 6467), WEED1(401, 6683), WEED2(403,
						6683), BAT(530, 2391), CHARCOAL(973, 704), COD(341,
								7528), KELP(7516, 7517), CRABMEAT(7518,
										7527), THISLE(3263,
												3264), MUSHROOM(4620, 4622);
	...
	public static void init(Client c, int itemUsed, int useWith) {
		for (Data d : Data.values()) {
			if (itemUsed == PESTLE_AND_MORTAR && useWith == d.getId()
				...
				c.getActionSender().sendMessage("You carefully grind the "
