package server.game.content.skills.herblore;
...
public class Herblore extends SkillHandler {
  ...
  private static final int[][] CLEAN_DATA = { { 199, 249, 1, 3 }, { 201, 251, 5, 4 }, { 203, 253, 11, 5 },
      { 205, 255, 20, 6 }, { 207, 257, 25, 8 }, { 3049, 2998, 30, 8 }, { 12174, 12172, 35, 8 }, { 209, 259, 40, 9 },
      { 14836, 14854, 30, 8 }, { 211, 261, 48, 10 }, { 213, 263, 54, 11 }, { 3051, 3000, 59, 12 }, { 215, 265, 65, 13 },
  ...
  private static final int[][] POTION_DATA = { { 91, 221, 121, 1, 25 }, { 93, 235, 175, 5, 38 },
      { 95, 225, 115, 12, 50 }, { 97, 223, 127, 22, 63 }, { 99, 239, 133, 30, 75 }, { 97, 9736, 9741, 36, 84 },
      { 99, 231, 139, 38, 88 }, { 101, 221, 145, 45, 100 }, { 101, 235, 181, 48, 106 }, { 103, 231, 151, 50, 112 },
      { 105, 225, 157, 55, 125 }, { 107, 239, 163, 66, 150 }, { 2483, 241, 2454, 69, 158 }, { 109, 245, 169, 72, 163 },
      { 2483, 3138, 3042, 76, 173 }, { 111, 247, 189, 78, 175 }, { 3002, 6693, 6687, 81, 180 },
      { 5935, 6016, 5936, 73, 0 }, { 5936, 223, 5937, 73, 165 }, { 5935, 2398, 5939, 82, 0 },
      { 5939, 6018, 5940, 82, 190 }, { 227, 263, 105, 55, 0 }, { 105, 241, 187, 60, 137 }, { 227, 249, 91, 1, 0 },
      { 227, 251, 93, 5, 0 }, { 227, 253, 95, 12, 0 }, { 227, 255, 97, 22, 0 }, { 227, 257, 99, 30, 0 },
      { 227, 259, 101, 34, 0 }, { 227, 261, 103, 45, 0 }, { 3004, 223, 3026, 63, 142 }, { 227, 265, 107, 66, 0 },
      { 227, 267, 109, 72, 0 }, { 227, 269, 111, 75, 0 }, { 227, 2481, 2483, 67, 0 }, { 227, 3000, 3004, 59, 0 },
      { 227, 2998, 3002, 30, 0 }, { 1975, 97, 3010, 26, 67 }, };

  public static void setupPotion(final Client c, int useItem, int itemUsed) {
    for (int[] element : POTION_DATA) {
      if (useItem == element[0] && itemUsed == element[1] || useItem == element[1] && itemUsed == element[0]) {
    ...
    CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
      ...
      public void execute(CycleEventContainer container) {
        ...
        if (!c.getItemAssistant().playerHasItem(itemToDelete2, 1)
            || !c.getItemAssistant().playerHasItem(itemToDelete, 1) || c.doAmount <= 0) {
          container.stop();
        }
        if (!c.isPotionMaking) {
          container.stop();
