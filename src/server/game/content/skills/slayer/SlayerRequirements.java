...
public class SlayerRequirements {
  ...
  private static final int NOSE_PEG = 4168, MIRROR_SHIELD = 4156, EAR_MUFFS = 4166, ROCK_HAMMER = 4162, FACEMASK = 4164,
      ...
      case 1616:// cockatrice
        if (client.playerEquipment[client.playerShield] != MIRROR_SHIELD) {
          client.getActionSender().sendMessage(
              "You need a Mirror Shield to attack a " + NpcHandler.getNpcListName(npcType).toLowerCase() + ".");
          client.getCombatAssistant().resetPlayerAttack();
          return false;
        }
        break;
