package server.game.content.skills.slayer;
...
public class Slayer {
  ...
  public static final int VERY_EASY_TASK = 0, EASY_TASK = 1, MEDIUM_TASK = 2, HARD_TASK = 3, VERY_HARD_TASK = 4,
      VERY_EASY_AMOUNT = 15 + r(25), EASY_AMOUNT = 25 + r(25), MEDIUM_AMOUNT = 50 + r(25), HARD_AMOUNT = 100 + r(50),
      VERY_HARD_AMOUNT = 130 + r(70), DRAGON_AMOUNT = 10 + r(40);
  ...
  public enum SlayerMasters {
    TURAEL(70, 1, "Taverly", "Turael"), MAZCHNA(1596, 20, "Canifis", "Mazchna"), VANNAKA(1597, 40, "Edgeville",
        "Vannaka"), CHAELDAR(1598, 70, "Zanaris", "Chaeldar"), DURADEL(1599, 100, "Shilo Village", "Duradel");

    private int masterId, combatReq;
    private String masterLocation, masterName;

    private SlayerMasters(int masterId, int combatReq, String masterLocation, String masterName) {
  ...
  public enum Task {
    ABERRANT_SPECTRE(1604, 60, 90, 3, "Slayer Tower"), ABYSSAL_DEMON(1615, 85, 150, 4, "Slayer Tower"), BANSHEE(1612,
        15, 22, 0 + r(2), "Slayer Tower"), BASILISK(1616, 40, 75, 2, "Fremennik Slayer Dungeon"), BAT(412, 1, 8, 1,
            "Road to Paterdomus"), BLACK_DEMON(84, 1, 157, 3, "Taverly Dungeon"), BLACK_DRAGON(54, 1, 258, 4,
                "Taverly Dungeon"), BLOODVELD(1618, 50, 120, 3 + r(1), "Slayer Tower"), BLUE_DRAGON(55, 1, 107, 3,
                    "Taverly Dungeon"), BRONZE_DRAGON(1590, 1, 125, 3, "Brimhaven Dungeon"), CAVE_CRAWLER(1600, 10, 22,
                        1, "Fremennik Slayer Dungeon"), COCKATRICE(1620, 25, 37, 2,
                            "Fremennik Slayer Dungeon"), CRAWLING_HAND(1648, 5, 16 + r(3), 1 + r(1),
                                "Slayer Tower"), DAGANNOTH_74(1338, 1, 70 + r(50), 3,
                                    "Lighthouse Basement"), DAGANNOTH_92(1342, 1, 70 + r(50), 3,
                                        "Lighthouse Basement"), DARK_BEAST(2783, 90, 180, 4,
                                            "Slayer Tower"), DUST_DEVIL(1624, 65, 105, 2,
                                                "Slayer Tower"), EARTH_WARRIOR(124, 1, 54, 2,
                                                    "Edgeville Dungeon"), FIRE_GIANT(110, 1, 111, 3,
                                                        "Brimhaven Dungeon"), GARGOYLE(1611, 75, 105, 3,
                                                            "Slayer Tower"), GHOST(103, 1, 25, 1 + r(1),
                                                                "Taverly Dungeon"), GREATER_DEMON(83, 1, 87, 3,
                                                                    "Brimhaven Dungeon"), GREEN_DRAGON(941, 1, 75, 2,
                                                                        "The Wilderness"), HELLHOUND(49, 1, 116,
                                                                            3 + r(1),
                                                                            "Taverly Dungeon"), HILL_GIANT(117, 1, 35,
                                                                                2, "Edgeville Dungeon"), ICE_GIANT(111,
                                                                                    1, 70, 2,
                                                                                    "Asgarnian Ice Caves or White Wolf Mountain"), ICE_WARRIOR(
                                                                                        125, 1, 59, 2,
                                                                                        "Asgarnian Ice Caves or the Wilderness"), SKELETAL_WYVERN(
                                                                                            3068, 72, 210, 4,
                                                                                            "Asgarnian Ice Caves"), INFERNAL_MAGE(
                                                                                                ...
                                                                                                "Slayer Tower"), IRON_DRAGON(
                                                                                                    ...
                                                                                                    "Brimhaven Dungeon"), JELLY(
                                                                                                        1637, 52, 75, 2,
                                                                                                        "Fremennik Slayer Dungeon"), KALPHITE_WORKER(
                                                                                                            1156, 1, 40,
                                                                                                            1 + r(1),
                                                                                                            "Kalphite Lair"), KALPHITE_SOLDIER(
                                                                                                                1154, 1,
                                                                                                                90, 3,
                                                                                                                "Kalphite Lair"), KALPHITE_GUARDIAN(
                                                                                                                    1157,
                                                                                                                    1,
                                                                                                                    170,
                                                                                                                    4,
                                                                                                                                        ...
                                                                                                                                        "Fremennik Slayer Dungeon"), RED_DRAGON(
                                                                                                                                            ...
                                                                                                                                            "Brimhaven Dungeon"), ROCKSLUG(
                                                                                                                                                ...
                                                                                                                                                "Fremennik Slayer Dungeon"), SKELETON(
                                                                                                                                                    ...
                                                                                                                                                    0 + r(
                                                                                                                                                        2),
                                                                                                                                                    "Edgeville Dungeon or Taverly Dungeon"), KARAMAJA_SKELETON(
                                                                                                                                                        91,
                                                                                                                                                        1,
                                                                                                                                                        30,
                                                                                                                                                        0 + r(
                                                                                                                                                            2),
                                                                                                                                                        "Karamaja"), WILDERNESS_SKELETON(
                                                                                                                                                            92,
                                                                                                                                                            1,
                                                                                                                                                            30,
                                                                                                                                                            0 + r(
                                                                                                                                                                2),
                                                                                                                                                            "Wilderness"), STEEL_DRAGON(
                                                                                                                                                                1592,
                                                                                                                                                                1,
                                                                                                                                                                221,
                                                                                                                                                                4,
                                                                                                                                                                "Brimhaven Dungeon"), GRIZZLY_BEAR(
                                                                                                                                                                    105,
                                                                                                                                                                    1,
                                                                                                                                                                    27,
                                                                                                                                                                    0,
                                                                                                                                                                    "Goblin Village"), GREEN_GOBLIN(
                                                                                                                                                                        298,
                                                                                                                                                                        1,
                                                                                                                                                                        6,
                                                                                                                                                                        0,
                                                                                                                                                                        "Goblin Village"), RED_GOBLIN(
                                                                                                                                                                            299,
                                                                                                                                                                            1,
                                                                                                                                                                            6,
                                                                                                                                                                            0,
                                                                                                                                                                            "Goblin Village"), SCORPION(
                                                                                                                                                                                107,
                                                                                                                                                                                1,
                                                                                                                                                                                17,
                                                                                                                                                                                0,
                                                                                                                                                                                "Goblin Village"), TUROTH(
                                                                                                                                                                                    1632,
                                                                                                                                                                                    55,
                                                                                                                                                                                    77,
                                                                                                                                                                                    3,
  ...
  public boolean canAttackNpc(int i) {
    if (c.playerLevel[c.playerSlayer] < getRequiredLevel(NpcHandler.npcs[i].npcType)) {
      c.getActionSender().sendMessage(
          "You need a slayer level of " + getRequiredLevel(NpcHandler.npcs[i].npcType) + " to attack this npc.");
  ...
  public void resizeTable(int difficulty) {
    if (easyTask.size() > 0 || hardTask.size() > 0 || mediumTask.size() > 0 || veryHardTask.size() > 0
        || veryEasyTask.size() > 0) {
      easyTask.clear();
      mediumTask.clear();
      hardTask.clear();
  ...
  public boolean getMasterRequirment(int id) {
    for (SlayerMasters slayermasters : SlayerMasters.values()) {
      if (c.combatLevel < slayermasters.getCombatRequirement() && slayermasters.getId() == id) {
        c.getActionSender()
            .sendMessage("You need " + slayermasters.getCombatRequirement() + " combat to use this slayer master.");
        return false;
      }
    }
    return true;
  ...
  public void generateTask() {
    if (hasTask() && !c.needsNewTask) {
      c.getDialogueHandler().sendDialogues(1226, c.npcType);// already
                                                            // have
                                                            // task
      return;
    }
    if (hasTask() && c.needsNewTask) {// assigning new task
      ...
      if (difficulty == VERY_EASY_TASK) {
         ...
         * VERY_EASY_TASK; int task = getRandomTask(taskLevel); c.slayerTask =
         * task; c.taskAmount = getTaskAmount(taskLevel);
         * c.getDialogues().handleDialogues(1368, c.npcType);
         * c.getPacketDispatcher().sendMessage("You have been assigned " +
         * c.taskAmount + " " + getTaskName(c.slayerTask) + ", good luck " +
         * c.playerName + "."); c.needsNewTask = false;
         */
      }
    }
      ...
      if (slayerTask.getDifficulty() == taskLevel) {
        if (c.playerLevel[18] >= slayerTask.getLevelReq()) {
          ...
          c.getDialogueHandler().sendDialogues(1237, c.npcType);// assign
                                                                // task
          c.getActionSender().sendMessage("You have been assigned " + c.taskAmount + " " + getTaskName(c.slayerTask)
  ...
  public void cancelTask() {
    ...
    if (c.slayerPoints < 30) {
      ...
      c.getDialogueHandler().sendNpcChat1("This requires atleast 30 slayer points, which you don't have.", c.npcType,
          NpcHandler.getNpcListName(c.talkingNpc));
      c.nextChat = 0;
      return;
    }
    c.getActionSender()
        .sendMessage("You have cancelled your current task of " + c.taskAmount + " " + getTaskName(c.slayerTask) + ".");
    c.slayerTask = -1;
    c.taskAmount = 0;
    c.slayerPoints -= 30;
  }
  ...
  public void removeTask() {
    ...
    if (c.slayerPoints < 100) {
      ...
      c.getDialogueHandler().sendNpcChat1("This requires atleast 100 slayer points, which you don't have.", c.npcType,
          NpcHandler.getNpcListName(c.talkingNpc));
      c.nextChat = 0;
      return;
    }
  ...
  public void buySlayerExperience() {
    ...
    c.getActionSender().sendMessage("You spend 50 slayer points and gain 16,250 experience in slayer.");
    updatePoints();
  }
  ...
  public void buySlayerDart() {
    ...
    if (c.getItemAssistant().freeSlots() < 2 && !c.getItemAssistant().playerHasItem(560)
