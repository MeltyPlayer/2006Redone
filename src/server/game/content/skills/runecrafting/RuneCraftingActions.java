  ...
  public static void handleRuneCrafting(Client client, int objectId) {
    switch (objectId) {
      ...
      case 2471:// cosmic altar portal
        if (client.objectX == 2163 && client.objectY == 4833 || client.objectX == 2142 && client.objectY == 4854
            || client.objectX == 2121 && client.objectY == 4833 || client.objectX == 2412 && client.objectY == 4812) {
      ...
      case 2475:// death altar portal
        if (client.objectX == 2208 && client.objectY == 4829) {
          client.getPlayerAssistant().startTeleport(1863, 4639, 0, "modern");
        }
        break;
