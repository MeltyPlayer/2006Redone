  ...
  public static void handleAbyssalTeleport(Client c, int objectId) {
    switch (objectId) {
      ...
      case 7134: // chaos
        ...
        break;
      default:
        c.getActionSender().sendMessage("If you see this message, please PM an Administrator.");
        break;
    }
    c.getActionSender().sendMessage("As you click the object, you teleport to a mystical place...");
  }
