...
public class WerewolfAgility {
  ...
  public static final int WEREWOLF_STEPPING_STONE_OBJECT = 5138, WEREWOLF_HURDLE_OBJECT1 = 5133,
      WEREWOLF_HURDLE_OBJECT2 = 5134, WEREWOLF_HURDLE_OBJECT3 = 5135, WEREWOLF_PIPES_OBJECT = 5152,
    ...
    switch (objectId) {
      case WEREWOLF_STEPPING_STONE_OBJECT:
        ...
        if (c.getAgility().hotSpot(3538, 9873)) {
          ...
          c.getAgility().walk(1, 2, c.getAgility().getAnimation(objectId), -1);
          c.getPlayerAssistant().addSkillXP(c.getAgility().getXp(objectId), c.playerAgility);
          c.getAgility().resetAgilityProgress();
          c.getAgility().agilityProgress[0] = true;
      ...
      case WEREWOLF_PIPES_OBJECT:
        ...
        if (c.getAgility().hotSpot(3538, 9904)) {
          c.getAgility().walk(0, 6, c.getAgility().getAnimation(objectId), 748);
          c.getPlayerAssistant().addSkillXP(c.getAgility().getXp(objectId), c.playerAgility);
      ...
      case 5139:
        if (c.getAgility().hotSpot(3528, 9910)) {
          c.getAgility().walk(0, -39, c.getAgility().getAnimation(WerewolfAgility.WEREWOLF_SLING_OBJECT), 743);
          c.getPlayerAssistant().addSkillXP(c.getAgility().getXp(objectId), c.playerAgility);
