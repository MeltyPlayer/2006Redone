    ...
    switch (client.objectId) {
      ...
      case 9330:
        if (client.objectX == 2601 && client.objectY == 3336) {
          handleAgility(client, -4, 0, 33, client.getAgility().getAnimation(Agility.PIPES_EMOTE), AGILITY,
      ...
      case 9293:
        if (client.absX < client.objectX) {
          handleAgility(client, 2892, 9799, 70, client.getAgility().getAnimation(Agility.PIPES_EMOTE), MOVE,
              "You pass through the agility shortcut.");
        } else {
          handleAgility(client, 2886, 9799, 70, client.getAgility().getAnimation(Agility.PIPES_EMOTE), MOVE,
              "You pass through the agility shortcut.");
        }
        break;
      ...
      case 9294:
        if (client.absX < client.objectX) {
          client.getPlayerAssistant().movePlayer(client.objectX + 1, client.absY, 0);
          handleAgility(client, 2880, 9713, 80, 3067, MOVE, "You jump over the strange wall.");
        } else if (client.absX > client.objectX) {
          handleAgility(client, 2878, 9713, 80, 3067, MOVE, "You jump over the strange wall.");
        }
        break;
