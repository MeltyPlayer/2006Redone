...
public class BarbarianAgility {
  ...
  public static final int BARBARIAN_ROPE_SWING_OBJECT = 2282, BARBARIAN_LOG_OBJECT = 2294, BARBARIAN_NET_OBJECT = 2284,
      BARBARIAN_LEDGE_OBJECT = 2302, BARBARIAN_LADDER_OBJECT = 3205, BARBARIAN_WALL_OBJECT = 1948; // barbarian
                                                                                                   // course
                                                                                                   // objects
    ...
    switch (objectId) {
      ...
      case BARBARIAN_LEDGE_OBJECT:
        ...
        if (c.getAgility().hotSpot(2536, 3547)) {
          c.getAgility().walk(-4, 0, c.getAgility().getAnimation(objectId), -1);
          c.getPlayerAssistant().addSkillXP(c.getAgility().getXp(objectId), c.playerAgility);
      ...
      case BARBARIAN_LADDER_OBJECT:
        if (c.playerLevel[c.playerAgility] < 35 && c.objectX != 2776 && c.objectY != 3121) {
          c.getActionSender().sendMessage("You need 35 agility to use this ladder.");
          return false;
      ...
      case BARBARIAN_WALL_OBJECT:
        ...
        if (c.getAgility().hotSpot(2541, 3553)) {
          ...
          c.getAgility().walk(3, 0, c.getAgility().getAnimation(objectId), -1);
          c.getPlayerAssistant().addSkillXP(c.getAgility().getXp(objectId), c.playerAgility);
        } else if (c.absX == 2542 && c.absY == 3553) {
          c.getAgility().walk(1, 0, c.getAgility().getAnimation(objectId), -1);
        } else if (c.absX == 2535 && c.absY == 3553 || c.absX == 2538 && c.absY == 3553) {
          c.getAgility().walk(2, 0, c.getAgility().getAnimation(objectId), -1);
          c.getPlayerAssistant().addSkillXP(c.getAgility().getXp(objectId), c.playerAgility);
          return true;
        }
