...
public class ApeAtollAgility {
  ...
  public static final int APE_ATOLL_STEPPING_STONES_OBJECT = 12568, APE_ATOLL_TROPICAL_TREE_OBJECT = 12570,
      APE_ATOLL_MONKEYBARS_OBJECT = 12573, APE_ATOLL_SKULL_SLOPE_OBJECT = 12576, APE_ATOLL_SWINGROPE_OBJECT = 12578,
    ...
    switch (objectId) {
      case APE_ATOLL_STEPPING_STONES_OBJECT:
        if (c.npcId2 != NINJA_MONKEY_NPC) {
          c.getActionSender().sendMessage("You can't do that! You aren't a monkey.");
          return false;
        }
      ...
      case APE_ATOLL_TROPICAL_TREE_OBJECT:
        ...
        if (c.getAgility().hotSpot(2753, 2742) && c.heightLevel == 0) {
          c.getActionSender().sendMessage("You managed to climb up the Tree.");
      ...
      case APE_ATOLL_MONKEYBARS_OBJECT:
        ...
        if (c.getAgility().hotSpot(2752, 2741)) {
          c.getActionSender().sendMessage("You swing yourself to the other side");
