...
public class WildernessAgility {
  ...
  public static final int WILDERNESS_PIPE_OBJECT = 2288, WILDERNESS_SWING_ROPE_OBJECT = 2283,
      WILDERNESS_STEPPING_STONE_OBJECT = 2311, WILDERNESS_LOG_BALANCE_OBJECT = 2297, WILDERNESS_ROCKS_OBJECT = 2328;
    ...
    switch (objectId) {
      case WILDERNESS_PIPE_OBJECT: // pipe
        ...
        if (c.getAgility().hotSpot(3004, 3937)) {
          c.getAgility().walk(0, 13, c.getAgility().getAnimation(objectId), 748);
      ...
      case WILDERNESS_LOG_BALANCE_OBJECT:
        ...
        if (c.getAgility().hotSpot(3002, 3945)) {
          c.getAgility().walk(-8, 0, c.getAgility().getAnimation(objectId), -1);
