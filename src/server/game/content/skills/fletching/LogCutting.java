...
public class LogCutting {
    ...
    CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
      ...
      public void execute(CycleEventContainer container) {
        if (c.getItemAssistant().playerHasItem(KNIFE)) {
          ...
          c.getActionSender().sendMessage("You carefully cut the " + ItemAssistant.getItemName(LogCuttingInterface.log)
              + " into an " + ItemAssistant.getItemName(product) + ".");
  ...
  public static void flightedArrow(Client c) {// to do
    ...
    if (c.getItemAssistant().playerHasItem(314) && c.getItemAssistant().playerHasItem(2864)) {
      final int feather = c.getItemAssistant().getItemCount(314), arrowShaft = c.getItemAssistant().getItemCount(2864);
      if (feather == arrowShaft * 4) {
        ...
        c.getActionSender().sendMessage(
            "You turn your " + ItemAssistant.getItemName(2864) + " into " + ItemAssistant.getItemName(2865) + "(s).");
        /*
         * } else if (feather > arrowShaft * 4) {//to fix
         * c.startAnimation(1248); c.getItemAssistant().deleteItem2(314,
         * feather*4); c.getItemAssistant().deleteItem2(2864, arrowShaft);
         * c.getItemAssistant().addItem(2865, arrowShaft);
  ...
  public static void ogreArrow(Client c) {
    ...
    if (c.getItemAssistant().playerHasItem(2861) && c.getItemAssistant().playerHasItem(2865)) {
      if (wolfBoneArrow == flightedArrow) {
        ...
        c.getActionSender().sendMessage("You turn your " + ItemAssistant.getItemName(2865) + " (s) into "
  ...
  public static void makeShafts(Client c) {
    if (c.getItemAssistant().playerHasItem(2862) && c.getItemAssistant().playerHasItem(946)) {
      ...
      c.getActionSender().sendMessage(
          "You turn your " + ItemAssistant.getItemName(2862) + " (s) into " + ItemAssistant.getItemName(2864) + "(s).");
    }
  }
}
