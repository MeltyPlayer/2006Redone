...
public class Stringing {
	...
	public enum Data {
		...
		SHORT_BOW(50, 1777, 841, 5, 5), LONG_BOW(48, 1777, 839, 10,
				10), OAK_SHORT_BOW(54, 1777, 843, 20, 16.5), OAK_LONG_BOW(56,
						1777, 845, 25, 25), COMPOSITE_BOW(4825, 1777, 4827, 30,
								45), WILLOW_SHORT_BOW(60, 1777, 849, 35,
										33.3), WILLOW_LONG_BOW(58, 1777, 847,
												40, 41.5), MAPLE_SHORT_BOW(64,
														1777, 853, 50,
														50), MAPLE_LONG_BOW(62,
																1777, 851, 55,
																58.3), YEW_SHORT_BOW(
																		68,
																		1777,
	...
	public static boolean StringBow(final Client c, int itemUsed,
			int usedWith) {
		...
		if (c.playerLevel[9] < loadData.getLevel()) {
			c.getDialogueHandler()
					.sendStatement("You need a fletching level of "
							+ loadData.getLevel() + " to do this");
			return false;
		}
		if (!c.getItemAssistant().playerHasItem(loadData.getItem1())
				|| !c.getItemAssistant().playerHasItem(loadData.getItem2())) {
			c.getDialogueHandler().sendStatement("You need a "
					+ ItemAssistant.getItemName(loadData.getItem1()) + " and a "
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				if (!c.getItemAssistant().playerHasItem(loadData.getItem1())
						|| !c.getItemAssistant()
								.playerHasItem(loadData.getItem2())
