package server.game.content.skills.smithing;
...
public class SilverCrafting {
  ...
  public static enum SilverCraft {
    UNBLESSED(34205, 2355, 1716, 1, 16, 50), UNBLESSED5(34204, 2355, 1716, 5, 16, 50), UNBLESSED10(34203, 2355, 1716,
        10, 16, 50), UNBLESSEDX(34202, 2355, 1716, 0, 16, 50), UNHOLY(34209, 2355, 1724, 1, 17, 50), UNHOLY5(34208,
            2355, 1724, 5, 17, 50), UNHOLY10(34207, 2355, 1724, 10, 17, 50), UNHOLYX(34206, 2355, 1724, 0, 17,
                50), SICKLE(34213, 2355, 2961, 1, 18, 50), SICKLE5(34212, 2355, 2961, 5, 18, 50), SICKLE10(34211, 2355,
                    2961, 10, 18, 50), SICKLEX(34210, 2355, 2961, 0, 18, 50), TIARA(34217, 2355, 5525, 1, 23,
                        52.5), TIARA5(34216, 2355, 5525, 5, 23,
                            52.5), TIARA10(34215, 2355, 5525, 10, 23, 52.5), TIARAX(34214, 2355, 5525, 0, 23, 52.5);
  ...
  public static void makeSilver(final Client player, int buttonId, final int amount) {
    ...
    if (silverCraft.getUsed() == SILVER_BAR && player.isCrafting) {
      ...
      CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
        ...
        public void execute(CycleEventContainer container) {
          if (amnt == 0 || !player.getItemAssistant().playerHasItem(SILVER_BAR) || player.isCrafting == false) {
            container.stop();
            return;
          }
          container.setTick(3);
          player.startAnimation(SILVER_ANIMATION);
          player.getActionSender().sendMessage("You make the silver bar into "
              + ItemAssistant.getItemName(silverCraft.getResult()).toLowerCase().toLowerCase() + ".");
          player.getItemAssistant().deleteItem2(SILVER_BAR, 1);
          player.getItemAssistant().addItem(silverCraft.getResult(), 1);
          player.getPlayerAssistant().addSkillXP(silverCraft.getExperience(), player.playerCrafting);
          amnt--;
