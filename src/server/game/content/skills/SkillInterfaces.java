...
public class SkillInterfaces {
   ...
   * @param write
   *          []
   * @return Used to shorten the sidebar tab texts, shortens by up to 12x, Also
   *         includes the title of the menu and the current tab
   */
  private void optionTab(String title, String currentTab, String op1, String op2, String op3, String op4, String op5,
    ...
    if (SkillHandler.isSkilling(c)) {
      c.getActionSender().sendMessage("You can't open this while skilling!");
      return;
    }
  ...
  public void attackComplex(int screen) {
    if (screen == 1) {
      ...
      optionTab("Attack", type, "Bronze", "Iron", "Steel", "Black", "White", "Mithril", "Adamant", "Rune", "Dragon",
          "Barrows", "Special", "", "");
    } else if (screen == 2) {
      clearMenu();
      String level = "1";
  ...
  public void defenceComplex(int screen) {
    if (screen == 1) {
      ...
      optionTab("Defence", type, "Bronze", "Iron", "Steel", "Black", "White", "Mithril", "Adamant", "Rune", "Dragon",
      ...
      optionTab("Defence", "Barrows", "Bronze", "Iron", "Steel", "Black", "White", "Mithril", "Adamant", "Rune",
          "Dragon", "Barrows", "Magic", "Equipment", "");
    }
      ...
      optionTab("Defence", "Magic", "Bronze", "Iron", "Steel", "Black", "White", "Mithril", "Adamant", "Rune", "Dragon",
          "Barrows", "Magic", "Equipment", "");
    }
  ...
  public void smithingComplex(int screen) {
    if (screen == 1) {
      ...
      optionTab("Smithing", "Bronze", "Smelting", "Bronze", "Iron", "Steel", "Mithril", "Adamantite", "Runite", "Gold",
          "Elemental", "Other", "", "", "");
    } else if (screen == 3) {
      clearMenu();
      String type = "Iron";
      ...
      menuLine("28", type + " Claws(After Death Plateau) - 2 Bars", 3096, 20);
      ...
      optionTab("Smithing", "Iron", "Smelting", "Bronze", "Iron", "Steel", "Mithril", "Adamantite", "Runite", "Gold",
          "Elemental", "Other", "", "", "");
    }
      ...
      optionTab("Smithing", "Steel", "Smelting", "Bronze", "Iron", "Steel", "Mithril", "Adamantite", "Runite", "Gold",
          "Elemental", "Other", "", "", "");
    } else if (screen == 5) {
      clearMenu();
      String type = "Mithril";
      ...
      menuLine("63", type + " Claws(After Death Plateau) - 2 Bars", 3099, 18);
      ...
      optionTab("Smithing", "Mithril", "Smelting", "Bronze", "Iron", "Steel", "Mithril", "Adamantite", "Runite", "Gold",
          "Elemental", "Other", "", "", "");
    } else if (screen == 6) {
      clearMenu();
      String type = "Adamant";
      ...
      menuLine("83", type + " Claws(After Death Plateau) - 2 Bars", 3100, 18);
      ...
      optionTab("Smithing", "Adamantite", "Smelting", "Bronze", "Iron", "Steel", "Mithril", "Adamantite", "Runite",
          "Gold", "Elemental", "Other", "", "", "");
    } else if (screen == 7) {
      clearMenu();
      String type = "Rune";
      ...
      menuLine("98", type + " Claws(After Death Plateau) - 2 Bars", 3101, 18);
      ...
      optionTab("Smithing", "Runite", "Smelting", "Bronze", "Iron", "Steel", "Mithril", "Adamantite", "Runite", "Gold",
          "Elemental", "Other", "", "", "");
    } else if (screen == 8) {
      clearMenu();
      menuLine("50", "Gold Bowl(After Starting Legends' Quest)", 721, 0);
      menuLine("50", "Gold Helmet(After starting Between a Rock)", 4567, 1);
      optionTab("Smithing", "Gold", "Smelting", "Bronze", "Iron", "Steel", "Mithril", "Adamantite", "Runite", "Gold",
          "Elemental", "Other", "", "", "");
    } else if (screen == 9) {
      clearMenu();
      ...
      optionTab("Smithing", "Other", "Smelting", "Bronze", "Iron", "Steel", "Mithril", "Adamantite", "Runite", "Gold",
          "Elemental", "Other", "", "", "");
    }
  }
  ...
  public void cookingComplex(int screen) {
    if (screen == 1) {
      ...
      optionTab("Cooking", "Hot Drinks", "Meats", "Bread", "Pies", "Stews", "Pizzas", "Cakes", "Wine", "Hot Drinks",
          "Brewing", "Potatoes", "Diary", "Gnome", "");
    }
      ...
      optionTab("Cooking", "", "Meats", "Bread", "Pies", "Stews", "Pizzas", "Cakes", "Wine", "Hot Drinks", "Brewing",
  ...
  public void farmingComplex(int screen) {
    if (screen == 1) {
      ...
      optionTab("Farming", "Allotments", "Allotments", "Hops", "Trees", "Fruit Trees", "Bushes", "Flowers", "Herbs",
          "Special", "Scarecrows", "", "", "", "");
    }
      ...
      optionTab("Farming", "Fruit Trees", "Allotments", "Hops", "Trees", "Fruit Trees", "Bushes", "Flowers", "Herbs",
          "Special", "Scarecrows", "", "", "", "");
    }
      ...
      optionTab("Farming", "Scarecrows", "Allotments", "Hops", "Trees", "Fruit Trees", "Bushes", "Flowers", "Herbs",
          "Special", "Scarecrows", "", "", "", "");
    }
  }
}
