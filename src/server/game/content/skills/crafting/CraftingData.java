...
public class CraftingData extends SkillHandler {
	...
	public static enum tanningData {
		...
		SOFT_LEATHER(new int[][] { { 57225, 1 }, { 57217, 5 }, { 57201, 28 } },
				...
				"Soft leather"), HARD_LEATHER(
						new int[][] { { 57226, 1 }, { 57218, 5 },
								{ 57202, 28 } },
						1739, 1743, 3, new int[] { 14778, 14786, 14770 },
						"Hard leather"), SNAKESKIN(
								new int[][] { { 57227, 1 }, { 57219, 5 },
										{ 57203, 28 } },
								6287, 6289, 15,
								new int[] { 14779, 14787, 14771 },
								"Snakeskin"), SNAKESKIN2(
										new int[][] { { 57228, 1 },
												{ 57220, 5 }, { 57204, 28 } },
										6287, 6289, 20,
										new int[] { 14780, 14788, 14772 },
										"Snakeskin"), GREEN_DRAGON_LEATHER(
												new int[][] { { 57229, 1 },
														{ 57221, 5 },
														{ 57205, 28 } },
												1753, 1745, 20,
	...
	public static enum leatherDialogueData {
		...
		GREEN_LEATHER(1745, 1065, 1135, 1099), BLUE_LEATHER(2505, 2487, 2499,
				2493), RED_LEATHER(2507, 2489, 2501,
	...
	public enum Leather {
		...
		LEATHER_GLOVES(1733, 1741, 1059, 1, 1, 13.75), LEATHER_BOOTS(1733, 1741,
				1061, 1, 7, 16.25);
	...
	public static enum leatherData {
		...
		LEATHER_BODY(new int[][] { { 33187, 1 }, { 33186, 5 }, { 33185, 10 } },
				1741, 1129, 14, 25, 1), LEATHER_GLOVES(
						new int[][] { { 33190, 1 }, { 33189, 5 },
								{ 33188, 10 } },
						1741, 1059, 1, 13.8, 1), LEATHER_BOOTS(
								new int[][] { { 33193, 1 }, { 33192, 5 },
										{ 33191, 10 } },
								1741, 1061, 7, 16.25, 1), LEATHER_VAMBRACES(
										new int[][] { { 33196, 1 },
												{ 33195, 5 }, { 33194, 10 } },
										1741, 1063, 11, 22, 1), LEATHER_CHAPS(
												new int[][] { { 33199, 1 },
														{ 33198, 5 },
														{ 33197, 10 } },
												1741, 1095, 18, 27,
	...
	public static enum cutGemData {
		...
		SAPPHIRE(1623, 1607, 20, 50, 888), EMERALD(1621, 1605, 27, 67,
				889), RUBY(1619, 1603, 34, 85, 887), DIAMOND(1617, 1601, 43,
						107.5, 886), DRAGONSTONE(1631, 1615, 55, 137.5,
								885), ONYX(6571, 6573, 67, 168, 885),
		/**
		 * 
		 * Need correct animation ID
		 **/
		OPAL(1625, 1609, 1, 12, 890), JADE(1627, 1611, 13, 20,
				891), RED_TOPAZ(1629, 1613, 16, 25, 892);
	...
	public static enum jewelryData {
		...
		RINGS(new int[][] { { 2357, 1635, 5, 15 }, { 1607, 1637, 20, 40 },
				...
				{ 6573, 6575, 67, 115 } }), NECKLACE(
						new int[][] { { 2357, 1654, 6, 20 },
								{ 1607, 1656, 22, 55 }, { 1605, 1658, 29, 60 },
								{ 1603, 1660, 40, 75 }, { 1601, 1662, 56, 90 },
								{ 1615, 1664, 72, 105 },
								{ 6573, 6577, 82, 120 } }), AMULETS(
										new int[][] { { 2357, 1673, 8, 30 },
												{ 1607, 1675, 24, 65 },
												{ 1605, 1677, 31, 70 },
												{ 1603, 1679, 50, 85 },
												{ 1601, 1681, 70, 100 },
