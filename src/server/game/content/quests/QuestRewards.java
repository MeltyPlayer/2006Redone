...
public class QuestRewards {
  ...
  public static void QuestReward(Client client, String questName, String Line1, String Line2, String Line3,
  ...
  public static void gertFinish(Client client) {
    QuestReward(client, "Gertrude's Cat", "1 Quest Point", "1,525 Cooking XP", "A kitten!", "Ability to raise cats",
