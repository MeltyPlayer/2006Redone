	...
	public void showInformation() {
		...
		if (client.romeojuliet == 0) {
			...
			client.getPlayerAssistant()
					.sendFrame126("@str@found in Varrock Square.", 8148);
			...
			client.getPlayerAssistant().sendFrame126(
					...
					8151);
			client.getPlayerAssistant().sendFrame126("his letters lately.",
					8152);
			...
			client.getPlayerAssistant()
					.sendFrame126("@str@could this be for Romeo?", 8156);
			client.getPlayerAssistant().sendFrame126("", 8157);
			client.getPlayerAssistant().sendFrame126(
					"You have spoken to Romeo and given him the message", 8158);
			client.getPlayerAssistant()
					.sendFrame126("You should try to talk to him again", 8159);
			...
			client.getPlayerAssistant().sendFrame126(
					...
					8162);
			client.getPlayerAssistant()
					.sendFrame126("I should go speak to Juliet", 8163);
			...
			client.getPlayerAssistant()
					.sendFrame126("I should go speak to Romeo", 8169);
			...
			client.getPlayerAssistant().sendFrame126("", 8167);
			client.getPlayerAssistant().sendFrame126(
					"@str@I have spoken to Juliet, she drank the potion", 8168);
			client.getPlayerAssistant()
					.sendFrame126("@str@I should go speak to Romeo", 8169);
			client.getPlayerAssistant().sendFrame126("", 8168);
			client.getPlayerAssistant().sendFrame126(
					"I have spoken to Romeo, he's thankful for all of our help",
					8169);
			client.getPlayerAssistant().sendFrame126("@red@     QUEST COMPLETE",
					8170);
			client.getPlayerAssistant().sendFrame126(
					"As a reward, I gained 5 quest points.", 8171);
		}
