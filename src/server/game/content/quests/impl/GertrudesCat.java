	...
	public void showInformation() {
		...
		if (client.gertCat == 0) {
			...
			client.getPlayerAssistant()
					.sendFrame126("@str@I've talked to Gertrude", 8147);
			client.getPlayerAssistant().sendFrame126(
					"I should speak to Wilough and Shilop.", 8148);
			client.getPlayerAssistant()
					.sendFrame126("They are in the varrock square.", 8149);
		} else if (client.gertCat == 2) {
			client.getPlayerAssistant().sendFrame126("Gertrudes Cat", 8144);
			client.getPlayerAssistant().sendFrame126(
					"@str@I've talked to Wilough and Shilop", 8147);
			client.getPlayerAssistant()
					.sendFrame126("@str@I gave them 100 coins", 8148);
			client.getPlayerAssistant()
					.sendFrame126("I should try to find Gertrudes Cat.", 8149);
		} else if (client.gertCat == 3) {
			client.getPlayerAssistant().sendFrame126("Gertrudes Cat", 8144);
			client.getPlayerAssistant().sendFrame126(
					"@str@I've talked to the Gertrudes Cat", 8147);
			client.getPlayerAssistant()
					.sendFrame126("@str@She seemed mad so I gave her", 8148);
			client.getPlayerAssistant().sendFrame126("@str@a bucket of milk",
					8149);
			client.getPlayerAssistant().sendFrame126(
					"The cat still seems mad you should give her some,", 8150);
			client.getPlayerAssistant().sendFrame126("seasoned salmon.", 8151);
		} else if (client.gertCat == 4) {
			client.getPlayerAssistant().sendFrame126("Gertrudes Cat", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@The cat is still mad", 8147);
			client.getPlayerAssistant().sendFrame126("@str@So i gave her some",
					8148);
			client.getPlayerAssistant().sendFrame126("@str@seasoned samon.",
					8149);
			client.getPlayerAssistant().sendFrame126(
					"I should talk to Gertrudes cat to see how she feels.",
					8150);
		} else if (client.gertCat == 5) {
			client.getPlayerAssistant().sendFrame126("Gertrudes Cat", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@The cat seems to be mad", 8147);
			client.getPlayerAssistant().sendFrame126(
					"@str@because she can't find her kittens.", 8148);
			client.getPlayerAssistant()
					.sendFrame126("I should go in the lumberyard and", 8149);
			client.getPlayerAssistant().sendFrame126("check it out.", 8150);
		} else if (client.gertCat == 6) {
			client.getPlayerAssistant().sendFrame126("Gertrudes Cat", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I gave gertrudes cat", 8147);
			client.getPlayerAssistant().sendFrame126("@str@her kittens", 8148);
			client.getPlayerAssistant()
					.sendFrame126("@str@and she now seems happy.", 8149);
			client.getPlayerAssistant()
					.sendFrame126("I should head back to Gertrude.", 8150);
		} else if (client.gertCat == 7) {
			client.getPlayerAssistant().sendFrame126("Gertrudes Cat", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I helped gertrude with her", 8147);
			client.getPlayerAssistant()
					.sendFrame126("@str@Cat so she awarded me.", 8148);
