...
public class VampyreSlayer {
  ...
  public void showInformation() {
    ...
    if (client.vampSlayer == 0) {
      ...
      client.getPlayerAssistant().sendFrame126("Vampyre Slayer", 8144);
      client.getPlayerAssistant().sendFrame126("@str@I've talked to the bartender", 8147);
      client.getPlayerAssistant().sendFrame126("@str@I gave Doctor Harlow the beer", 8148);
      client.getPlayerAssistant().sendFrame126("@str@Doctor Harlow talked to me and", 8149);
      client.getPlayerAssistant().sendFrame126("@str@Gave me a stake and hammer.", 8150);
      ...
      client.getPlayerAssistant().sendFrame126("Vampyre Slayer", 8144);
      client.getPlayerAssistant().sendFrame126("@str@I've Talked to Morgan", 8148);
      client.getPlayerAssistant().sendFrame126("@red@     QUEST COMPLETE", 8150);
      client.getPlayerAssistant().sendFrame126("As a reward, I gained 4825 Attack Exp.", 8151);
