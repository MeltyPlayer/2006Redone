...
public class SheepShearer {
  ...
  public void showInformation() {
    ...
    if (client.sheepShear == 0) {
      ...
      client.getPlayerAssistant().sendFrame126("I can start this quest by speaking to Fred in", 8147);
      ...
      client.getPlayerAssistant().sendFrame126("Sheep Shearer", 8144);
      client.getPlayerAssistant().sendFrame126("@str@I've talked to fred", 8147);
      client.getPlayerAssistant().sendFrame126("I've agreed to get him some wool.", 8148);
      if (client.getItemAssistant().playerHasItem(1759, 20)) {
        client.getPlayerAssistant().sendFrame126("@str@Bal of Wool", 8149);
      } else {
        client.getPlayerAssistant().sendFrame126("@red@Ball of Wool", 8149);
      }
    } else if (client.sheepShear == 2) {
      client.getPlayerAssistant().sendFrame126("Sheep Shearer", 8144);
      client.getPlayerAssistant().sendFrame126("@str@I gave fred his wool", 8147);
      client.getPlayerAssistant().sendFrame126("@str@So he awarded me.", 8148);
      client.getPlayerAssistant().sendFrame126("@red@     QUEST COMPLETE", 8149);
      client.getPlayerAssistant().sendFrame126("As a reward, 60 coins.", 8150);
