	...
	public void showInformation() {
		...
		if (client.runeMist == 0) {
			...
			client.getPlayerAssistant()
					.sendFrame126("There are no minimum requirments.", 8150);
		} else if (client.runeMist == 1) {
			client.getPlayerAssistant().sendFrame126("Rune Mysteries", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I've talked to the duke", 8147);
			client.getPlayerAssistant().sendFrame126(
					"I should take the talisman to the Head Wizard.", 8148);
		} else if (client.runeMist == 2) {
			client.getPlayerAssistant().sendFrame126("Rune Mysteries", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I've talked to Sedridor", 8147);
			client.getPlayerAssistant()
					.sendFrame126("@str@I gave him the talisman", 8148);
			client.getPlayerAssistant()
					.sendFrame126("I should bring the notes to Aubury.", 8149);
		} else if (client.runeMist == 3) {
			client.getPlayerAssistant().sendFrame126("Rune Mysteries", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I've talked to Aubury.", 8147);
			client.getPlayerAssistant()
					.sendFrame126("@str@I gave him the notes", 8148);
			client.getPlayerAssistant()
					.sendFrame126("I should go back to the wizard tower", 8149);
		} else if (client.runeMist == 4) {
			client.getPlayerAssistant().sendFrame126("Rune Mysteries", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I talked to Sedridor", 8147);
			client.getPlayerAssistant()
					.sendFrame126("@str@I gave him his items.", 8148);
			client.getPlayerAssistant().sendFrame126("@red@     QUEST COMPLETE",
					8150);
			client.getPlayerAssistant()
					.sendFrame126("As a reward, I gained 1 Quest point", 8151);
			client.getPlayerAssistant().sendFrame126("And an air talisman.",
					8152);
		}
