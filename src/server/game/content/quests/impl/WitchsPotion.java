...
public class WitchsPotion {
  ...
  public void showInformation() {
    ...
    if (client.witchspot == 0) {
      ...
      client.getPlayerAssistant().sendFrame126("I can start this quest by speaking to Hetty", 8147);
      ...
      client.getPlayerAssistant().sendFrame126("Witch's Potion", 8144);
      client.getPlayerAssistant().sendFrame126("@str@I've talked to the Hetty", 8147);
      client.getPlayerAssistant().sendFrame126("I've agreed to get her the ingredients", 8148);
    } else if (client.witchspot == 2) {
      client.getPlayerAssistant().sendFrame126("Witch's Potion", 8144);
      client.getPlayerAssistant().sendFrame126("@str@I have all the ingredients", 8147);
      client.getPlayerAssistant().sendFrame126("I should talk to hetty.", 8148);
      client.getPlayerAssistant().sendFrame126("", 8149);
    } else if (client.witchspot == 3) {
      client.getPlayerAssistant().sendFrame126("Witch's Potion", 8144);
      client.getPlayerAssistant().sendFrame126("@str@I've Talked to Hetty", 8147);
      client.getPlayerAssistant().sendFrame126("@str@I drank from the Cauldron", 8148);
      client.getPlayerAssistant().sendFrame126("@red@     QUEST COMPLETE", 8150);
      client.getPlayerAssistant().sendFrame126("As a reward, I gained 325 Magic Exp.", 8151);
