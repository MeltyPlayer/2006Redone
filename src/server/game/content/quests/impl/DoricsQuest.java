	...
	public void showInformation() {
		...
		if (client.doricQuest == 0) {
			...
			client.getPlayerAssistant()
					.sendFrame126("Recommended Levels: 15 Mining", 8150);
		} else if (client.doricQuest == 1) {
			client.getPlayerAssistant().sendFrame126("Dorics Quest", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I've talked to the doric.", 8147);
			client.getPlayerAssistant().sendFrame126(
			...
			if (client.getItemAssistant().playerHasItem(440, 2)) {
				client.getPlayerAssistant().sendFrame126("@str@2 Iron ore",
						8151);
			} else {
				client.getPlayerAssistant().sendFrame126("@red@2 Iron ore",
						8151);
			}
		} else if (client.doricQuest == 2) {
			client.getPlayerAssistant().sendFrame126("Dorics Quest", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I talked to the doric.", 8147);
			client.getPlayerAssistant()
					.sendFrame126("@str@I gave the doric his items.", 8148);
			client.getPlayerAssistant()
					.sendFrame126("I should go speak to the doric.", 8149);
			...
			client.getPlayerAssistant().sendFrame126("And 1 Quest Point.",
					8152);
		}
