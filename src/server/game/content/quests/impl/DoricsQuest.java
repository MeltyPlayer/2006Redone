...
public class DoricsQuest {
  ...
  public void showInformation() {
    ...
    if (client.doricQuest == 0) {
      ...
      client.getPlayerAssistant().sendFrame126("I can start this quest by speaking to doric", 8147);
      client.getPlayerAssistant().sendFrame126("Northwest of falador.", 8148);
      client.getPlayerAssistant().sendFrame126("", 8149);
      client.getPlayerAssistant().sendFrame126("Recommended Levels: 15 Mining", 8150);
    } else if (client.doricQuest == 1) {
      client.getPlayerAssistant().sendFrame126("Dorics Quest", 8144);
      client.getPlayerAssistant().sendFrame126("@str@I've talked to the doric.", 8147);
      ...
      client.getPlayerAssistant().sendFrame126("Dorics Quest", 8144);
      client.getPlayerAssistant().sendFrame126("@str@I talked to the doric.", 8147);
      client.getPlayerAssistant().sendFrame126("@str@I gave the doric his items.", 8148);
      client.getPlayerAssistant().sendFrame126("I should go speak to the doric.", 8149);
      ...
      client.getPlayerAssistant().sendFrame126("As a reward, I gained 26000 Mining Exp", 8151);
