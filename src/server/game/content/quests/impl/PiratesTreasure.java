...
public class PiratesTreasure {
	...
	public void showInformation() {
		...
		client.getPlayerAssistant().sendFrame126("@dre@Pirate's Treasure",
				8144);
		...
		if (client.pirateTreasure == 0) {
			...
			client.getPlayerAssistant().sendFrame126("Pirate's Treasure", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I've talked to Redbeard.", 8147);
			client.getPlayerAssistant()
					.sendFrame126("He wants me to get him some rum", 8148);
		} else if (client.pirateTreasure == 2) {
			client.getPlayerAssistant().sendFrame126("Pirate's Treasure", 8144);
			client.getPlayerAssistant()
					.sendFrame126("@str@I talked to Redbeard.", 8147);
			client.getPlayerAssistant()
					.sendFrame126("@str@I found a way to get the rum", 8148);
			client.getPlayerAssistant().sendFrame126(
			...
			client.getPlayerAssistant().sendFrame126("@str@I gave him the rum",
					8149);
			client.getPlayerAssistant()
					.sendFrame126("@str@I looked in the chest", 8149);
			client.getPlayerAssistant().sendFrame126(
			...
			client.getPlayerAssistant()
					.sendFrame126("I should find the casket now", 8151);
			...
			client.getPlayerAssistant().sendFrame126("@red@     QUEST COMPLETE",
					8152);
			client.getPlayerAssistant()
					.sendFrame126("As a reward, I gained a casket.", 8153);
