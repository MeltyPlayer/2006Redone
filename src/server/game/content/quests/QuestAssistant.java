...
public class QuestAssistant {
  ...
  public static void sendStages(Client client) {
    ...
    if (client.romeojuliet == 0) {
      ...
      client.getPlayerAssistant().sendFrame126("@yel@Romeo and Juliet", 7343);
    } else if (client.romeojuliet >= 9) {
      client.getPlayerAssistant().sendFrame126("@gre@Romeo and Juliet", 7343);
    }
  ...
  public enum Quests {
    BLACK_KNIGHT(28164, "Black Knights' Fortress"), COOKS_ASSISTANT(28165, "Cook's Assistant"), DEMON_SLAYER(28166,
        "Demon Slayer"), DORICS_QUEST(28168, "Doric's Quest"), DRAGON_SLAYER(28215, "Dragon Slayer"), ERNEST(28171,
            "Ernest the Chicken"), GOBLIN(28170, "Goblin Diplomacy"), IMP_CATCHER(28172, "Imp Catcher"), KNIGHTS_SWORD(
                28178, "The Knight's Sword"), PIRATES_TREASURE(28173, "Pirates Treasure"), PRINCE_RESCUE(28174,
                    "Prince Ali Rescue"), RESTLESS_GHOST(28169, "Restless Ghost"), ROMEO_JULIET(28175,
                        "Romeo Juliet"), RUNE_MYSTERIES(28167, "Rune Mysteries"), SHEEP_SHEARER(28176,
                            "Sheep Shearer"), SHIELD_OF_ARRAV(28177, "Shield of Arrav"), VAMPYRE_SLAYER(28179,
                                "Vampyre Slayer"), WITCHS_POTION(28180, "Witchs Potion"), BETWEEN_A_ROCK(49228,
                                    "Between A Rock"), CHOMPY(2161, "Big Chompy Bird Hunting"), BIOHAZARD(28124,
                                        "Biohazard"), CABIN(68102, "Cabin Fever"), CLOCK(28185,
                                            "Clock Tower"), DEATH(32246, "Death Plateau"), CREATURE(47097,
                                                "Creature of Fenkenstrain"), DESERT_TREASURE(50052,
                                                    "Desert Treasure"), DRUDIC_RITUAL(28187,
                                                        "Drudic Ritual"), DWARF_CANNON(28188,
                                                            "Dwarf Cannon"), EADGARS_RUSE(33231,
                                                                "Eadgars Ruse"), DEVIOUS(61225,
                                                                    "Devious Minds"), DIGSITE(28186,
                                                                        "Digsite Quest"), ELEMENTAL(29035,
                                                                            "Elemental Workshop"), ENAKHRA(63021,
                                                                                "Enakhra's Lamet"), FAIRY1(27075,
                                                                                    "A Fairy Tale Pt. 1"), FAMILYCREST(
                                                                                        28189,
                                                                                        "Family Crest"), FEUD(50036,
      ...
      default:
        if (Quests.forButton(buttonId) != null) {
          client.getActionSender()
              .sendMessage("The quest " + Quests.forButton(buttonId).getName() + " is currently disabled.");
        }
        break;
    }
  }
