...
public class Balloons extends Objects {
  ...
  public Balloons(int id, int x, int y, int height, int face, int type, int ticks, int item, int amount) {
  ...
  public static Balloons getBalloon(int item, int amount) {
    return new Balloons(115 + r.nextInt(5), 2730 + r.nextInt(13), 3462 + r.nextInt(13), 0, 0, 10, 0, item, amount);
  }

  public static Balloons getEmpty() {
    return new Balloons(115 + r.nextInt(5), 2730 + r.nextInt(13), 3462 + r.nextInt(13), 0, 0, 10, 0, 0, 0);
  }
