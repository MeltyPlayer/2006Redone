...
public class FightCaves {
  ...
  public static final int TZ_KIH = 2627, TZ_KEK_SPAWN = 2738, TZ_KEK = 2630, TOK_XIL = 2631, YT_MEJKOT = 2741,
      KET_ZEK = 2743, TZTOK_JAD = 2745, YT_HURKOT = 2746;
  ...
  private final int[][] WAVES = { { TZ_KIH }, { TZ_KIH, TZ_KIH }, { TZ_KEK }, { TZ_KEK, TZ_KIH },
      ...
      { TOK_XIL, TZ_KEK }, { TOK_XIL, TZ_KEK, TZ_KIH }, { TOK_XIL, TZ_KEK, TZ_KIH, TZ_KIH },
      { TOK_XIL, TZ_KEK, TZ_KEK }, { TOK_XIL, TOK_XIL }, { YT_MEJKOT }, { YT_MEJKOT, TZ_KIH },
      { YT_MEJKOT, TZ_KIH, TZ_KIH }, { YT_MEJKOT, TZ_KEK }, { YT_MEJKOT, TZ_KEK, TZ_KIH },
      ...
      { YT_MEJKOT, TOK_XIL, TZ_KEK, TZ_KEK }, { YT_MEJKOT, TOK_XIL, TOK_XIL }, { YT_MEJKOT, YT_MEJKOT }, { KET_ZEK },
      { KET_ZEK, TZ_KIH }, { KET_ZEK, TZ_KIH, TZ_KIH }, { KET_ZEK, TZ_KEK }, { KET_ZEK, TZ_KEK, TZ_KIH },
      { KET_ZEK, TZ_KEK, TZ_KIH, TZ_KIH }, { KET_ZEK, TZ_KEK, TZ_KEK }, { KET_ZEK, TOK_XIL },
      { KET_ZEK, TOK_XIL, TZ_KIH }, { KET_ZEK, TOK_XIL, TZ_KIH, TZ_KIH }, { KET_ZEK, TOK_XIL, TZ_KEK },
      { KET_ZEK, TOK_XIL, TZ_KEK, TZ_KIH }, { KET_ZEK, TOK_XIL, TZ_KEK, TZ_KIH, TZ_KIH },
      { KET_ZEK, TOK_XIL, TZ_KEK, TZ_KEK }, { KET_ZEK, TOK_XIL, TOK_XIL }, { KET_ZEK, YT_MEJKOT },
      { KET_ZEK, YT_MEJKOT, TZ_KIH }, { KET_ZEK, YT_MEJKOT, TZ_KIH, TZ_KIH }, { KET_ZEK, YT_MEJKOT, TZ_KEK },
      { KET_ZEK, YT_MEJKOT, TZ_KEK, TZ_KIH }, { KET_ZEK, YT_MEJKOT, TZ_KEK, TZ_KIH, TZ_KIH },
      { KET_ZEK, YT_MEJKOT, TZ_KEK, TZ_KEK }, { KET_ZEK, YT_MEJKOT, TOK_XIL }, { KET_ZEK, YT_MEJKOT, TOK_XIL, TZ_KIH },
  ...
  public static void spawnHealers(Client player, int i, int amount) {
    if (player.spawnedHealers < 4) {
      ...
      for (int i1 = 0; i1 < amount; i1++) {
        NpcHandler.spawnNpc(player, YT_HURKOT, HEALER_COORDS[i1][0], HEALER_COORDS[i1][1], player.heightLevel, 0, hp,
            max, atk, def, false, false);
      }
  ...
  /**
   * Handles the correct tz-kih effect; prayer is drained by the formula: drain
   * = damage + 1
   * 
   * @param player
   *          The player
  ...
  /**
   * Checks if a tzhaar npc has been killed, if so then it checks if it needs to
   * do the tz-kek effect. If tzKek spawn has been killed twice or didn't need
   * to be killed it calls killedTzhaar.
   * 
   * @param i
   *          The npc.
   */
