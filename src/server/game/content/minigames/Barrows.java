...
public class Barrows {
  ...
  public int[][] spadeData = {
      /** X Y X1 Y1 toX toY */
      { 3553, 3301, 3561, 3294, 3578, 9706 }, { 3550, 3287, 3557, 3278, 3568, 9683 },
      { 3561, 3292, 3568, 3285, 3557, 9703 }, { 3570, 3302, 3579, 3293, 3556, 9718 },
      { 3571, 3285, 3582, 3278, 3534, 9704 }, { 3562, 3279, 3569, 3273, 3546, 9684 }, };
  ...
  public void spadeDigging() {
    if (c.inArea(spadeData[0][0], spadeData[0][1], spadeData[0][2], spadeData[0][3])) {
      ...
      NpcHandler.spawnNpc(c, 1217, c.absX + Misc.random(1), c.absY + Misc.random(1), c.heightLevel, 0, 10, 2, 5, 5,
          true, true);
  ...
  public boolean checkBarrows() {
    if (c.barrowsNpcs[2][1] == 2 || c.barrowsNpcs[3][1] == 2 || c.barrowsNpcs[1][1] == 2 || c.barrowsNpcs[5][1] == 2
  ...
  public void fixAllBarrows() {
    ...
    if (totalCost > 0)
      c.getItemAssistant().deleteItem(995, c.getItemAssistant().getItemSlot(995), totalCost);
  }
