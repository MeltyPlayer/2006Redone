...
public class MageArena {
  ...
  private final int[] shopItems = { 6908, 6910, 6912, 6914, 6916, 6918, 6920, 6922, 6924, 6889, 6926, 1391, 4695, 4696,
      4698, 4697, 4694, 4699, 564, 561, 560, 563, 565, 6891 };

  private final String[] interfaceText = { "Magic Training Arena Shop", "Telekinetic Pizazz Points",
      "Enchantment Pizazz Points", "Graveyard Pizazz Points", "Alchemist Pizazz Points" };
  ...
  public void openShop() {
    ...
    c.getPlayerAssistant().sendFrame126(Integer.toString(enchantPoints), 15956);
  ...
  public void sendMessage(int itemId) {
    c.getActionSender().sendMessage(ItemAssistant.getItemName(itemId) + " costs " + getGraveValue(itemId)
        + " Graveyard points, " + getAlchVal(itemId) + " Alchemy points,");
    c.getActionSender().sendMessage(
        "" + getEnchVal(itemId) + " Enchantment points, and " + getTelVal(itemId) + " Telekinetic points.");
  }
