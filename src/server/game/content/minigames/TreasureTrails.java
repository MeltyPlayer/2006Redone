...
public class TreasureTrails {
  ...
  public static int lowLevelReward[] = { 1077, 1125, 1165, 1195, 1297, 1367, 853, 7390, 7392, 7394, 7396, 7386, 7388,
      1099, 1135, 1065, 851 };
  public static int mediemLevelReward[] = { 1073, 1123, 1161, 1199, 1301, 1371, 857, 2577, 2579, 2487, 2493, 2499, 2631,
      855 };
  public static int highLevelReward[] = { 1079, 1093, 1113, 1127, 1147, 1163, 1185, 1201, 1275, 1303, 1319, 1333, 1359,
      1373, 2491, 2497, 2503, 861, 859, 2581, 2651, 1079, 1093, 1113, 1127, 1147, 1163, 1185, 1201, 1275, 1303, 1319,
      1333, 1359, 1373, 2491, 2497, 2503, 861, 859, 2581, 2651, };
    ...
    if (clueLevel == 0) {
      switch (chanceReward) {
        case 0:
          ...
          break;
        case 1:
          displayReward(c, lowLevelReward[Misc.random(16)], 1, lowLevelStacks[Misc.random(3)], 1 + Misc.random(150), -1,
              1);
          break;
        case 2:
      ...
      switch (chanceReward) {
        case 0:
          displayReward(c, mediemLevelReward[Misc.random(13)], 1, mediemLevelReward[Misc.random(13)], 1,
              mediumLevelStacks[Misc.random(4)], 1 + Misc.random(200));
          break;
        case 1:
          displayReward(c, mediemLevelReward[Misc.random(13)], 1, mediumLevelStacks[Misc.random(4)],
      ...
      switch (chanceReward) {
        case 0:
          displayReward(c, highLevelReward[Misc.random(52)], 1, highLevelReward[Misc.random(52)], 1,
              highLevelStacks[Misc.random(5)], 1 + Misc.random(350));
          break;
        case 1:
          displayReward(c, highLevelReward[Misc.random(52)], 1, highLevelStacks[Misc.random(5)], 1 + Misc.random(350),
              -1, 1);
          break;
        case 2:
