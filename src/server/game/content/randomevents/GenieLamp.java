...
public class GenieLamp {
  ...
  public static boolean spawnGenieNpc(Client c) {
    if (Misc.random(100) == 1 && !c.inWild()) {
      NpcHandler.spawnNpc(c, 409, c.absX, c.absY + 1, 0, 0, 0, 0, 0, 0, false, false);
      return true;
    }
    return false;
  }
  ...
  private static int[][] genieData = { { 10252, 0 }, { 11000, 1 }, { 10253, 2 }, { 11001, 3 }, { 10254, 4 },
      { 11002, 5 }, { 10255, 6 }, { 11011, 7 }, { 11013, 8 }, { 11014, 9 }, { 11010, 10 }, { 11012, 11 }, { 11006, 12 },
      { 11009, 13 }, { 11008, 14 }, { 11004, 15 }, { 11003, 16 }, { 11005, 17 }, { 47002, 18 }, { 54090, 19 },
      { 11007, 20 }, };
  public String statName[] = { "attack", "defence", "strength", "hitpoints", "range", "prayer", "magic", "cooking",
    ...
    for (int[] genie : genieData) {
      if (genie[0] == actionButtonId) {
        if (c.getItemAssistant().playerHasItem(GENIE_LAMP1, 1)) {
          ...
          break;
          /*
           * } else if (c.getItemAssistant().playerHasItem(GENIE_LAMP2, 1)) {
           * c.getItemAssistant().deleteItem(GENIE_LAMP2, 1); expAmount = 10 *
           * c.playerLevel[genie[1]];
           * c.getPlayerAssistant().addSkillXP(expAmount, genie[1]);
           * //c.getDH().sendStatement( //"You gained " + expAmount *
           * Config.SERVER_EXP_BONUS // + " experience."); c.nextChat = 0;
           * break;
           */
        }
      }
