...
public class SandwhichLady {
  ...
  public static void openSandwhichLady(Client player) {
    ...
    switch (randomMessage) {
      case 0:
        player.getPlayerAssistant().sendFrame126("Please select the pie.", 16145);
        itemType = 0;
        break;
      case 1:
        player.getPlayerAssistant().sendFrame126("Please select the kebab.", 16145);
        itemType = 1;
        break;
      case 2:
        player.getPlayerAssistant().sendFrame126("Please select the chocolate.", 16145);
        itemType = 2;
        break;
      case 3:
        player.getPlayerAssistant().sendFrame126("Please select the bagel.", 16145);
        itemType = 3;
        break;
      case 4:
        player.getPlayerAssistant().sendFrame126("Please select the triangle sandwich.", 16145);
        itemType = 4;
        break;
      case 5:
        player.getPlayerAssistant().sendFrame126("Please select the square sandwich.", 16145);
        itemType = 5;
        break;
      case 6:
        player.getPlayerAssistant().sendFrame126("Please select the bread.", 16145);
        itemType = 6;
        break;
    }
  }
