...
public final class Frog {
  ...
  public static void spawnBasedOnGender(Client client) {// ternary
    NpcHandler.spawnNpc(client, client.playerAppearance[0] == 1 ? 2474 : 2475, client.absX + Misc.random(1),
        client.absY + Misc.random(1), 0, 0, 0, 0, 0, 0, false, false);
  }
  ...
  public static void spawnFrogs(Client client) {
    for (int[] element : FROG_DATA) {
      NpcHandler.spawnNpc(client, element[0], client.absX + Misc.random(1), client.absY + Misc.random(1), 0, 0, 0, 0, 0,
          0, false, false);
    }
  }
}
