...
public class NpcCombat {
  ...
  public static void multiAttackDamage(int i) {
    ...
    for (Player player : PlayerHandler.players) {
      if (player != null) {
        ...
        if (player.goodDistance(c.absX, c.absY, NpcHandler.npcs[i].absX, NpcHandler.npcs[i].absY, 15)) {
          if (NpcHandler.npcs[i].attackType == 2) {
            ...
            if (!c.getPrayer().prayerActive[17]) {
              int dam = Misc.random(max);
              if (Misc.random(500) + 200 > Misc.random(c.getCombatAssistant().calculateRangeDefence())) {
                c.dealDamage(dam);
                c.handleHitMask(dam);
              } else {
                c.dealDamage(0);
    ...
    for (Player player : PlayerHandler.players) {
      if (player != null) {
        ...
        if (player.goodDistance(c.absX, c.absY, NpcHandler.npcs[i].absX, NpcHandler.npcs[i].absY, 15)) {
          ...
          int offX = (nY - pY) * -1;
          int offY = (nX - pX) * -1;
          c.getPlayerAssistant().createPlayersProjectile(nX, nY, offX, offY, 50, NpcHandler.getProjectileSpeed(i),
  ...
  public static void attackPlayer(Client c, int i) {
    if (NpcHandler.npcs[i] != null) {
      ...
      if (NpcHandler.npcs[i].npcType == 1532 || NpcHandler.npcs[i].npcType == 1534 || NpcHandler.npcs[i].npcType == 6145
          || NpcHandler.npcs[i].npcType == 6144 || NpcHandler.npcs[i].npcType == 6143
          || NpcHandler.npcs[i].npcType == 6142 || NpcHandler.npcs[i].npcType == 752) {
        return;
      }
      ...
      if (!NpcData.goodDistanceNpc(NpcHandler.npcs[i].npcId, c.getX(), c.getY(),
          NpcData.distanceRequired(NpcHandler.npcs[i].npcId))
          || NpcData.inNpc(NpcHandler.npcs[i].npcId, c.getX(), c.getY())) {
        return;
      }
  ...
  public static void loadSpell(Client c, int i) {
    if (NpcHandler.npcs[i].npcType > 2462 && NpcHandler.npcs[i].npcType < 2469
        || NpcHandler.npcs[i].npcType > 3751 && NpcHandler.npcs[i].npcType < 3762) {
    ...
    if (NpcHandler.npcs[i] != null) {
      ...
      if (c.respawnTimer <= 0) {
        ...
        if (NpcHandler.npcs[i].attackType == 0) {
          ...
          if (10 + Misc.random(c.getCombatAssistant().calcDef()) > Misc.random(NpcHandler.npcs[i].attack)) {
            damage = 0;
          }
        ...
        if (NpcHandler.npcs[i].attackType == 1) { // range
          damage = Misc.random(NpcHandler.npcs[i].maxHit);
          if (10 + Misc.random(c.getCombatAssistant().calculateRangeDefence()) > Misc
