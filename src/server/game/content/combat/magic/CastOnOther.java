...
public class CastOnOther extends CastRequirements {
  ...
  public static void teleOtherDistance(Client c, int type, int i) {
    ...
    int[][] data = { { 74, SOUL, LAW, EARTH, 1, 1, 1 }, { 82, SOUL, LAW, WATER, 1, 1, 1 },
        { 90, SOUL, LAW, -1, 2, 1, -1 }, };
    if (!hasRequiredLevel(c, data[type][0])) {
      c.getActionSender().sendMessage("You need to have a magic level of " + data[type][0] + " to cast this spell.");
      return;
    }
