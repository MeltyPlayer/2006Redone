...
public class MagicTeleports {
  ...
  public static final int AIR_RUNE = 556, FIRE_RUNE = 554, WATER_RUNE = 555, EARTH_RUNE = 557, LAW_RUNE = 563,
      BLOOD_RUNE = 565, SOUL_RUNE = 566, BANANA = 1963;
  ...
  public static void paddewwaTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
          || !player.getItemAssistant().playerHasItem(FIRE_RUNE, 1) && hasRuneStaff(player, FIRE_RUNE) == false
          || !player.getItemAssistant().playerHasItem(FIRE_RUNE, 1) && hasRuneStaff(player, AIR_RUNE) == false) {
  ...
  public static void senntisenTeleport(Client player) {
    ...
    player.getPlayerAssistant().startTeleport(SENNTISTEN_X + Misc.random(1), SENNTISTEN_Y - Misc.random(1), 0,
        "ancient");
    player.lastCast = System.currentTimeMillis();
  ...
  public static void kharyllTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
          || !player.getItemAssistant().playerHasItem(BLOOD_RUNE, 1)) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
    }
  ...
  public static void lassarTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
          || !player.getItemAssistant().playerHasItem(WATER_RUNE, 4) && hasRuneStaff(player, WATER_RUNE) == false) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
    }
  ...
  public static void dareeyakTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
          || !player.getItemAssistant().playerHasItem(FIRE_RUNE, 3) && hasRuneStaff(player, FIRE_RUNE) == false
          || !player.getItemAssistant().playerHasItem(AIR_RUNE, 2) && hasRuneStaff(player, AIR_RUNE) == false) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
    }
    ...
    player.getPlayerAssistant().startTeleport(DAREEYAK_X + Misc.random(1), DAREEYAK_Y - Misc.random(1), 0, "ancient");
    player.lastCast = System.currentTimeMillis();
  ...
  public static void carrallangarTeleport(Client player) {
    ...
    player.getItemAssistant().deleteItem2(LAW_RUNE, 2);
    player.getPlayerAssistant().startTeleport(CARRALLANGAR_X + Misc.random(2), CARRALLANGAR_Y - Misc.random(2), 0,
        "ancient");
    player.lastCast = System.currentTimeMillis();
  ...
  public static void ghorrockTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
          || !player.getItemAssistant().playerHasItem(WATER_RUNE, 8) && hasRuneStaff(player, WATER_RUNE) == false) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
    }
    ...
    player.getPlayerAssistant().startTeleport(GHORROCK_X + Misc.random(3), GHORROCK_Y - Misc.random(3), 0, "ancient");
    player.lastCast = System.currentTimeMillis();
  ...
  public static void varrockTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 1)
          || !player.getItemAssistant().playerHasItem(FIRE_RUNE, 1) && hasRuneStaff(player, FIRE_RUNE) == false
          || !player.getItemAssistant().playerHasItem(AIR_RUNE, 3) && hasRuneStaff(player, AIR_RUNE) == false) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
    }
  ...
  public static void lumbridgeTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 1)
          || !player.getItemAssistant().playerHasItem(EARTH_RUNE, 1) && hasRuneStaff(player, EARTH_RUNE) == false
          || !player.getItemAssistant().playerHasItem(AIR_RUNE, 3) && hasRuneStaff(player, AIR_RUNE) == false) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
  ...
  public static void faladorTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 1)
          || !player.getItemAssistant().playerHasItem(WATER_RUNE, 1) && hasRuneStaff(player, WATER_RUNE) == false
          || !player.getItemAssistant().playerHasItem(AIR_RUNE, 3) && hasRuneStaff(player, AIR_RUNE) == false) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
  ...
  public static void camelotTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 1)
          || !player.getItemAssistant().playerHasItem(AIR_RUNE, 5) && hasRuneStaff(player, AIR_RUNE) == false) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
    }
  ...
  public static void ardougneTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
          || !player.getItemAssistant().playerHasItem(WATER_RUNE, 2) && hasRuneStaff(player, WATER_RUNE) == false) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
    }
    ...
    player.getPlayerAssistant().startTeleport(ARDOUGNE_X + Misc.random(4), ARDOUGNE_Y - Misc.random(4), 0, "modern");
    player.lastCast = System.currentTimeMillis();
  ...
  public static void watchTowerTeleport(Client player) {
    ...
    RandomEventHandler.addRandom(player);
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(EARTH_RUNE, 2) && hasRuneStaff(player, EARTH_RUNE) == false
          || !player.getItemAssistant().playerHasItem(LAW_RUNE, 2)) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
    ...
    if (MAGIC_LEVEL_REQUIRED) {
      if (player.playerLevel[player.playerMagic] < 58) {
        player.getActionSender().sendMessage("You need a magic level of 58 to cast this spell.");
        return;
      }
    }
    if (hasRuneStaff(player, EARTH_RUNE) == false) {
  ...
  public static void trollhiemTeleport(Client player) {
    ...
    RandomEventHandler.addRandom(player);
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(FIRE_RUNE, 2) && hasRuneStaff(player, FIRE_RUNE) == false
          || !player.getItemAssistant().playerHasItem(LAW_RUNE, 2)) {
        player.getActionSender().sendMessage("You don't have the required runes to cast this spell.");
        return;
      }
    ...
    player.getItemAssistant().deleteItem2(LAW_RUNE, 2);
    player.getPlayerAssistant().startTeleport(2892 + Misc.random(2), 3679 - Misc.random(2), 0, "modern");
    player.lastCast = System.currentTimeMillis();
    player.getPlayerAssistant().addSkillXP(68, player.playerMagic);
  }
  ...
  public static void apeAtollTeleport(Client player) {
    ...
    if (RUNES_REQUIRED) {
      if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
          || !player.getItemAssistant().playerHasItem(FIRE_RUNE, 2) && hasRuneStaff(player, FIRE_RUNE) == false
          || !player.getItemAssistant().playerHasItem(WATER_RUNE, 2) && hasRuneStaff(player, WATER_RUNE) == false
    ...
    if (player.questPoints < QuestAssistant.MAXIMUM_QUESTPOINTS) {
      player.getActionSender()
          .sendMessage("You need " + QuestAssistant.MAXIMUM_QUESTPOINTS + " quest points to teleport here.");
      return;
    }
    if (MAGIC_LEVEL_REQUIRED) {
