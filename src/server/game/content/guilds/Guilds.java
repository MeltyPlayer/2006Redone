  ...
  public static void movePlayer(Client c, int objectId) {
    switch (objectId) {
      ...
      case 2391:
        ...
        break;
      default:
        c.getActionSender().sendMessage("You can't access this guild from here.");
        break;
    }
  }
      ...
      case 1805: // Champions Guild
        if (c.questPoints < QuestAssistant.MAXIMUM_QUESTPOINTS) {
          c.getDialogueHandler()
              .sendStatement("You need " + QuestAssistant.MAXIMUM_QUESTPOINTS + " quest points to enter this guild!");
          c.nextChat = 0;
          return false;
        }
        break;
