...
public class RangersGuild {
  ...
  public final String MISSED = "Missed!", BLACK = "Hit Black!", YELLOW = "Hit Yellow!", BLUE = "Hit Blue!",
      RED = "Hit Red!", BULLSEYE = "Bulls-Eye";
  ...
  public void exchangePoints() {
    if (arrowsLeft == 0 && playerScore > 0) {
      if (c.getItemAssistant().freeSlots() > 0) {
        ...
        c.getDialogueHandler().sendNpcChat2("Well done. Your score is : " + playerScore + ".",
            "You have earned " + ticketsAmt + " Archery tickets.", c.talkingNpc, "Tutor");
        playerScore = 0;
        c.nextChat = 0;
      } else {
  ...
  public void howAmIDoing() {
    if (playerScore == 0) {
      c.getDialogueHandler().sendNpcChat2("You haven't started yet. Stand behind the hay bales and",
          "shoot those arrows at the targets.", c.talkingNpc, "Tutor");
      c.nextChat = 0;
    } else {
      c.getDialogueHandler().sendNpcChat2("Your score is : " + playerScore, "Your doing very well!", c.talkingNpc,
          "Tutor");
      c.nextChat = 0;
    }
  }
