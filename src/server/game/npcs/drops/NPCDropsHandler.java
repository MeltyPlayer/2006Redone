...
public class NPCDropsHandler {
  ...
  ALWAYS = 0, COINSRATE = 3, CHICKEN_RATE = 75 / 100, COMMON = 2 + r(48), UNCOMMON = 51 + r(49), RARE = 101 + r(411),
      VERY_RARE = 513;
  ...
  public static final int[][] NPC_DROPS(String npc, int NPCId) {
    ...
    } else if (npc.equals("aberrant_spectre") || npc.equals("aberrant_specter") || npc.equals("Aberant_specter")) {
    ...
    } else if (npc.equals("lesser_demon") || npc.equals("Lesser_demon") || npc.equals("lesserdemon")) {
