...
import server.game.shops.Shops;
...
public class NpcActions {
    ...
    switch (npcType) {
      ...
      case 536:
        if (c.questPoints >= QuestAssistant.MAXIMUM_QUESTPOINTS) {
          ...
          c.getActionSender()
              .sendMessage("You need " + QuestAssistant.MAXIMUM_QUESTPOINTS + " quest points to open this shop.");
        }
        break;
      ...
      case 2270:
        ...
        } else if (c.playerLevel[c.playerThieving] > 49 && c.playerLevel[c.playerAgility] > 49) {
          c.getShopAssistant().openShop(118);
        } else {
          c.getActionSender().sendMessage("You don't have the required skills to open this shop");
        }
        break;
      ...
      case 944: // Combat deud
        ...
        } else if (c.tutorialProgress == 23 && !c.getItemAssistant().playerHasItem(1171)
            && !c.getItemAssistant().playerHasItem(1277)) {
          c.getDialogueHandler().sendDialogues(3072, npcType);
        } else if (c.getItemAssistant().playerHasItem(1171) && c.getItemAssistant().playerHasItem(1277)
            && c.tutorialProgress == 23) {
          c.getActionSender().sendMessage("I already gave you a sword and shield.");
          c.nextChat = 0;
          c.getDialogueHandler().chatboxText(c, "In your worn inventory panel, right click on the dagger and",
      ...
      case 378:
        if (c.getItemAssistant().playerHasItem(995, 30)) {
          ...
          c.getDialogueHandler().sendStatement("You need 30 coins to travel on this ship.");
        }
        break;
      ...
      case 375:
        if (c.pirateTreasure == 0) {
          ...
          c.getDialogueHandler().sendStatement("Talk to lucas and help him transport the bannanas.");
          ...
          c.getActionSender().sendMessage("Arr! Thanks for me helping me.");
        }
        break;
      ...
      case 307:
        if (c.witchspot == 0) {
          ...
          c.getDialogueHandler().sendNpcChat1("Welcome back, thank you again for helping me.", c.talkingNpc, "Hetty");
        }
        break;
      ...
      case 759:
        if (c.getItemAssistant().playerHasItem(1927, 1) && c.gertCat == 2) {
          ...
          c.gertCat = 3;
        } else if (c.getItemAssistant().playerHasItem(1552, 1) && c.gertCat == 3) {
          ...
          c.gertCat = 5;
        } else if (c.getItemAssistant().playerHasItem(1554, 1) && c.gertCat == 6) {
      ...
      case 780:
        if (c.playerLevel[10] < 4) {
          c.getDialogueHandler().sendStatement("You don't have the requirements to do this quest.");
          return;
        }
        if (c.gertCat == 0) {
          ...
          c.getDialogueHandler().sendStatement("She has nothing to say to you.");
        }
        break;
      ...
      case 639:
        ...
        if (c.romeojuliet == 2 && c.getItemAssistant().playerHasItem(755, 1)) {
          c.getDialogueHandler().sendDialogues(415, npcType);
        }
        if (c.romeojuliet == 2 && !c.getItemAssistant().playerHasItem(755, 1)) {
      ...
      case 276:
        ...
        if (c.romeojuliet == 6 && c.getItemAssistant().playerHasItem(300, 1)
            && c.getItemAssistant().playerHasItem(227, 1) && c.getItemAssistant().playerHasItem(526, 1)) {
      ...
      case 300:
        if (c.runeMist == 1) {
          ...
          c.getActionSender().sendMessage("He has nothing to say to you.");
        }
        break;
      ...
      case 706:
        ...
        if (c.impsC == 1 && c.getItemAssistant().playerHasItem(1470, 1) && c.getItemAssistant().playerHasItem(1472, 1)
            && c.getItemAssistant().playerHasItem(1474, 1) && c.getItemAssistant().playerHasItem(1476, 1)) {
      ...
      case 379:
        if (c.bananas == 0 || c.luthas == false) {
          ...
          c.getActionSender().sendMessage("You may now talk to Luthas your bananna task has been reset.");
          c.luthas = false;
          c.bananas = 0;
        }
        break;
      ...
      case 8689:
        if (System.currentTimeMillis() - c.buryDelay > 1500) {
          if (c.getItemAssistant().playerHasItem(1925, 1)) {
            ...
            c.getActionSender().sendMessage("You need a bucket to milk a cow!");
          }
        }
        break;

      case 3789:
        c.getActionSender().sendMessage(new StringBuilder().append("You currently have ").append(c.pcPoints)
       ...
       * c.getShops().openShop(10); break; case 581: c.getShops().openShop(11);
       * break; case 548: c.getShops().openShop(12); break; case 554:
       * c.getShops().openShop(13); break; case 601: c.getShops().openShop(14);
       * break; case 1301: c.getShops().openShop(15); break; case 1039:
       * c.getShops().openShop(16); break; case 2353: c.getShops().openShop(17);
       * break; case 3166: c.getShops().openShop(18); break; case 2161:
       * c.getShops().openShop(19); break; case 2162: c.getShops().openShop(20);
       * break; case 600: c.getShops().openShop(21); break; case 603:
       * c.getShops().openShop(22); break; case 593: c.getShops().openShop(23);
       * break; case 545: c.getShops().openShop(24); break; case 585:
       * c.getShops().openShop(25); break; case 2305: c.getShops().openShop(26);
       * break; case 2307: c.getShops().openShop(27); break; case 2304:
       * c.getShops().openShop(28); break; case 2306: c.getShops().openShop(29);
       * break; case 517: c.getShops().openShop(30); break; case 558:
       * c.getShops().openShop(31); break; case 576: c.getShops().openShop(32);
       * break; case 1369: c.getShops().openShop(33); break; case 1038:
       * c.getShops().openShop(35); break; case 1433: c.getShops().openShop(36);
       * break; case 584: c.getShops().openShop(37); break; case 540:
       * c.getShops().openShop(38); break; case 2157: c.getShops().openShop(39);
       * break; case 538: c.getShops().openShop(40); break; case 1303:
       * c.getShops().openShop(41); break; case 578: c.getShops().openShop(42);
       * break; case 587: c.getShops().openShop(43); break; case 1398:
       * c.getShops().openShop(44); break; case 556: c.getShops().openShop(45);
       * break; case 1865: c.getShops().openShop(46); break; case 543:
       * c.getShops().openShop(47); break; case 2198: c.getShops().openShop(48);
       * break; case 580: c.getShops().openShop(49); break; case 1862:
       * c.getShops().openShop(50); break; case 583: c.getShops().openShop(51);
       * break; case 553: c.getShops().openShop(52); break; case 461:
       * c.getShops().openShop(53); break; case 903: c.getShops().openShop(54);
       * break; case 1435: c.getShops().openShop(56); break; case 3800:
       * c.getShops().openShop(57); break; case 2623: c.getShops().openShop(58);
       * break; case 594: c.getShops().openShop(59); break; case 579:
       * c.getShops().openShop(60); break; case 2160: c.getShops().openShop(61);
       * break; case 2191: c.getShops().openShop(61); break; case 589:
       * c.getShops().openShop(62); break; case 549: c.getShops().openShop(63);
       * break; case 542: c.getShops().openShop(64); break; case 3038:
       * c.getShops().openShop(65); break; case 544: c.getShops().openShop(66);
       * break; case 541: c.getShops().openShop(67); break; case 1434:
       * c.getShops().openShop(68); break; case 577: c.getShops().openShop(69);
       * break; case 539: c.getShops().openShop(70); break; case 1980:
       * c.getShops().openShop(71); break; case 546: c.getShops().openShop(72);
       * break; case 382: c.getShops().openShop(73); break; case 3541:
       * c.getShops().openShop(74); break; case 520: c.getShops().openShop(75);
       * break; case 1436: c.getShops().openShop(76); break; case 590:
       * c.getShops().openShop(77); break; case 971: c.getShops().openShop(78);
       * break; case 1917: c.getShops().openShop(79); break; case 1040:
       * c.getShops().openShop(80); break; case 563: c.getShops().openShop(81);
       * break; case 522: c.getShops().openShop(82); break; case 524:
       * c.getShops().openShop(83); break; case 526: c.getShops().openShop(84);
       * break; case 2154: c.getShops().openShop(85); break; case 1334:
       * c.getShops().openShop(86); break; case 2552: c.getShops().openShop(87);
       * break; case 528: c.getShops().openShop(88); break; case 1254:
       * c.getShops().openShop(89); break; case 2086: c.getShops().openShop(90);
       * break; case 3824: c.getShops().openShop(91); break; case 1866:
       * c.getShops().openShop(92); break; case 1699: c.getShops().openShop(93);
       * break; case 1282: c.getShops().openShop(94); break; case 530:
       * c.getShops().openShop(95); break; case 516: c.getShops().openShop(96);
       * break; case 560: c.getShops().openShop(97); break; case 471:
       * c.getShops().openShop(98); break; case 1208: c.getShops().openShop(99);
       * break; case 532: c.getShops().openShop(100); break; case 555:
  ...
  public void secondClickNpc(int npcType) {
    ...
    if (npcType >= 761 && npcType <= 773 || npcType > 3504 && npcType < 3508 && npcType != 767) {
    ...
    switch (npcType) {
      ...
      case 536:
        if (c.questPoints >= QuestAssistant.MAXIMUM_QUESTPOINTS) {
          ...
          c.getActionSender().sendMessage("You need 19 quest points to open this shop.");
        }
        break;
      ...
      case 1042:
        if (c.getItemAssistant().playerHasItem(995, 5)) {
          ...
          c.getDialogueHandler().sendNpcChat1("You need 5 coins to buy a moonlight mead.", c.talkingNpc, "Roavar");
          c.nextChat = 0;
        }
        break;
  ...
  public void thirdClickNpc(int npcType) {
    ...
    switch (npcType) {
      ...
      case 836:
        if (c.getItemAssistant().playerHasItem(995, 5)) {
          c.getActionSender().sendMessage("You buy a shantay pass quickly.");
          c.getItemAssistant().deleteItem2(995, 5);
          c.getItemAssistant().addItem(1854, 1);
        } else {
          c.getActionSender().sendMessage("You need 5 coins to buy a pass.");
        }
        break;
      case 553:
        if (c.runeMist < 4) {
