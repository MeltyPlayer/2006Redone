...
public class UseItem {
    ...
    switch (objectID) {
      ...
      case 2782:
        if (c.doricQuest >= 3) {
          ...
          c.getActionSender().sendMessage("You need to beat dorics quest to use his anvils");
        }
        break;
      case 879:
      case 12279:
      ...
      default:
        if (c.playerRights == 3) {
          Misc.println("Player At Object id: " + objectID + " objectX: " + objectX + " objectY: " + objectY
              + " with Item id: " + itemId);
        }
        break;
    }
  ...
  public static void ItemonItem(Client c, int itemUsed, int useWith) {
    ...
    if (itemUsed == 771 && useWith == 946 && c.playerLevel[c.playerCrafting] > 30) {
      c.getItemAssistant().deleteItem(771, 1);
      c.getItemAssistant().addItem(772, 1);
    } else if (c.playerLevel[c.playerCrafting] < 31 && itemUsed == 771 && useWith == 946) {
      c.getActionSender().sendMessage("You need 31 crafting to make this.");
    }
    if (itemUsed == 946 && useWith == 771 && c.playerLevel[c.playerCrafting] > 30) {
      c.getItemAssistant().deleteItem(771, 1);
      c.getItemAssistant().addItem(772, 1);
    } else if (c.playerLevel[c.playerCrafting] < 31 && itemUsed == 946 && useWith == 771) {
      c.getActionSender().sendMessage("You need 31 crafting to make this.");
    }
    if (useWith == 7051 && itemUsed == 590 || itemUsed == 590 && useWith == 7051) {
    ...
    if (itemUsed == 38 && useWith == 590 || useWith == 38 && itemUsed == 590) {//
      c.getItemAssistant().addItem(32, 1);
      c.getItemAssistant().deleteItem2(38, 1);
    }
    if (itemUsed == 36 && useWith == 590 || useWith == 36 && itemUsed == 590) {
      c.getItemAssistant().addItem(33, 1);
      c.getItemAssistant().deleteItem2(36, 1);
    }
    if (itemUsed == 596 && useWith == 590 || useWith == 596 && itemUsed == 590) {
      c.getItemAssistant().addItem(594, 1);
      c.getItemAssistant().deleteItem2(596, 1);
    }
    if (itemUsed == 4537 && useWith == 590 || useWith == 4537 && itemUsed == 590) {
      c.getItemAssistant().addItem(4539, 1);
      c.getItemAssistant().deleteItem2(4537, 1);
    }
    if (itemUsed == 4548 && useWith == 590 || useWith == 4548 && itemUsed == 590) {
      c.getItemAssistant().addItem(4550, 1);
      c.getItemAssistant().deleteItem2(4548, 1);
    }
    if (itemUsed == 1095 && useWith == 2370
        || itemUsed == 2370 && useWith == 1095 && c.playerLevel[c.playerCrafting] > 43) {// chaps
    ...
    } else if (itemUsed == 1095 && useWith == 2370
        || itemUsed == 2370 && useWith == 1095 && c.playerLevel[c.playerCrafting] < 44) {
    ...
    if (itemUsed == 1129 && useWith == 2370
        || itemUsed == 2370 && useWith == 1129 && c.playerLevel[c.playerCrafting] > 40) {// body
      c.getItemAssistant().deleteItem2(2370, 1);
    ...
    } else if (itemUsed == 1129 && useWith == 2370
        || itemUsed == 2370 && useWith == 1129 && c.playerLevel[c.playerCrafting] < 41) {
    ...
    if (itemUsed == 1987 && useWith == 1937 || itemUsed == 1937 && useWith == 1987) {
      if (c.playerLevel[c.playerCooking] >= 35) {
        ...
        c.getActionSender().sendMessage("You need grapes and a jug of water to make wine.");
      }
    }
