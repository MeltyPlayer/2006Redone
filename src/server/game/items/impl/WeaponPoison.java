...
public class WeaponPoison {
	 ...
	 */
	private enum Weapon {
	BRONZE_DAGGER(1205, new int[][] { { 5940, 5688 }, { 5937, 5670 }, { 187,
			1221 } }), IRON_DAGGER(1203, new int[][] { { 5940, 5686 },
					{ 5937, 5668 }, { 187, 1219 } }), STEEL_DAGGER(
							1207,
							new int[][] { { 5940, 5690 }, { 5937, 5672 }, { 187,
									1223 } }), BLACK_DAGGER(1217, new int[][] {
											{ 5940, 5700 }, { 5937, 5682 },
											{ 187, 1233 } }), MITHRIL_DAGGER(
													1209,
													new int[][] {
															{ 5940, 5692 },
															{ 5937, 5674 },
															{ 187, 1225 } }), ADAMANT_DAGGER(
																	1211,
																	new int[][] {
																			{ 5940, 5694 },
																			{ 5937, 5676 },
																			{ 187, 1227 } }), RUNE_DAGGER(
																					1213,
																					new int[][] {
																							{ 5940, 5696 },
																							{ 5937, 5678 },
																							{ 187, 1229 } }), DRAGON_DAGGER(
																									1215,
																									new int[][] {
																											{ 5940, 5698 },
																											{ 5937, 5680 },
																											{ 187, 1231 } }), BRONZE_DART(
																													806,
																													new int[][] {
																															{ 5940, 5635 },
																															{ 5937, 5628 },
																																																																									...
																																																																									new int[][] {
																																																																											...
																																																																											{ 187, 1259 } }), RUNE_SPEAR(
																																																																													...
																																																																													new int[][] {
																																																																															{ 5940, 5728 },
																																																																															{ 5937, 5714 },
																																																																															{ 187, 1261 } }), DRAGON_SPEAR(
																																																																																	1249,
																																																																																	new int[][] {
																																																																																			{ 5940, 5730 },
																																																																																			{ 5937, 5716 },
																																																																																			{ 187, 1263 } }), BRONZE_JAVELIN(
																																																																																					825,
																																																																																					new int[][] {
																																																																																							{ 5940, 5648 },
																																																																																							{ 5937, 5642 },
																																																																																							{ 187, 831 } }), IRON_JAVELIN(
																																																																																									826,
																																																																																									new int[][] {
																																																																																											{ 5940, 5648 },
																																																																																											{ 5937, 5643 },
																																																																																											{ 187, 832 } }), STEEL_JAVELIN(
																																																																																													827,
																																																																																													new int[][] {
																																																																																															{ 5940, 5648 },
																																																																																															{ 5937, 5644 },
																																																																																															{ 187, 833 } }), MITHRIL_JAVELIN(
																																																																																																	828,
																																																																																																	new int[][] {
																																																																																																			{ 5940, 5648 },
																																																																																																			{ 5937, 5645 },
																																																																																																			{ 187, 834 } }), ADAMANT_JAVELIN(
																																																																																																					829,
																																																																																																					new int[][] {
																																																																																																							{ 5940, 5648 },
																																																																																																							{ 5937, 5646 },
																																																																																																							{ 187, 835 } }), RUNE_JAVELIN(
																																																																																																									830,
																																																																																																									new int[][] {
																																																																																																											{ 5940, 5648 },
																																																																																																											{ 5937, 5647 },
																																																																																																											{ 187, 836 } }), BRONZE_ARROW(
																																																																																																													882,
																																																																																																													new int[][] {
																																																																																																															{ 5940, 5622 },
																																																																																																															{ 5937, 5616 },
																																																																																																																	...
																																																																																																																	new int[][] {
																																																																																																																			...
																																																																																																																			{ 187, 885 } }), STEEL_ARROW(
																																																																																																																					...
																																																																																																																					new int[][] {
																																																																																																																							{ 5940, 5624 },
																																																																																																																							{ 5937, 5618 },
																																																																																																																							{ 187, 887 } }), MITHRIL_ARROW(
																																																																																																																									888,
																																																																																																																									new int[][] {
																																																																																																																											{ 5940, 5625 },
																																																																																																																											{ 5937, 5619 },
																																																																																																																											{ 187, 889 } }), ADAMANT_ARROW(
																																																																																																																													890,
																																																																																																																													new int[][] {
																																																																																																																															{ 5940, 5626 },
																																																																																																																															{ 5937, 5620 },
																																																																																																																																													...
																																																																																																																																													new int[][] {
																																																																																																																																															...
																																																																																																																																															{ 187, 872 } }), BLACK_KNIFE(
																																																																																																																																																	...
																																																																																																																																																	new int[][] {
																																																																																																																																																			{ 5940, 5665 },
																																																																																																																																																			{ 5937, 5658 },
																																																																																																																																																			{ 187, 873 } }), MITHRIL_KNIFE(
																																																																																																																																																					866,
																																																																																																																																																					new int[][] {
																																																																																																																																																							{ 5940, 5664 },
																																																																																																																																																							{ 5937, 5657 },
																																																																																																																																																							{ 187, 874 } }), ADAMANT_KNIFE(
																																																																																																																																																									867,
																																																																																																																																																									new int[][] {
																																																																																																																																																											{ 5940, 5666 },
																																																																																																																																																											{ 5937, 5659 },
		...
		if (weapon != null) {
			for (int element[] : weapon.getNewItemId()) {
				if (itemUse == element[0]) {
					...
					player.getItemAssistant().deleteItem(element[0],
							player.getItemAssistant().getItemSlot(element[0]),
							1);
					player.getItemAssistant().deleteItem(weapon.getItemId(),
							player.getItemAssistant()
									.getItemSlot(weapon.getItemId()),
							1);
