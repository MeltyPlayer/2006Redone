...
public class WeaponPoison {
   ...
   * id, the type of poison used on the weapon and the new poisoned weapon that
   * will be obtained.
   */
  private enum Weapon {
  BRONZE_DAGGER(1205, new int[][] { { 5940, 5688 }, { 5937, 5670 }, { 187, 1221 } }), IRON_DAGGER(1203, new int[][] { {
      5940, 5686 }, { 5937, 5668 },
      { 187, 1219 } }), STEEL_DAGGER(1207, new int[][] { { 5940, 5690 }, { 5937, 5672 }, { 187, 1223 } }), BLACK_DAGGER(
          1217, new int[][] { { 5940, 5700 }, { 5937, 5682 }, { 187, 1233 } }), MITHRIL_DAGGER(1209,
              new int[][] { { 5940, 5692 }, { 5937, 5674 }, { 187, 1225 } }), ADAMANT_DAGGER(1211,
                  new int[][] { { 5940, 5694 }, { 5937, 5676 }, { 187, 1227 } }), RUNE_DAGGER(1213,
                      new int[][] { { 5940, 5696 }, { 5937, 5678 }, { 187, 1229 } }), DRAGON_DAGGER(1215,
                          new int[][] { { 5940, 5698 }, { 5937, 5680 }, { 187, 1231 } }), BRONZE_DART(806,
                              new int[][] { { 5940, 5635 }, { 5937, 5628 }, { 187, 812 } }), IRON_DART(807,
                                  new int[][] { { 5940, 5636 }, { 5937, 5629 }, { 187, 813 } }), STEEL_DART(808,
                                      new int[][] { { 5940, 5637 }, { 5937, 5630 }, { 187, 814 } }), BLACK_DART(3093,
                                          new int[][] { { 5940, 5638 }, { 5937, 5631 }, { 187, 815 } }), MITHRIL_DART(
                                              809,
                                              new int[][] { { 5940, 5639 }, { 5937, 5632 },
                                                  { 187, 816 } }), ADAMANT_DART(
                                                      810,
                                                      new int[][] { { 5940, 5640 }, { 5937, 5633 }, { 187,
                                                          817 } }), RUNE_DART(811, new int[][] { { 5940, 5641 },
                                                              { 5937, 5634 }, { 187, 818 } }), BRONZE_SPEAR(
                                                                  1237,
                                                                  new int[][] { { 5940, 5718 }, { 5937, 5704 }, { 187,
                                                                      1251 } }), IRON_SPEAR(1239, new int[][] {
                                                                          { 5940, 5720 }, { 5937, 5706 },
                                                                          { 187, 1253 } }), STEEL_SPEAR(
                                                                              1241,
                                                                              new int[][] { { 5940, 5722 },
                                                                                  { 5937, 5708 },
                                                                                  { 187, 1255 } }), MITHRIL_SPEAR(
                                                                                      1243,
                                                                                      new int[][] { { 5940, 5724 },
                                                                                          { 5937, 5710 },
                                                                                          { 187,
    ...
    if (weapon != null) {
      for (int element[] : weapon.getNewItemId()) {
        if (itemUse == element[0]) {
          ...
          player.getItemAssistant().deleteItem(weapon.getItemId(),
              player.getItemAssistant().getItemSlot(weapon.getItemId()), 1);
