...
public class ExperienceLamp {
    ...
    switch (id) {
      ...
      case 11015:
        ...
        if (c.getItemAssistant().playerHasItem(LAMP, 1) && skill > -1) {// normal
                                                                        // lamp
          int xp = c.getPlayerAssistant().getLevelForXP(c.playerXP[skill]) * 10;
          c.getPlayerAssistant().addNormalExperienceRate(xp, skill);
          c.getItemAssistant().deleteItem2(LAMP, 1);
          c.getActionSender().sendMessage("@blu@Your wish has been granted!");
          c.getActionSender().sendMessage("@blu@You have been awarded " + xp + " experience in your selected skill!");
          c.getPlayerAssistant().removeAllWindows();
        } else if (c.getItemAssistant().playerHasItem(LAMP_2, 1) && skill > -1) {// vote
                                                                                 // reward
  ...
  public static void addExp(Client c) {
    if (c.getPlayerAssistant().getLevelForXP(c.playerXP[skill]) < 20) {
      ...
      c.getActionSender().sendMessage("@blu@You have been awarded 1000 experience in your selected skill!");
      ...
      c.getActionSender().sendMessage("@blu@You have been awarded 2000 experience in your selected skill!");
    } else {
      c.getPlayerAssistant().addNormalExperienceRate(3000, skill);
      c.getActionSender().sendMessage("@blu@You have been awarded 3000 experience in your selected skill!");
    }
  }
