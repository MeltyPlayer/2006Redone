...
public class OtherObjects {
  ...
  private final static int[] SPECIAL_OBJECTS = { 160, 155, 156, 298, 299, 300, 304, 1181, 5253, 5254, 5255, 5256, 5257,
      5258 };
  ...
  public static void searchSpecialObject(Client player, int objectType) {
    for (int i = 0; i < SPECIAL_OBJECTS.length; i++) {
      if (objectType == SPECIAL_OBJECTS[i]) {
        if (System.currentTimeMillis() - player.searchObjectDelay < 1200 || objectType == 160 && player.absX != 3096
            || objectType > 154 && objectType < 157 && player.absX != 3098 || player.absY == 3301) {
          return;
        }
