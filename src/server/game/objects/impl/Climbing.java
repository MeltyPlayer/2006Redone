  ...
  public static void processClimbing(Client client) {
    switch (client.objectId) {
      ...
      case 1722:
        ...
        if (client.objectX == 3175 && client.objectY == 3420 && client.heightLevel == 0 && client.absX == 3177
        ...
        } else if (client.absY == 3358 && client.questPoints >= QuestAssistant.MAXIMUM_QUESTPOINTS) {
          client.getPlayerAssistant().movePlayer(client.absX, 3354, 1);
        } else if (client.absY == 3358 && client.questPoints < QuestAssistant.MAXIMUM_QUESTPOINTS) {
          client.getActionSender()
              .sendMessage("You need " + QuestAssistant.MAXIMUM_QUESTPOINTS + " quest points to use these stairs.");
      ...
      case 1723:
        ...
        } else if (client.absY == 3354 && client.questPoints >= QuestAssistant.MAXIMUM_QUESTPOINTS) {
      ...
      case 1733:
        if (client.objectX == 2569 && client.objectY == 3122) {
          ...
          client.getPlayerAssistant().movePlayer(client.absX, client.absY + 6393, 0);
        }
        break;
      ...
      case 1734:
        if (client.objectX == 2569 && client.objectY == 9522) {
          ...
          client.getPlayerAssistant().movePlayer(3061, client.absY - 6400, 0);
        } else if (client.absX != 3190) {
          client.getPlayerAssistant().movePlayer(client.absX, client.absY - 6396, 0);
        }
        break;
      ...
      case 1744:
        ...
        } else if (client.objectX == 2444 || client.objectX == 2445 && client.objectY == 3415) {
      ...
      case 6279:
        if (client.getItemAssistant().playerHasItem(954, 1)) {
          ...
          client.getActionSender().sendMessage("You need a rope to enter.");
          return;
        }
        break;
      ...
      case 2408:
        ...
        client.getActionSender().sendMessage("Your prayer is drained as you enter the dungeon.");
      ...
      case 3432:
        ...
        break;
      case 1738:
        if (client.objectX == 2728 && client.objectY == 3460 && client.heightLevel == 0) {
          client.getPlayerAssistant().movePlayer(2749, 3462, 1);
        } else if (client.objectX == 2746 && client.objectY == 3460 && client.heightLevel == 0) {
        ...
        } else if (client.objectX == 3144 && client.objectY == 3447 && client.playerLevel[client.playerCooking] > 31
      ...
      case 5492:
        if (client.getItemAssistant().playerHasItem(1523, 1) && Misc.random(4) < 3) {
          client.getPlayerAssistant().movePlayer(3149, 9652, 0);
          client.getActionSender().sendMessage("You go down the trapdoor.");
          client.startAnimation(827);
          client.getPlayerAssistant().addSkillXP(.5, client.playerThieving);
          client.getPlayerAssistant().removeAllWindows();
        } else if (!client.getItemAssistant().playerHasItem(1523, 1) && Misc.random(5) < 2) {
          client.getPlayerAssistant().movePlayer(3149, 9652, 0);
          client.getActionSender().sendMessage("You go down the trapdoor.");
          client.startAnimation(827);
          client.getPlayerAssistant().addSkillXP(.5, client.playerThieving);
          client.getPlayerAssistant().removeAllWindows();
        } else if (client.getItemAssistant().playerHasItem(1523, 1) && Misc.random(4) > 3) {
          client.getActionSender().sendMessage("You fail to pick the lock.");
          client.getActionSender().sendMessage("Your thieving has been drained, your fingers feel numb.");
          client.playerLevel[17] = client.getPlayerAssistant().getLevelForXP(client.playerXP[17]) - 1;
      ...
      case 1725:
        if (client.absX == 3285 || client.absX == 3286 && client.heightLevel == 0) {
      ...
      case 1726:
        ...
        } else if (client.absX == 3285 || client.absX == 3286 && client.heightLevel == 1) {
          client.getPlayerAssistant().movePlayer(client.absX, 3496, 0);
        }
        break;

      case 11727:
        if (client.absY == 3350 || client.absY == 3351 || client.absY == 3340 || client.absY == 3341
            || client.absY == 3342) {
          climbUp(client);
        }
        break;
  ...
  public static void climbUp(Client client) {
    ...
    switch (client.heightLevel) {
      ...
      default:
        ...
        System.out.println("Bug detected with climbing up object " + client.objectId + " objectX " + client.objectX
  ...
  public static void climbDown(Client client) {
    ...
    switch (client.heightLevel) {
      ...
      default:
        ...
        client.getActionSender().sendMessage("This object is currently not supported.");
        System.out.println("Bug detected with climbing down object " + client.objectId + " objectX " + client.objectX
            + " objectY " + client.objectY + ".");
        break;
    }
  }
