...
public class ActionSender {
  ...
  public ActionSender shakeScreen(int verticleAmount, int verticleSpeed, int horizontalAmount, int horizontalSpeed) {
  ...
  public ActionSender createProjectile(int x, int y, int offX, int offY, int angle, int speed, int gfxMoving,
  ...
  public ActionSender createProjectile2(int x, int y, int offX, int offY, int angle, int speed, int gfxMoving,
