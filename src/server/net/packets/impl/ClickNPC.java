    ...
    switch (packetType) {
      ...
      case ATTACK_NPC:
        if (client.tutorialProgress == 24) {
          ...
          client.getDialogueHandler().chatboxText(client,
              "While you are fighting you will see a bar over your head. The",
              "bar shows how much health you have left. Your opponent will",
              "have one too. You will continue to attack the rat until it's dead", "or you do something else.",
              "Sit back and watch");
          client.getActionSender().chatbox(6179);

        }
        if (client.tutorialProgress == 33) {
          client.getActionSender().sendMessage("You can't range these chickens you have to mage them!");
          return;
        }
        ...
        if ((usingBow || client.autocasting) && client.goodDistance(client.getX(), client.getY(),
            NpcHandler.npcs[client.npcIndex].getX(), NpcHandler.npcs[client.npcIndex].getY(), 7)) {
          client.stopMovement();
        }

        if (usingOtherRangeWeapons && client.goodDistance(client.getX(), client.getY(),
            NpcHandler.npcs[client.npcIndex].getX(), NpcHandler.npcs[client.npcIndex].getY(), 4)) {
          client.stopMovement();
        }
        if (!usingCross && !usingArrows && usingBow && client.playerEquipment[client.playerWeapon] < 4212
          ...
          client.getActionSender().sendMessage("You have run out of arrows!");
          break;
        }
        if (RangeData.correctBowAndArrows(client) < client.playerEquipment[client.playerArrows]
          ...
          client.getActionSender()
              .sendMessage("You can't use "
                  + ItemAssistant.getItemName(client.playerEquipment[client.playerArrows]).toLowerCase() + "s with a "
                  + ItemAssistant.getItemName(client.playerEquipment[client.playerWeapon]).toLowerCase() + ".");
          client.stopMovement();
          client.getCombatAssistant().resetPlayerAttack();
          return;
        }
        if (client.playerEquipment[client.playerWeapon] == 9185 && !client.getCombatAssistant().properBolts()) {
          client.getActionSender().sendMessage("You must use bolts with a crossbow.");
          client.stopMovement();
          client.getCombatAssistant().resetPlayerAttack();
          return;
        }
      ...
      case MAGE_NPC:
        if (client.tutorialProgress == 33) {
          ...
          client.getActionSender().chatbox(6179);
          // c.getDialogues().sendStatement4("You have almost completed
          // the tutorial!",
          // "All you need to do is move on to the mainland. Just speak",
        ...
        if (NpcHandler.npcs[client.npcIndex].MaxHP == 0 || NpcHandler.npcs[client.npcIndex].npcType == 944) {
          client.getActionSender().sendMessage("You can't attack this npc.");
          break;
        }
        ...
        if (client.usingMagic) {
          if (client.goodDistance(client.getX(), client.getY(), NpcHandler.npcs[client.npcIndex].getX(),
      ...
      case FIRST_CLICK:
        ...
        if (client.goodDistance(NpcHandler.npcs[client.npcClickIndex].getX(),
            NpcHandler.npcs[client.npcClickIndex].getY(), client.getX(), client.getY(), 2)) {
          ...
          CycleEventHandler.getSingleton().addEvent(client, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
              if (client.clickNpcType == 1 && NpcHandler.npcs[client.npcClickIndex] != null) {
                if (client.goodDistance(client.getX(), client.getY(), NpcHandler.npcs[client.npcClickIndex].getX(),
      ...
      case SECOND_CLICK:
        ...
        if (client.goodDistance(NpcHandler.npcs[client.npcClickIndex].getX(),
          ...
          CycleEventHandler.getSingleton().addEvent(client, new CycleEvent() {
            @Override
            public void execute(CycleEventContainer container) {
              if (client.clickNpcType == 2 && NpcHandler.npcs[client.npcClickIndex] != null) {
                if (client.goodDistance(client.getX(), client.getY(), NpcHandler.npcs[client.npcClickIndex].getX(),
                    NpcHandler.npcs[client.npcClickIndex].getY(), 1)) {
                  client.turnPlayerTo(NpcHandler.npcs[client.npcClickIndex].getX(),
                      NpcHandler.npcs[client.npcClickIndex].getY());
      ...
      case THIRD_CLICK:
        ...
        if (client.goodDistance(NpcHandler.npcs[client.npcClickIndex].getX(),
          ...
          CycleEventHandler.getSingleton().addEvent(client, new CycleEvent() {
            @Override
            public void execute(CycleEventContainer container) {
              if (client.clickNpcType == 3 && NpcHandler.npcs[client.npcClickIndex] != null) {
                if (client.goodDistance(client.getX(), client.getY(), NpcHandler.npcs[client.npcClickIndex].getX(),
                    NpcHandler.npcs[client.npcClickIndex].getY(), 1)) {
                  client.turnPlayerTo(NpcHandler.npcs[client.npcClickIndex].getX(),
                      NpcHandler.npcs[client.npcClickIndex].getY());
