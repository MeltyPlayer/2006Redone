...
public class ClickNPC implements PacketType {
	...
	@Override
	public void processPacket(final Client client, int packetType,
			int packetSize) {
		client.npcIndex = 0;
		...
		case ATTACK_NPC:
			if (client.tutorialProgress == 24) {
				...
				client.getDialogueHandler().chatboxText(client,
						...
						"or you do something else.", "Sit back and watch");
			...
			if (usingOtherRangeWeapons && client.goodDistance(client.getX(),
					client.getY(), NpcHandler.npcs[client.npcIndex].getX(),
						...
						new CycleEvent() {
							...
							public void execute(CycleEventContainer container) {
								if (client.clickNpcType == 1
									...
									if (client.goodDistance(client.getX(),
											client.getY(),
											NpcHandler.npcs[client.npcClickIndex]
													.getX(),
											NpcHandler.npcs[client.npcClickIndex]
										...
										NpcHandler.npcs[client.npcClickIndex]
												.facePlayer(client.playerId);
										client.getNpcs()
												.firstClickNpc(client.npcType);
										container.stop();
									}
								}
								if (client.clickNpcType == 0
										|| client.clickNpcType > 1) {
									container.stop();
								}
							}
