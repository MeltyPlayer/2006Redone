  ...
  public void processPacket(Client player, int packetType, int packetSize) {
    ...
    if (player.playerRights == 3) {
      player.getActionSender()
          .sendMessage("Object Id:" + objectId + " ObjectX: " + objectX + " ObjectY: " + objectY + ".");
    }
    switch (objectId) {
      case 3044:
      ...
      case 9682:
        if (player.absX == 3014 && player.absY > 3235 && player.absY < 3238
            ...
            || player.absX == 3020 && player.absY > 3236 && player.absY < 3239
            || player.absX > 2805 && player.absX < 2813 || player.absY > 3437 && player.absY < 3442) {
          return;
        }
    ...
    if (itemId == 1710 || itemId == 1708 || itemId == 1706 || itemId == 1704 && objectId == 2638) { // glory
      int amount = player.getItemAssistant().getItemCount(1710) + player.getItemAssistant().getItemCount(1708)
          + player.getItemAssistant().getItemCount(1706) + player.getItemAssistant().getItemCount(1704);
     ...
     * (c.getItemAssistant().getItemCount(1777)); int[] spin = {1777}; for (int
     * i : spin) { c.getItemAssistant().deleteItem(i,
