  ...
  public void processPacket(Client c, int packetType, int packetSize) {
    ...
    switch (packetType) {
      ...
      case ATTACK_PLAYER:
        ...
        if (c.duelStatus == 5) {
          if (c.duelCount > 0) {
            c.getActionSender().sendMessage("The duel hasn't started yet!");
            c.playerIndex = 0;
            return;
          }
          if (c.duelRule[9]) {
        ...
        if (usingOtherRangeWeapons && c.goodDistance(c.getX(), c.getY(), PlayerHandler.players[c.playerIndex].getX(),
        ...
        if (c.playerEquipment[c.playerWeapon] == 9185 && !c.getCombatAssistant().properBolts()) {
      ...
      case MAGE_PLAYER:
        ...
        if (c.playerRights == 3) {
          c.getActionSender().sendMessage("Casting Spell id: " + c.castingSpellId + ".");
        }
        ...
        if (!teleother) {
          ...
          if (System.currentTimeMillis()
            ...
            c.getActionSender().sendMessage("That player is already affected by this spell.");
            c.usingMagic = false;
            c.stopMovement();
            c.getCombatAssistant().resetPlayerAttack();
          }
