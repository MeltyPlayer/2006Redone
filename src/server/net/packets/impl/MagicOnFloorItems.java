...
public class MagicOnFloorItems implements PacketType {
  ...
  public void processPacket(final Client c, int packetType, int packetSize) {
    ...
    if ((c.getItemAssistant().freeSlots() >= 1 || c.getItemAssistant().playerHasItem(itemId, 1))
        && Item.itemStackable[itemId] || c.getItemAssistant().freeSlots() > 0 && !Item.itemStackable[itemId]) {
      if (c.goodDistance(c.getX(), c.getY(), itemX, itemY, 12)) {
        ...
        c.getPlayerAssistant().createPlayersProjectile(c.getX(), c.getY(), offX, offY, 50, 70,
        ...
        CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
          ...
          public void execute(CycleEventContainer container) {
            ...
            if (System.currentTimeMillis() - c.teleGrabDelay > 1550 && c.usingMagic) {
              if (Server.itemHandler.itemExists(c.teleGrabItem, c.teleGrabX, c.teleGrabY)
      ...
      c.getActionSender().sendMessage("You don't have enough space in your inventory.");
      c.stopMovement();
    }
