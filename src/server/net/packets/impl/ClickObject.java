    ...
    switch (packetType) {
      ...
      case FIRST_CLICK:
        ...
        if (player.playerRights == 3) {
          player.getActionSender()
              .sendMessage("ObjectId: " + player.objectId + " ObjectX: " + player.objectX + " ObjectY: "
                  + player.objectY + " Objectclick = 1, Xoff: " + (player.getX() - player.objectX) + " Yoff: "
        ...
        if (player.teleTimer > 0) {
          player.getActionSender().sendMessage("You cannot use objects while teleporting.");
          return;
        }
        ...
        switch (player.objectId) {
          ...
          case 96:
            if (player.objectX == 2638 && player.objectY == 9763 || player.objectY == 9740) {
              player.objectXOffset = 3;
              player.objectYOffset = 1;
            }
            break;
          ...
          case 4437:
            if (player.getItemAssistant().playerHasItem(1265, 1)) {
              player.getActionSender().sendMessage("You start to break up the rocks...");
              ...
              CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
                ...
                @Override
                public void stop() {
                  player.getActionSender().object(-1, player.objectX, player.objectY, 0, 10);
                  player.getActionSender().object(4438, player.objectX, player.objectY, 0, 10);
                  player.getActionSender().sendMessage("You break up the rocks.");
                }
              }, 3);
            }
            break;
          ...
          case 4448:
            if (player.getItemAssistant().playerHasItem(1265, 1)) {
              player.getActionSender().sendMessage("You start to mine the wall...");
              player.startAnimation(625);
              CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
                @Override
                public void execute(CycleEventContainer container) {
                  stop();
                  player.startAnimation(65535);
                  player.getActionSender().sendMessage("You collapse the cave wall.");
                }
                ...
                public void stop() {
                  if ((player.objectX == 2390 || player.objectX == 2393)
                    ...
                    // cave
                    // side
                    player.getActionSender().object(-1, 2391, 9501, 0, 10);
                    player.getActionSender().object(4437, 2391, 9501, 0, 10);
                  ...
                  if ((player.objectX == 2399 || player.objectX == 2402)
                    ...
                    // cave
                    // side
                    player.getActionSender().object(-1, 2400, 9512, 1, 10);
                    player.getActionSender().object(4437, 2400, 9512, 1, 10);
                  ...
                  if ((player.objectX == 2408 || player.objectX == 2411)
                    ...
                    // cave
                    // side
                    player.getActionSender().object(-1, 2409, 9503, 0, 10);
                    player.getActionSender().object(4437, 2409, 9503, 0, 10);
                  ...
                  if ((player.objectX == 2400 || player.objectX == 2403)
                    ...
                    // cave
                    // side
                    player.getActionSender().object(-1, 2401, 9494, 1, 10);
                    player.getActionSender().object(4437, 2401, 9494, 1, 10);
          ...
          case 1723:
            if (player.objectX == 3100 && player.objectY == 3266 || player.objectX == 2663 && player.objectY == 3321) {
              player.objectXOffset = 2;
              player.objectYOffset = 1;
        ...
        if (player.goodDistance(player.objectX + player.objectXOffset, player.objectY + player.objectYOffset,
            player.getX(), player.getY(), player.objectDistance)) {
          ...
          CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
            @Override
            public void execute(CycleEventContainer container) {
              if (player.clickObjectType == 1 && player.goodDistance(player.objectX + player.objectXOffset,
                  player.objectY + player.objectYOffset, player.getX(), player.getY(), player.objectDistance)) {
                player.getObjects().firstClickObject(player.objectId, player.objectX, player.objectY);
                container.stop();
              }
      ...
      case SECOND_CLICK:
        ...
        if (player.playerRights == 3) {
          player.getActionSender()
              .sendMessage("ObjectId: " + player.objectId + " ObjectX: " + player.objectX + " ObjectY: "
                  + player.objectY + " Objectclick = 2, Xoff: " + (player.getX() - player.objectX) + " Yoff: "
                  + (player.getY() - player.objectY));
        }
        if (Stalls.isObject(player.objectId)) {
          Stalls.attemptStall(player, player.objectId, player.objectX, player.objectX);
        ...
        if (player.goodDistance(player.objectX + player.objectXOffset, player.objectY + player.objectYOffset,
          ...
          CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
            @Override
            public void execute(CycleEventContainer container) {
              if (player.clickObjectType == 2 && player.goodDistance(player.objectX + player.objectXOffset,
                  player.objectY + player.objectYOffset, player.getX(), player.getY(), player.objectDistance)) {
                player.getObjects().secondClickObject(player.objectId, player.objectX, player.objectY);
                container.stop();
              }
      ...
      case THIRD_CLICK: // 'F'
        ...
        if (player.playerRights == 3) {
          player.getActionSender()
              .sendMessage("ObjectId: " + player.objectId + " ObjectX: " + player.objectX + " ObjectY: "
                  + player.objectY + " Objectclick = 3, Xoff: " + (player.getX() - player.objectX) + " Yoff: "
                  + (player.getY() - player.objectY));
        }
        switch (player.objectId) {
          case 12537:
        ...
        if (player.goodDistance(player.objectX + player.objectXOffset, player.objectY + player.objectYOffset,
          ...
          CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
            @Override
            public void execute(CycleEventContainer container) {
              if (player.clickObjectType == 3 && player.goodDistance(player.objectX + player.objectXOffset,
                  player.objectY + player.objectYOffset, player.getX(), player.getY(), player.objectDistance)) {
                player.getObjects().thirdClickObject(player.objectId, player.objectX, player.objectY);
                container.stop();
              }
      ...
      case FOURTH_CLICK:
        ...
        if (player.playerRights == 3) {
          player.getActionSender()
              .sendMessage("ObjectId: " + player.objectId + " ObjectX: " + player.objectX + " ObjectY: "
                  + player.objectY + " Objectclick = 4, Xoff: " + (player.getX() - player.objectX) + " Yoff: "
                  + (player.getY() - player.objectY));
        }
        switch (player.objectId) {
          default:
        ...
        if (player.goodDistance(player.objectX + player.objectXOffset, player.objectY + player.objectYOffset,
          ...
          CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
            @Override
            public void execute(CycleEventContainer container) {
              if (player.clickObjectType == 4 && player.goodDistance(player.objectX + player.objectXOffset,
                  player.objectY + player.objectYOffset, player.getX(), player.getY(), player.objectDistance)) {
                player.getObjects().fourthClickObject(player.objectId, player.objectX, player.objectY);
                container.stop();
              }
