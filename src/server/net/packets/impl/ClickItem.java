...
import server.game.content.consumables.Beverages;
import server.game.content.consumables.Kebabs;
import server.game.content.consumables.Beverages.beverageData;
import server.game.content.minigames.TreasureTrails;
  ...
  public void processPacket(Client player, int packetType, int packetSize) {
    ...
    switch (itemId) {
      ...
      case 4155:// enchanted gem
        player.getDialogueHandler().sendOption4("How many kills do I have left?", "Who are you?",
            "Where are you located?", "How many slayer points do I have?");
