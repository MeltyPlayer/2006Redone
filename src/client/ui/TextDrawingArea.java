    ...
    for (int i1 = 0; i1 < s.length(); i1++) {
      ...
      if (c != ' ') {
        method392(aByteArrayArray1491[c], j + anIntArray1494[c],
            l + anIntArray1495[c] + (int) (Math.sin(i1 / 2D + k / 5D) * 5D), anIntArray1492[c], anIntArray1493[c], i);
      }
      j += anIntArray1496[c];
    }
    ...
    for (int i1 = 0; i1 < s.length(); i1++) {
      ...
      if (c != ' ') {
        method392(aByteArrayArray1491[c], i + anIntArray1494[c] + (int) (Math.sin(i1 / 5D + j / 5D) * 5D),
            k + anIntArray1495[c] + (int) (Math.sin(i1 / 3D + j / 5D) * 5D), anIntArray1492[c], anIntArray1493[c], l);
      }
      i += anIntArray1496[c];
    }
    ...
    for (int k1 = 0; k1 < s.length(); k1++) {
      ...
      if (c != ' ') {
        method392(aByteArrayArray1491[c], l + anIntArray1494[c],
            k + anIntArray1495[c] + (int) (Math.sin(k1 / 1.5D + j) * d), anIntArray1492[c], anIntArray1493[c], i1);
      }
      l += anIntArray1496[c];
    }
