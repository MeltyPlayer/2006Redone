...
final class Class56_Sub1_Sub2 extends Class56_Sub1 implements Runnable {
  ...
  final synchronized void method832(int i) {
    if (aClass11_1857.method527()) {
      ...
      long l = ((long) (i_11_ - (i_13_ + i_12_)) * (long) (aClass11_1857.anInt213 * 1000));
      for (;;) {
        ...
        if (l < l_16_)
          break;
        while (i_15_ == aClass11_1857.anIntArray216[i_14_]) {
          ...
          if (aClass11_1857.method521()) {
            ...
            if (aClass11_1857.method531()) {
              if (aBoolean1854)
                ...
                method838((long) (int) (l_16_ / (long) ((aClass11_1857.anInt213) * 1000)));
                aClass11_1857.method523();
                method846();
                return;
              }
