...
final class ObjectManager {
      ...
      for (int l6 = -5; l6 < anInt146 + 5; l6++) {
        ...
        if (l6 >= 1 && l6 < anInt146 - 1) {
          ...
          for (int k17 = -5; k17 < anInt147 + 5; k17++) {
            ...
            if (k17 >= 1 && k17 < anInt147 - 1 && (!lowMem || (aByteArrayArrayArray149[0][l6][k17] & 2) != 0
                || (aByteArrayArrayArray149[l][l6][k17] & 0x10) == 0 && method182(k17, l, l6) == anInt131)) {
              if (l < anInt145) {
                anInt145 = l;
              }
              ...
              if (l18 > 0 || i19 > 0) {
                ...
                if (i19 == 0) {
                  worldController.method279(l, l6, k17, 0, 0, -1, j19, k19, l19, i20, method187(j21, j20),
                      method187(j21, k20), method187(j21, l20), method187(j21, i21), 0, 0, 0, 0, i22, 0);
                } else {
                  ...
                  if (i23 >= 0) {
                    ...
                    /*
                     * j23 = -2; i23 = -1; k23 =
                     * Texture.anIntArray1482[method185(flo_2.anInt399, 96)];
                     */
                    k23 = 0;
                    j23 = -2;
                    i23 = -1;
                  ...
                  worldController.method279(l, l6, k17, k22, byte4, i23, j19, k19, l19, i20, method187(j21, j20),
                      method187(j21, k20), method187(j21, l20), method187(j21, i21), method185(j23, j20),
                      method185(j23, k20), method185(j23, l20), method185(j23, i21), i22, k23);
                }
              }
            }
          }
  ...
  private void method175(int i, WorldController worldController, CollisionMap class11, int j, int k, int l, int i1,
    ...
    if (j == 2) {
      ...
      worldController.method282(anIntArray152[j1], ((Animable) obj11), l2, i, byte0, l, ((Animable) obj12), k2,
          anIntArray152[i3], k);
      if (class46.aBoolean764) {
        if (j1 == 0) {
          anIntArrayArrayArray135[k][l][i] |= 0x249;
      ...
      for (int i3 = 0; i3 < 64; i3++) {
        for (int j3 = 0; j3 < 64; j3++) {
          if (l2 == i && i3 >= i1 && i3 < i1 + 8 && j3 >= j1 && j3 < j1 + 8) {
            method181(l1 + Class4.method156(j3 & 7, j, i3 & 7), 0, stream, l + Class4.method155(j, j3 & 7, i3 & 7), k1,
                j, 0);
          } else {
