...
public final class OnDemandFetcher extends OnDemandFetcherParent implements Runnable {
   ...
   * null || abyte0.length < 2) //return false; int k = abyte0.length - 2; int l
   * = ((abyte0[k] & 0xff) << 8) + (abyte0[k + 1] & 0xff); crc32.reset();
   * crc32.update(abyte0, 0, k); int i1 = (int) crc32.getValue(); //return l ==
   * i && i1 == j; return true;
   * 
   * }
   */
  ...
  public void method558(int i, int j) {
    ...
    synchronized (nodeSubList) {
      for (OnDemandData onDemandData = (OnDemandData) nodeSubList
          .reverseGetFirst(); onDemandData != null; onDemandData = (OnDemandData) nodeSubList.reverseGetNext()) {
      ...
      while (running) {
        ...
        if (!flag) {
          for (OnDemandData onDemandData_1 = (OnDemandData) requested
              .reverseGetFirst(); onDemandData_1 != null; onDemandData_1 = (OnDemandData) requested.reverseGetNext()) {
            flag = true;
  ...
  private void checkReceived() {
    ...
    while (onDemandData != null) {
      ...
      if (!crcMatches(versions[onDemandData.dataType][onDemandData.ID], crcs[onDemandData.dataType][onDemandData.ID],
          abyte0)) {
        abyte0 = null;
      }
      synchronized (aClass19_1370) {
