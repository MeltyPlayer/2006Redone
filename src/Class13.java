  ...
  private static void method227(Class32 class32) {
    ...
    while (flag19) {
      ...
      for (int l3 = 0; l3 < j4; l3++) {
        ...
        method232(class32.anIntArrayArray597[l3], class32.anIntArrayArray598[l3], class32.anIntArrayArray599[l3],
      ...
      for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4;) {
        if (k5 == 0 || k5 == 1) {
          ...
          if (j11 < 16) {
            ...
            for (; l10 > 0; l10--) {
              class32.anIntArray593[l10]--;
              class32.aByteArray592[class32.anIntArray593[l10]] = class32.aByteArray592[class32.anIntArray593[l10 - 1]
                  + 16 - 1];
            }
