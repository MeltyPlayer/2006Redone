...
public class MagicTeleports {
	...
	public static final int AIR_RUNE = 556, FIRE_RUNE = 554, WATER_RUNE = 555,
			EARTH_RUNE = 557, LAW_RUNE = 563, BLOOD_RUNE = 565, SOUL_RUNE = 566,
			BANANA = 1963;
	...
	public static boolean hasRuneStaff(Client player, int rune) {
		if (rune == 556) {// Air
			if (player.playerEquipment[player.playerWeapon] == 1381// Staff of
																	// air
					|| player.playerEquipment[player.playerWeapon] == 1397// Air
																			// battlestaff
					|| player.playerEquipment[player.playerWeapon] == 1405) {// Mystic
																				// air
																				// staff
				return true;
			}
		...
		if (rune == 555) {// Water
			if (player.playerEquipment[player.playerWeapon] == 1383// Staff of
																	// water
					|| player.playerEquipment[player.playerWeapon] == 1395// Water
																			// battlestaff
					|| player.playerEquipment[player.playerWeapon] == 6562// Mud
																			// battlestaff
					|| player.playerEquipment[player.playerWeapon] == 6563// Mystic
																			// mud
																			// staff
					|| player.playerEquipment[player.playerWeapon] == 11736// Steam
																			// battlestaff
					|| player.playerEquipment[player.playerWeapon] == 11738// Mystic
																			// steam
																			// staff
					|| player.playerEquipment[player.playerWeapon] == 1403) {// Mystic
																				// water
																				// staff
				return true;
			}
		...
		if (rune == 557) {// Earth
			if (player.playerEquipment[player.playerWeapon] == 1385// Staff of
																	// earth
					|| player.playerEquipment[player.playerWeapon] == 1399// Earth
																			// battlestaff
					|| player.playerEquipment[player.playerWeapon] == 3053// Lava
																			// battlestaff
					|| player.playerEquipment[player.playerWeapon] == 3054// Mystic
																			// lava
																			// staff
					|| player.playerEquipment[player.playerWeapon] == 6562// Mud
																			// battlestaff
					|| player.playerEquipment[player.playerWeapon] == 6563// Mystic
																			// mud
																			// staff
					|| player.playerEquipment[player.playerWeapon] == 1407) {// Mystic
																				// earth
																				// staff
				return true;
			}
		...
		if (rune == 554) {// Fire
			if (player.playerEquipment[player.playerWeapon] == 1387// Staff of
																	// fire
					|| player.playerEquipment[player.playerWeapon] == 1393// Fire
																			// battlestaff
					|| player.playerEquipment[player.playerWeapon] == 3053// Lava
																			// battlestaff
					|| player.playerEquipment[player.playerWeapon] == 3054// Mystic
					...
					|| player.playerEquipment[player.playerWeapon] == 11738// Mystic
																			// steam
																			// staff
					|| player.playerEquipment[player.playerWeapon] == 1401) {// Mystic
																				// fire
																				// staff
				return true;
			}
	...
	public static void paddewwaTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
					|| !player.getItemAssistant().playerHasItem(FIRE_RUNE, 1)
							&& hasRuneStaff(player, FIRE_RUNE) == false
					|| !player.getItemAssistant().playerHasItem(FIRE_RUNE, 1)
							&& hasRuneStaff(player, AIR_RUNE) == false) {
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 54) {
				player.getActionSender().sendMessage(
						"You need a magic level of 54 to cast this spell.");
				return;
			}
		}
		...
		player.getPlayerAssistant().startTeleport(PADDEWWA_X + Misc.random(2),
				PADDEWWA_Y - Misc.random(2), 0, "ancient");
	...
	public static void senntisenTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
					|| !player.getItemAssistant().playerHasItem(SOUL_RUNE, 1)) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
				return;
			}
		...
		player.getPlayerAssistant().startTeleport(SENNTISTEN_X + Misc.random(1),
				SENNTISTEN_Y - Misc.random(1), 0, "ancient");
		player.lastCast = System.currentTimeMillis();
	...
	public static void kharyllTeleport(Client player) {
		...
		RandomEventHandler.addRandom(player);
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2) || !player
					.getItemAssistant().playerHasItem(BLOOD_RUNE, 1)) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
				return;
			}
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 66) {
				player.getActionSender().sendMessage(
						"You need a magic level of 66 to cast this spell.");
				return;
			}
		}
		player.getItemAssistant().deleteItem2(LAW_RUNE, 2);
		player.getItemAssistant().deleteItem2(BLOOD_RUNE, 1);
		player.getPlayerAssistant().startTeleport(KHARYRLL_X, KHARYRLL_Y, 0,
				"ancient");
		player.lastCast = System.currentTimeMillis();
	...
	public static void lassarTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
					|| !player.getItemAssistant().playerHasItem(WATER_RUNE, 4)
							&& hasRuneStaff(player, WATER_RUNE) == false) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
				return;
			}
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 72) {
				player.getActionSender().sendMessage(
						"You need a magic level of 72 to cast this spell.");
				return;
			}
		}
		player.getItemAssistant().deleteItem2(LAW_RUNE, 2);
		...
		player.getPlayerAssistant().startTeleport(LASSAR_X + Misc.random(2),
				LASSAR_Y - Misc.random(2), 0, "ancient");
		player.lastCast = System.currentTimeMillis();
	...
	public static void dareeyakTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
					|| !player.getItemAssistant().playerHasItem(FIRE_RUNE, 3)
							&& hasRuneStaff(player, FIRE_RUNE) == false
					|| !player.getItemAssistant().playerHasItem(AIR_RUNE, 2)
							&& hasRuneStaff(player, AIR_RUNE) == false) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
				return;
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 78) {
				player.getActionSender().sendMessage(
						"You need a magic level of 78 to cast this spell.");
				return;
			}
		}
		player.getItemAssistant().deleteItem2(LAW_RUNE, 2);
		...
		player.getPlayerAssistant().startTeleport(DAREEYAK_X + Misc.random(1),
	...
	public static void carrallangarTeleport(Client player) {
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 84) {
				player.getActionSender().sendMessage(
						"You need a magic level of 84 to cast this spell.");
				return;
			}
		}
		...
		player.getPlayerAssistant().startTeleport(
				CARRALLANGAR_X + Misc.random(2),
				CARRALLANGAR_Y - Misc.random(2), 0, "ancient");
		player.lastCast = System.currentTimeMillis();
	...
	public static void annakarlTeleport(Client player) {
		...
		RandomEventHandler.addRandom(player);
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(BLOOD_RUNE, 2)
					|| !player.getItemAssistant().playerHasItem(LAW_RUNE, 2)) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
				return;
		...
		player.getItemAssistant().deleteItem2(LAW_RUNE, 2);
		player.getPlayerAssistant().startTeleport(ANNAKARL_X + Misc.random(1),
				ANNAKARL_Y - Misc.random(1), 0, "ancient");
		player.lastCast = System.currentTimeMillis();
	...
	public static void ghorrockTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
					|| !player.getItemAssistant().playerHasItem(WATER_RUNE, 8)
							&& hasRuneStaff(player, WATER_RUNE) == false) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
				return;
	...
	public static void varrockTeleport(Client player) {
		...
		RandomEventHandler.addRandom(player);
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 1)
					|| !player.getItemAssistant().playerHasItem(FIRE_RUNE, 1)
							&& hasRuneStaff(player, FIRE_RUNE) == false
					|| !player.getItemAssistant().playerHasItem(AIR_RUNE, 3)
							&& hasRuneStaff(player, AIR_RUNE) == false) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
				return;
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 25) {
				player.getActionSender().sendMessage(
						"You need a magic level of 25 to cast this spell.");
				return;
			}
		}
		...
		player.getPlayerAssistant().startTeleport(VARROCK_X + Misc.random(2),
				VARROCK_Y - Misc.random(2), 0, "modern");
		player.lastCast = System.currentTimeMillis();
	...
	public static void lumbridgeTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 1)
					|| !player.getItemAssistant().playerHasItem(EARTH_RUNE, 1)
							&& hasRuneStaff(player, EARTH_RUNE) == false
					|| !player.getItemAssistant().playerHasItem(AIR_RUNE, 3)
							&& hasRuneStaff(player, AIR_RUNE) == false) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 32) {
				player.getActionSender().sendMessage(
						"You need a magic level of 32 to cast this spell.");
				return;
			}
		}
		player.getItemAssistant().deleteItem2(LAW_RUNE, 1);
		...
		player.getPlayerAssistant().startTeleport(LUMBRIDGE_X, LUMBRIDGE_Y, 0,
				"modern");
		player.lastCast = System.currentTimeMillis();
		player.getPlayerAssistant().addSkillXP(35, player.playerMagic);
	}
	...
	public static void faladorTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 1)
					|| !player.getItemAssistant().playerHasItem(WATER_RUNE, 1)
							&& hasRuneStaff(player, WATER_RUNE) == false
					|| !player.getItemAssistant().playerHasItem(AIR_RUNE, 3)
							&& hasRuneStaff(player, AIR_RUNE) == false) {
				player.getActionSender().sendMessage(
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 37) {
				player.getActionSender().sendMessage(
						"You need a magic level of 37 to cast this spell.");
				return;
			}
		}
		player.getItemAssistant().deleteItem2(LAW_RUNE, 1);
		...
		player.getPlayerAssistant().startTeleport(FALADOR_X + Misc.random(4),
				FALADOR_Y - Misc.random(4), 0, "modern");
		player.lastCast = System.currentTimeMillis();
	...
	public static void camelotTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 1)
					|| !player.getItemAssistant().playerHasItem(AIR_RUNE, 5)
							&& hasRuneStaff(player, AIR_RUNE) == false) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
				return;
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 45) {
				player.getActionSender().sendMessage(
						"You need a magic level of 45 to cast this spell.");
				return;
			}
		}
		player.getItemAssistant().deleteItem2(LAW_RUNE, 1);
		...
		// 2757, 3479
		player.getPlayerAssistant().startTeleport(CAMELOT_X + Misc.random(1),
				CAMELOT_Y - Misc.random(1), 0, "modern");
		player.lastCast = System.currentTimeMillis();
	...
	public static void ardougneTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
					|| !player.getItemAssistant().playerHasItem(WATER_RUNE, 2)
							&& hasRuneStaff(player, WATER_RUNE) == false) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
				return;
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 51) {
				player.getActionSender().sendMessage(
						"You need a magic level of 51 to cast this spell.");
				return;
			}
		}
		player.getItemAssistant().deleteItem2(LAW_RUNE, 2);
	...
	public static void watchTowerTeleport(Client player) {
		...
		RandomEventHandler.addRandom(player);
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(EARTH_RUNE, 2)
					&& hasRuneStaff(player, EARTH_RUNE) == false
					|| !player.getItemAssistant().playerHasItem(LAW_RUNE, 2)) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
		...
		player.getItemAssistant().deleteItem2(LAW_RUNE, 2);
		player.getPlayerAssistant().startTeleport(WATCHTOWER_X, WATCHTOWER_Y, 1,
				"modern");
		player.lastCast = System.currentTimeMillis();
	...
	public static void trollhiemTeleport(Client player) {
		...
		RandomEventHandler.addRandom(player);
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(FIRE_RUNE, 2)
					&& hasRuneStaff(player, FIRE_RUNE) == false
					|| !player.getItemAssistant().playerHasItem(LAW_RUNE, 2)) {
				player.getActionSender().sendMessage(
						"You don't have the required runes to cast this spell.");
		...
		if (MAGIC_LEVEL_REQUIRED) {
			if (player.playerLevel[player.playerMagic] < 61) {
				player.getActionSender().sendMessage(
						"You need a magic level of 61 to cast this spell.");
				return;
			}
		}
		if (hasRuneStaff(player, FIRE_RUNE) == false) {
	...
	public static void apeAtollTeleport(Client player) {
		...
		if (RUNES_REQUIRED) {
			if (!player.getItemAssistant().playerHasItem(LAW_RUNE, 2)
					|| !player.getItemAssistant().playerHasItem(FIRE_RUNE, 2)
							&& hasRuneStaff(player, FIRE_RUNE) == false
					|| !player.getItemAssistant().playerHasItem(WATER_RUNE, 2)
							&& hasRuneStaff(player, WATER_RUNE) == false
					|| !player.getItemAssistant().playerHasItem(BANANA, 1)) {
				player.getActionSender().sendMessage(
						"You don't have the required items to cast this spell.");
				return;
			}
		}
		...
		player.getPlayerAssistant().startTeleport(2798 + Misc.random(1),
				2798 - Misc.random(1), 1, "modern");
		player.lastCast = System.currentTimeMillis();
		player.getPlayerAssistant().addSkillXP(76, player.playerMagic);
	}
}