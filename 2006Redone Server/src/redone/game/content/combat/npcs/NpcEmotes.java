...
public enum NpcEmotes {
	MAN(new int[] { 1, 2, 3, 4, 5, 6 }, 422, 1834, 836), GARGOYLE(
			new int[] { 1610, 1611 }, 1517, 1519,
			1518), SKELETAL_WYVERN(new int[] { 3068 }, 2989, 2988, 2987), BAT(
					new int[] { 412, 78 }, 30, 31,
					36), BEAR(new int[] { 105, 106 }, 41, 42, 44), HOB_GOBLIN(
							new int[] { 122, 123 }, 164, 165,
							167), AHRIM(new int[] { 2025 }, 729, 404,
									2304), DHAROK(new int[] { 2026 }, 2067, 404,
											2304), GUTHAN(new int[] { 2027 },
													422, 404, 2304), KARIL(
															new int[] { 2028 },
															2075, 404,
															2304), TORAG(
	...
	private NpcEmotes(int[] npcId, int attackAnim, int blockAnim,
			int deadAnim) {
		this.npcId = npcId;
